...
此專案歡迎發佈和建議。  大部分的發佈需要您同意參與者授權合約（CLA）宣告的權利，實際上，請授與我們使用您之貢獻的權力。 如需詳細資訊，請造訪 <https://cla.microsoft.com> 。

當您提交「提取要求」時，CLA 會自動判斷是否需要提供 CLA 並適當地修飾 PR （例如，標籤、批註）。 只需遵循 bot 所提供的指示。 您只需要在所有 repos 使用我們的 CLA 來執行這項作業。
