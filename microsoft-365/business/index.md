...
<div id="main" class="v2">
    <div class="container">
        <h1>Microsoft 365 商務版資源</h1>
        <P>Microsoft 365 商務版包含最新版的 Windows 和 Office 應用程式，如 Excel 和 Outlook。 取得並執行，並善加利用資料保護和延伸至所有商務裝置的安全性。</p>
        <P></p>
        <ul class="pivots">
            <li>
                <a href="#home"></a>
                                            ...
                                            <div class="cardText">
                                              ...
                                              <P><a href="sign-up.md" target="_blank">取得 Microsoft 365 商務版</a></p>
                                               <P><a href="set-up.md" target="_blank">設定 Microsoft 365 商務版</a></p>
                                                ...
                                                <P><a href="auto-install-or-uninstall-office.md" target="_blank">在 Windows 10 上安裝 Office</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>移至 Microsoft 365 商務版</h3>
                                                <P><a href="migrate-to-microsoft-365-business.md" target="_blank">從 Office 365 商務進階版移動</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>使用</h3>
                                                <P><a href="https://support.office.com/office-training-center" target="_blank">協助每個人 Office 快速上手及執行</a></p>
                                                <P><a href="https://www.microsoft.com/itpro/windows-10/end-user-readiness" target="_blank">協助每個人切換至 Windows 10</a></p>
                                                <P><a href="https://docs.microsoft.com/intune-user-help/use-managed-devices-to-get-work-done" target="_blank">Intune 教育訓練</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>合作夥伴的資源</h3>
                                                <P><a href="get-microsoft-365-business.md" target="_blank">從合作夥伴中心取得 Microsoft 365 商務版</a></p>
                                                <P><a href="https://www.microsoft.com/microsoft-365/partners/business" target="_blank">Microsoft 365 合作夥伴頁面</a></p>
                                                <P><a href="https://www.microsoft.com/microsoft-365/partners/resources/microsoft-365-business-licensing-deck" target="_blank">Microsoft 365 商務版授權艙面的</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <P><a href="https://support.office.com/article/Contact-support-for-business-products-Admin-Help-32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b" target="_blank">請連絡 Office 365 的支援</a></p>
                                                    <P><a href="https://techcommunity.microsoft.com/t5/Small-and-Medium-Businesses/ct-p/SMB" target="_blank">小型和中型企業技術社群</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>說明 」 文件</h3>
                                                     <P><a href="https://docs.microsoft.com/office/admins-itprofessionals" target="_blank">Office 系統文件</a></p>
                                                     <P><a href="https://docs.microsoft.com/intune/index">Microsoft Intune 的文件</a></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
