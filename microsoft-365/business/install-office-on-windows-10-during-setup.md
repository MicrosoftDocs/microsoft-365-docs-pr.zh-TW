...
我們建議您接受在安裝期間預設設定。如果您想要有不同的不同使用者群組設定，您可以管理 Office 為基礎的群組中的部署設定後。移至 [**裝置** \> **管理 Office 的部署**從管理中心首頁。如需的逐步指示，請參閱[自動安裝或解除安裝 Windows 10 裝置上的 Office](auto-install-or-uninstall-office.md)。
