...
2. 移至左導覽窗格中的 [ **安裝程式** ]，然後在 [ **安裝程式** ] 頁面上，滾動至 [ **應用程式和更新**]。
    > [!NOTE]
    > 如果所有的使用者都已安裝 Office 應用程式，您可能不會看到此卡片。
  
3. 在 [ **説明使用者安裝其 Office 應用程式** 卡片] 中，選擇 [ **View**]，然後 **開始**。
