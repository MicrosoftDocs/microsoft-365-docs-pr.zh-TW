...
- [設定 Windows 10 裝置的裝置保護設定](protection-settings-for-windows-10-pcs.md) 。 
    ...
    您可以啟用 [BitLocker](/windows/security/information-protection/bitlocker/bitlocker-frequently-asked-questions) 加密，協助保護資料以防裝置遺失或遭盜，並啟用 [Windows 利用防護](/windows/security/threat-protection/microsoft-defender-atp/enable-exploit-protection) ，以針對勒索軟體提供高級防護。 
...
- **與 Azure AD Premium P1 方案相同的 [條件式存取](/azure/active-directory/conditional-access/overview)**
...
- **[資料遺失防護原則](../compliance/data-loss-prevention-policies.md)** (DLP) 的概覽。 
