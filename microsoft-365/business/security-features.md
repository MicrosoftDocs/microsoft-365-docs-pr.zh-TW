...
1. 登入[Azure Active Directory 系統管理中心](https://portal.azure.com/)。

    您可以也歌唱中所找到**系統中心** \> **Azure Active Directory**中系統管理中心的左的巡覽。

2. 選取**所有服務**和 tyoe *Azure 資訊保護*在**搜尋方塊**中。
...
3. 選擇 [**安全性&amp;規範**移至安全性&amp;規範中心。 
 ...
 ### <a name="how-do-i-find-the-intune-admin-center"></a>如何尋找 Intune 系統管理中心？
