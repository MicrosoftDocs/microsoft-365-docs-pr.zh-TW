...
在您[設定 App 保護原則](protection-settings-for-windows-10-devices.md)後，這些原則可能需要幾個小時才會在使用者的裝置上生效。 如果**您開啟**防止使用者複製到個人檔案的公司資料並強制他們將工作將檔案儲存到商務用 OneDrive**設定公司擁有裝置，** 您可以在使用者的裝置檢查此之後他們已連線到 Azure AD 和登入。 
...
1. Windows 10 個人裝置其中您登入為本機使用者，請移至**Windows 設定**，並按一下或點選 [**帳戶** \> **存取公司或學校資源**。
