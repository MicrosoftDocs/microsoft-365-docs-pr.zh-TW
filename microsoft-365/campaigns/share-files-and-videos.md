...
當您需要控制誰可以查看您的檔案，以及誰可以編輯您的檔案時，您必須將檔案儲存在安全的位置，以確保正確套用許可權。 您可以使用 Microsoft 團隊儲存您的檔案，然後使用 Microsoft 團隊或傳送 SharePoint 連結，在您的公司、實踐或活動內部或外部共用檔。 傳送連結（而非電子郵件附件）表示您知道誰在查看及修改檔案，而且不需要您的許可權就能查看或修改這些檔案。

![Microsoft 團隊視窗的圖表，顯示 [檔案] 索引標籤，並取得功能表上的連結](../media/m365-democracy-teams-sharefiles.png)

您也可以在 Microsoft 小組和 SharePoint 中處理檔案，並彼此檢查檔案的變更。 使用 Microsoft 團隊在公司、實踐或活動中共用檔案。 如果您需要與組織外部的人員共用，可將其新增為小組的客人，或傳送安全的 SharePoint 連結。

您也可以使用 Microsoft Stream 在內部儲存和共用影片。 這些影片對公眾是無法查看的，所以它們非常適合內部活動郵件。
...
若要建立小組並新增來賓（如廣告人員或融資合作夥伴），請遵循下列步驟。

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE1FQMp]

若要與來賓共用安全連結，而不使用 Microsoft 小組，請遵循下列步驟。
