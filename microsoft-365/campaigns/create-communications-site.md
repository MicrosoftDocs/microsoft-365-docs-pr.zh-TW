...
使用 SharePoint 中的通訊網站是一種極佳的方式，可讓您交流優先順序、分享策略檔，以及醒目即將發生的事件。 通訊網站是用於整個商務或活動中的廣泛共用專案;這是您的內部策略網站。

## <a name="best-practices"></a>最佳做法

在您的通訊網站中包含下列元素：

1. 將您的徽標和色彩新增為頁首影像和主題。
2. 在 [ **英雄網頁元件**] 中，靠您提供您的策略、訊息、重要檔、目錄及常見問題。
3. 在 **文字網頁元件** 中包含 CEO 或候選人報表給小組。
4. 將事件新增至 **事件網頁元件** ，讓所有人都能看到即將推出的專案。
