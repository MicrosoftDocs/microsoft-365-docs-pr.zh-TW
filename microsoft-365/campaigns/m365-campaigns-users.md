...
---
# <a name="how-microsoft-365-for-campaigns-affects-your-users"></a>Microsoft 365 如何影響使用者的活動

Microsoft 365 的行銷活動可讓駭客很難取得您環境的存取權。 其缺點是，您的使用者必須瞭解如何在此更安全的環境內運作。 我們很瞭解，需要一些額外的耐心，但有必要讓組織保持受保護。
...
- 驗證合法的電子郵件，並尋找 ATP Advanced 網路釣魚防護中的安全性秘訣。
- 只開啟安全連結和附件（由 ATP 安全連結和 ATP 安全附件所驗證）。

深入瞭解[網路釣魚和其他攻擊](m365-campaigns-phishing-and-attacks.md)。 

下載[資訊圖表](m365-campaigns-protect-campaign-infographic.md)，並提供您和您的行銷活動團隊成員的秘訣。
