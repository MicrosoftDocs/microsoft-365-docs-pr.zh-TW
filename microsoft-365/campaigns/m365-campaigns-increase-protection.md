...
## <a name="protect-against-malicious-attachments-files-and-links-with-advanced-threat-protection-atp"></a>防止惡意附件、檔案及具有高級威脅防護的連結 (ATP) 
...
如果您還沒有在租使用者中看到含卡的「 **安裝** 」頁面，請參閱 how To complete Security & 合規性中心的如何完成這些步驟。 請參閱在 [安全性 & 規範中心內設定 atp 安全附件](#set-up-atp-safe-attachments-in-the-security--compliance-center) ，並在 [安全性 & 規範中心設定 atp 安全連結](#set-up-atp-safe-links-in-the-security--compliance-center)。
...
1. 若要開啟 [審計記錄檔搜尋]，請移至系統管理中心， <https://admin.microsoft.com> 然後在左側導覽中的 [系統**管理中心**] 下選擇 [**合規性**]。
2. 在 [ **Microsoft 365 合規性**] 頁面上，選擇 [**更多資源**]，然後在**Office 365 安全性 & center**卡片上**開啟**]。
...
1. 移至 [系統管理中心] <https://admin.microsoft.com> ，然後選擇 [ **設定** \> **服務] & 增益集**]。
