...
---
# <a name="create-teams-for-collaboration-in-microsoft-teams"></a>在 Microsoft Teams 中建立共同作業的團隊

Microsoft Teams 是一種共同作業應用程式，可協助您的員工從任何裝置進行組織和交談。 您可以使用 Microsoft Teams 立即與您的員工或組織外的客人成員交談。 您也可以撥打電話、主控會議及共用檔案。
...
- 共用信箱和行事曆的[Exchange Online](/MicrosoftTeams/exchange-teams-interact)
- OneNote 筆記本
- 與其他 Office 365 的應用程式（例如 Planner 和 Power BI）進行結合

您可以在 Microsoft Teams 內找到下列專案：

1. **Teams：** 尋找屬於或建立您自己的頻道。 內部頻道您可以保留熱點會議、進行交談及共用檔。
2. **會議：** 查看您在一天或一周中已完成的所有專案。 或者，排程會議。 此行事曆會與您的 Outlook 行事曆同步。
3. **呼叫：** 在某些情況下，如果您的組織已設定，即使他們不是使用 Microsoft Teams，也可以從 Microsoft Teams 呼叫任何人。
...
深入瞭解 Microsoft Teams [Microsoft Teams 技術檔](/microsoftteams/microsoft-teams)

## <a name="admin-settings"></a>系統管理員設定

您必須是系統管理員，才可建立整個組織的團隊。 如需詳細資訊，請參閱[什麼是 Microsoft 365 的系統管理員？](https://support.office.com/article/what-is-an-admin-e123627e-4892-4461-b9aa-1b6d57a5cfa4?ui=en-US&rs=en-US&ad=US)。