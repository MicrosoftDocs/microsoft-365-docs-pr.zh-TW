...
Microsoft 365 提供許多選項來管理您的共同作業解決方案。 我們建議您使用此部署內容與共同作業控管 [內容](collaboration-governance-overview.md) ，為您的組織建立最佳的共同作業解決方案。
...
Microsoft 學習的這些訓練模組可協助您瞭解小組和 SharePoint 中的共同作業、控管和身分識別功能。
