...
9. 在 **[指派權限給特定使用者和群組]** 底下，按一下 **[指派權限]**。
10. 按一下 **[新增組織中的所有使用者和群組]**。
11. 如果有應該獲得解密檔案權限的來賓，請按一下 **[新增使用者或群組]** 並新增這些來賓。
12.  按一下 **[儲存]**，然後按 **[下一步]**。
13. 在 [自動為檔案和電子郵件加上標籤 *]* 頁面上按 [下一步 **]**。
...
- 在 SharePoint 系統管理中心更新網站的來賓共用設定，以將預設共用連結更新為 *擁有現有存取權的人員*。
...
5. 在 **[預設的共用連結類型] 底下，清除 [與組織層級設定相同]** 核取方塊，然後選取 **[擁有現有存取權的人員]**。
6. 按一下 **[儲存]**。
