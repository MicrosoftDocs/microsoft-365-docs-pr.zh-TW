...
3. 按一下 [建立標籤]****。
4. 為標籤輸入與小組名稱類似的名稱。 例如，**高敏感度 - 土星專案**。
5. 新增工具提示，然後按 [下一步]****。
6. 在 [加密]**** 頁面上，於 [加密]**** 下拉式清單中選擇 [套用]****。
7. 若要新增小組權限：<br>
  a. 按一下 [指派權限]****。<br>
  b. 按一下 [新增使用者或群組]****、選取您所建立的小組，然後按一下 [新增]****<br>
  c. 按一下 [選擇權限]****。<br>
  d. 從下拉式清單中選擇 [共同作者]****，然後按一下 [儲存]****。<br>
8. 對於具有此標籤的檔案，如果您想要將有其唯讀存取權的使用者或群組包含進來：<br>
  a. 按一下 [指派權限]****。<br>
  b. 按一下 [新增使用者或群組]****、選取您要新增的使用者或群組，然後按一下 [新增]****。<br>
  c. 按一下 [選擇權限]****。<br>
  d. 從下拉式清單中選擇 [檢視者]****，然後按一下 [儲存]****。<br>
  e. 按一下 [儲存]****。
9. 按 [下一步]****。
10. 如果您想要將頁首、頁尾或浮水印自動新增至以此標籤分類的檔案，請在 [內容標記]**** 頁面上開啟內容標記。
11. 在 [網站和群組設定]**** 頁面上，將 [網站和群組設定]**** 設為 [開啟]****。
12. 在 [Office 365 群組連線小組網站的隱私權]**** 下拉式清單中，選擇 [私人 - 只有成員可以存取網站]****。
13. 如果您想要允許來賓存取，請選取 [讓 Office 365 群組擁有者將貴組織外部的人員新增到群組]**** 核取方塊。 
14. 在 [未受管理的裝置]**** 底下，選擇 [封鎖存取]****。
15. 按 [下一步]****。
16. 在 [Office 應用程式的自動加上標籤]**** 頁面上按 [下一步]****。
17. 按一下 [提交]****，然後按一下 [完成]****。
