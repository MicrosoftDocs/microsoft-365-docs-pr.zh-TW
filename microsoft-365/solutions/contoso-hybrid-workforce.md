...
---
# <a name="contosos-covid-19-response-and-support-for-a-hybrid-workforce"></a>Contoso 的 COVID-19 對混合工作力的回應及支援
...
## <a name="contosos-support-for-a-dynamic-hybrid-workforce"></a>Contoso 對動態混合工作力的支援

在地區鎖定期間，為了支援大多數的遠端工作者所做的初步變更之後，Contoso 進行基礎結構變更，以支援工作者可能的混合工作力：
