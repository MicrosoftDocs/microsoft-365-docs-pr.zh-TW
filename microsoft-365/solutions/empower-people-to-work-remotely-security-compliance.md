...
| 功能 | 描述 | 授權 |
|:-------|:-----|:-------|
| Office 365 進階威脅防護（ATP） | 保護您的 Microsoft 365 應用程式和資料不受攻擊，例如電子郵件訊息、Office 文件和共同作業工具。 <br><br> Office ATP 會收集並分析來自應用程式的訊號，以進行偵測、調查，並修正安全風險，並抵禦電子郵件訊息、連結 (Url) 和共同作業工具所帶來的惡意威脅，以保護組織。 | Microsoft 365 E3 和 E5 | 
| 惡意程式碼防護 | ‎Windows Defender 防毒軟體和 Device Guard 提供裝置型惡意程式碼保護功能。 <br><br> SharePoint‎ Online 會自動掃描檔案上傳是否有已知的惡意程式碼。 ‎<br><br> Exchange Online Protection‎ (‎EOP‎) 可保護雲端信箱。 | Microsoft 365 E3 和 E5 |
