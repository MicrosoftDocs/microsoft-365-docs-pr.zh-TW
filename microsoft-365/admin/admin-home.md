        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>所有人適用：Office 訓練中心</h3>
                        <p><a href="https://go.microsoft.com/fwlink/?linkid=124250">尋找所有 Office 應用程式的訓練。</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>入門</h3>
                        <p><a href="admin-overview/admin-overview.md">誰是我的系統管理員？</a></p>
                        <p><a href="setup/plan-your-setup.md">規劃您的設定</a></p>
                        <p><a href="add-users/add-users.md">新增使用者</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>深入了解</h3>
                        <p><a href="admin-overview/about-the-admin-center.md">了解系統管理中心</a></p>
                        <p><a href="https://docs.microsoft.com/MicrosoftTeams/Microsoft-Teams">Microsoft Teams 文件</a></p>
                        <p><a href="https://go.microsoft.com/fwlink/?linkid=853063">LinkedIn Learning 的進階 IT 專業訓練</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>訂閱</h3>
                        <p><a href="../commerce/buy-a-subscription-from-your-free-trial.md">從免費試用版購買訂閱</a></p>
                        <p><a href="../commerce/subscriptions/cancel-your-subscription.md">取消訂閱</a></p>
                    </div>
                </div>
            </div>
        </div>
