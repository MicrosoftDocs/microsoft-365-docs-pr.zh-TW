...
ms.locfileid: "42547674"
---
# <a name="office-app-for-android-for-office-365-operated-by-21vianet"></a>適用於 Android 的由 21Vianet 運作的 Office 365 的 office 應用程式

Android 版的 Microsoft Office 應用程式會將 Word、 Excel 及 PowerPoint 行動應用程式合併成單一應用程式可供下載的 Android 手機。 使用 Android 版的 Office 應用程式您可以連線到 Office 365 就如同您可以使用 Word、 Excel 及 PowerPoint 行動應用程式。 Android 下載 Office 相關應用程式不會影響任何現有的安裝的 Word、 Excel 及 PowerPoint。

適用於 Android 的功能的幾個 Office 應用程式目前不適用於由 21Vianet 客戶運作的 Office 365 的：
...
## <a name="download-the-office-app-for-android"></a>Android 版下載 Office 應用程式

下載 Office app for Android 電話從任何這些中國存放區：
...
> [!NOTE]
> Android 版的 Office 應用程式是目前適用於僅限電話。 將在稍後新增的平板電腦的支援。 


## <a name="security-considerations"></a>安全考量

如果您的組織發送到員工的行動裝置應用程式，則建議的 Word、 Excel 及 PowerPoint 應用程式取代 Android 版的 Office 應用程式。  
