...
ms.locfileid: "52274361"
---
# <a name="office-365-operated-by-21vianet"></a>由 21Vianet 運作的 Office 365

由世紀運作的 Office 365 旨在滿足在中國安全、可靠及可伸縮的雲端服務的需求。 這項服務由 Microsoft 授權給 21Vianet 的技術提供支援。
  
Microsoft 不直接營運此項服務。 世紀會運作、提供並管理服務的傳遞。 21Vianet 是中國最大的運營商中立網際網路資料中心服務提供者，提供託管、受管理的網路服務，以及雲端運算基礎結構服務。 使用 Microsoft 技術授權，世紀運作當地 Office 365 資料中心，讓您能夠使用 Office 365 服務，同時將您的資料保留在中國。 世紀也會提供您的訂閱和計費服務，以及支援。
 ...
 **關於由世紀運作的 Office 365 中的服務**
  
以下各節強調每個服務的差異重點。 最後，我們的目標是與全域服務達成奇偶。 不過，由於 a 年在中國的資料中心的合作夥伴運作，其運作的獨特性質，有些功能尚未啟用。 經過一段時間後，客戶將會看到服務的功能逐漸完整。 如需適用于由世紀運作之每個 Office 365 計畫的服務的詳細資訊，請參閱[Office 365 服務描述](/office365/servicedescriptions/office-365-platform-service-description/office-365-operated-by-21vianet)。
  
    
如果您想要瞭解如何開始使用一般 Office 365 服務，請參閱[開始](../admin-overview/get-started-with-office-365.md)使用。
...
|訂閱、帳單和技術支援  <br/> |由世紀所提供。 如需如何聯繫支援人員的資訊，請參閱[business support 的連絡人 Office 365](../contact-support-for-business-products.md)。  <br/> |
|自助式密碼重設  <br/> |僅適用于系統管理員。 如需詳細資訊，請參閱[在由世紀運作的 Office 365 中變更或重設密碼](https://support.microsoft.com/office/d8eb5b62-9d0e-4267-a9bf-2aa491ee6d0b)。  <br/> |
|支援層級的安全性、隱私權、合規性及詳細資料  <br/> |由世紀所提供。  <br/> |
|Office桌面設定  <br/> |Office 2010 和 Office 2007 無法使用 Office 桌面設定。 不過，系統管理員可以[將目前的 Office 桌面應用程式設定為搭配 Office 365](https://support.microsoft.com/office/85646aba-7e6c-4e24-a047-8fd9ce4f9d2e)使用。  <br/> |
|行動裝置和裝置支援\*  <br/> | 即將推出下列行動裝置功能：  <br/>  移動裝置管理 (MDM)   <br/>  Blackberry Business 雲端服務 (BBCS) 無法使用，但是您可以使用 Exchange ActiveSync 裝置或的行動， (邊緣，BlackBerry 無線電子郵件解決方案) ，以執行 BlackBerry Enterprise Server (# #) 。  <br/>  如需行動支援的詳細資訊，請參閱 [Set up and manage mobile access for a 使用者](https://support.microsoft.com/office/01fff219-4492-40f2-82d3-fd2ffc0ad802)。  <br/> |
|Office Lens  <br/> |不提供。  <br/> |
|Microsoft Planner  <br/> |即將推出。  <br/> |
|Microsoft Teams  <br/> |無法使用。  <br/> |
|Sway  <br/> |即將推出。  <br/> |
|多種語言的說明  <br/> |[說明] 只適用于簡體中文和英文版。  <br/> |
|Community 提供的說明  <br/> |尚無法使用 Community 提供的說明，但您可以選取 [說明] 按鈕 ( **？** 在入口網站右上角 ) ，查看 [說明] 文章。  <br/> |
...
|能夠轉譯文字或頁面  <br/> |可供使用，但預設為關閉。 租使用者系統管理員可以開啟此功能，但翻譯雲端服務可能位於您的國家/地區以外。 如果您不想要讓使用者將內容傳送至翻譯雲端服務，您可以停用這些功能。  <br/> |
|公用網站 ICP 註冊  <br/> |中國網際網路相容性原則要求您取得網際網路內容提供者 (您公用網站的 ICP) 號碼。  |
|公用網站功能  <br/> |只有在2015年3月9日之前購買 Office 365 時，才可使用公用網站。 不過，如果這些功能可能會傳送您國家/地區以外的資料，就無法在公用網站上使用 Bing 對應、外部共用及批註。  <br/> |
...
|Office 365開發人員網站：使用賣方儀表板發佈至 SharePoint 存放區\*  <br/> |瞭解[提交應用程式的 SharePoint](/office/dev/store/submit-sharepoint-add-ins-for-office-365-operated-by-21vianet-in-china) ，以將其發佈至由世紀運作之 Office 365 的使用者。  <br/> |
...
|資訊版權管理  <br/> |即將推出。  <br/> |
|Free/Busy 資訊  <br/> |可使用內部部署和 Exchange Online 信箱之間的 Free/Busy 資訊。  <br/> |
|共用您的行事曆  <br/> |可使用內部部署與 Exchange Online 信箱之間的行事曆共用。  <br/> |
|共用連絡人  <br/> |即將推出。  <br/> |
|郵件追蹤  <br/> |即將推出。  <br/> |
|應用程式  <br/> |即將推出。  <br/> |
|位置功能  <br/> |這項功能顯示電子郵件中的位址對應;因為它可能允許超出您國家/地區的資料，所以無法使用。  <br/> |
|連線的帳戶  <br/> |即將推出其他帳戶（如 Hotmail (Outlook .com) ）。  <br/> |
   
## <a name="exchange"></a>Exchange

 Exchange 2013 累積更新 5 (CU5) 、內部部署 Exchange 2013 組織和 Office 365 服務之間的全功能混合式部署現在已支援。 利用混合式設定向導中的新改進功能，Exchange 2013 CU5 支援您的內部部署和 Exchange Online 組織之間的下列混合式功能：  
...
- Outlook 連絡人的 MailTips、HD 相片支援，以及內部部署和 Exchange Online 組織之間的多信箱搜尋。 
- 適用於內部部署 Exchange 信箱的雲端式郵件封存。 

針對執行較舊版本或混合式 Exchange Server 的組織，有些混合式功能並不是由世紀主控 Office 365 承租人所支援。 請使用下表深入瞭解不同 Exchange 部署案例中的混合式功能支援：  <br/> 


|**On-Premises Exchange 版本**|**Exchange混合伺服器版本**|**是否支援混合式設定向導？**|**支援的混合式功能**|
|:-----|:-----|:-----|:-----|
| 2016  <br/> | 不適用  <br/> | 是  <br/> | 全部  <br/> |
| 2013 CU5  <br/> | 不適用  <br/> | 是  <br/> | 全部  <br/> |
| 2013 SP1  <br/> | 2013 CU5  <br/> | 是  <br/> | 全部  <br/> |
| 2013 SP1  <br/> | 2013 SP1  <br/> | 是  <br/> | 全部  <br/> |
| 混合 2013 SP1/2010 SP3  <br/> | 2013 CU5  <br/> | 是  <br/> | 全部，除了就地 eDiscovery/封存之外，OWA access (請參閱下表)   <br/> |
| 混合 2013 SP1/2010 SP3  <br/> | 2013 SP1  <br/> | 是  <br/> | 僅手動設定空閒/忙碌  <br/> |
| 2010 SP3  <br/> | 2010 SP3  <br/> | 否  <br/> | 無  <br/> |
| 2007  <br/> | 2013 CU5  <br/> | 是  <br/> | 僅空閒/忙碌  <br/> |
| 2007  <br/> | 2013 SP1 或 2010 SP3No  <br/> | N/A  <br/> | 不支援  <br/> |
| 2003  <br/> | 2013 SP1/CU5  <br/> | N/A  <br/> | 不支援  <br/> |
| 2003  <br/> | 2010 SP3  <br/> | 否  <br/> | 無  <br/> |

   
> [!IMPORTANT]
>  委派行事曆存取，當使用者或一組使用者提供存取另一個使用者的行事歷時，混合式部署中不支援由世紀所主控的 Office 365 承租人。 
  
 此外，混合式部署中，有些 Exchange 郵件原則和符合性功能並不完全支援由世紀主控 Office 365 承租人。 這些功能包括：
...
- 使用[Outlook Web App (OWA) ](/exchange/clients-and-mobile-in-exchange-online/outlook-on-the-web/outlook-on-the-web)存取線上歸檔 

請使用下表深入瞭解不同 Exchange 部署案例中的功能支援： 

|**On-Premises Exchange 版本**|**MRM (分割封存)**|**OWA access (分割封存)**|**就地電子文件**|**信箱審核**|**保留/封存 In-Place**|
|:-----|:-----|:-----|:-----|:-----|:-----|
| 所有 2013 CU5  <br/> | 支援 <br/>  | 不支援 <br/>  | 支援 <br/>  | 支援  <br/> | 支援 <br/> |
| 所有 2010 SP3 <br/>  | 不支援 <br/>  | 不支援 <br/>  | 支援<sup>1</sup> <br/> | 支援  <br/> | 支援 <br/>  |
| 至少一部 2013 CU5 伺服器  <br/> | 支援<sup>2</sup> <br/> | 不支援  <br/> | 不支援 <br/> | 支援  <br/> | 支援 <br/> |
|||
...
|||
|:-----|:-----|
|從 Office 用戶端中管理帳戶 ()   <br/> |這項功能，以及要移至 Office 365 入口網站的其他功能，目前指向全球 Office 365 入口網站，您無法使用由您的 Office 365 （由世紀帳戶運作）進行登錄。 這是正修正的已知問題。 同時，您可以使用 URL 登 https://portal.partner.microsoftonline.cn/ 入您的帳戶，並從那裡管理設定。 如需詳細資訊，請參閱 [管理您的 Microsoft 365 應用程式企業版帳戶（由世紀運作的 Office 365](https://support.microsoft.com/office/fbe473d3-69de-4d0c-aecb-b9c2d0d45bc8)）。  <br/> |
...
|研究工具  <br/> |無法使用。  <br/> |
|貼 紙  <br/> |無法使用。  <br/> |
|即時搜尋 (在用戶端中未開啟的線上筆記本中搜尋的功能)   <br/> |無法使用。  <br/> |
|與 Mac 和 iOS 平臺的智慧查閱服務整合  <br/> |無法使用。  <br/> |
|共用筆記本經驗和共用通知  <br/> |無法使用。  <br/> |
...
|整合合作夥伴  <br/> |無法使用。  <br/> |
|語音功能（例如語音信箱）可以從 PSTN 號碼撥打和接聽電話、來電轉接、來電轉接  <br/> |無法使用。 這些功能需要整合合作夥伴。  <br/> |
|封存或標記使用者的電子郵件和 IMs 以進行 Exchange 的功能  <br/> |無法使用。  <br/> |
|商務用 Skype Web 用戶端 (LWA) browser 支援 Firefox 29  <br/> |無法使用，但您可以使用舊版本的 Firefox。  <br/> |
|整合連絡人存放區 (UCS)   <br/> |使用者可停用在 Microsoft Exchange Server 2013 中保留其所有商務用 Skype 連絡人資訊的功能。  <br/> |
| 會議裝置：  <br/>  Polycom CX5100 的整合會議站  <br/>  Logitech ConferenceCam CC3000e  <br/>  Polycom CX7000  <br/>  Polycom CX3000  <br/>  Logitech BCC950 ConferenceCam  <br/>  Polycom CX5000 HD  <br/> |無法使用。  <br/> |
   
## <a name="data-subject-requests-for-gdpr"></a>GDPR 的資料主體要求

GDPR 授與個人 (，或資料主體) 某些與處理個人資料的處理相關的權利，包括更正不正確的資料、擦除資料或限制處理、接收資料，以及完成將資料傳輸至另一個控制器的要求。 由世紀運作之 Office 365 的租使用者系統管理員角色，可透過下列方式代表資料主體要求資料：
  
- 租使用者系統管理員可以使用 Azure Active Directory 系統管理中心，永久刪除 Azure Active Directory 和相關服務中的資料主體。
...
[嘗試或購買 Microsoft 365 for business 訂閱](../../commerce/try-or-buy-microsoft-365.md) (文章) 

[受世紀運作之 Office 365 的 Azure 資訊保護支援](parity-between-azure-information-protection.md) (文章) 
