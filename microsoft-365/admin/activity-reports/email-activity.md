...
|6.  <br/> |您可以選取圖例中的專案，以篩選您在圖表上看到的數列。 例如，在 [**活動**] 圖表上，選取 [**已傳送**、**已接收**、**讀取**、**會議建立**] 或 [**會議**互動篩選] ![ 圖表以取得特定相關資料， ](../../media/6065f515-b97b-4829-b683-a7667542d1af.png) 以查看只與各項相關的資訊。   變更此選取項目並不會變更格線資料表中的資訊。  <br/> |
...
|8.  <br/> |您也可以選取 [ **匯出**] 按鈕連結，將報告資料匯出至 Excel .csv 檔案 ![ ](../../media/816a224b-6ca7-4967-a135-4f6427f64dc8.JPG) 。 這會匯出所有使用者的資料，並可讓您進行簡單的排序和篩選，以便進一步分析。 如果您的使用者少於 2000 個，您可以直接在報告中的表格內進行排序和篩選。 如果您的使用者多於 2000 個，則需要匯出資料才能進行排序和篩選。  <br/> |
|||
