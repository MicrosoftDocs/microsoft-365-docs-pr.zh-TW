...
|項目|描述|
 ...
 |7.<br/>|表格顯示每個使用者層級的資料明細。 您可以新增或移除表格中的欄位。 <br/><br/>**Username** 是在 Microsoft app 上執行活動之使用者的電子郵件地址。<br><br/>**上次啟用日期 (UTC)** 是使用者啟用其 Microsoft 365 應用程式訂閱的最晚日期。<br/><br/>**上次活動日期 (UTC)** 是使用者執行有意活動的最晚日期。 若要查看特定日期發生的活動，請直接選取圖表中的日期。<br/><br/>下列各欄會對應至每個應用程式，識別使用者在該應用程式中所選期間內的使用中狀態：<br> <br>**Outlook** <br>**Word** <br>**Excel**<br>**PowerPoint** <br>**OneNote**<br><br> 下列各欄會對應至每個平臺，以識別使用者在該平臺上是否使用的任何應用程式，以及在所選期間內) 的任何應用程式 365 (：<br><br>**Outlook (Windows)**<br>**Outlook (Mac)**<br>**Outlook (網頁)** <br>**Outlook (Mobile)**<br> **Word (Windows)**<br> **Word (Mac)**<br> **Word (Web)**<br> **Word (Mobile)**<br> **Excel (Windows)**<br> **Excel (Mac)**<br> **Excel (網頁)**<br> **Excel (Mobile)**<br> **PowerPoint (Windows)**<br> **PowerPoint (Mac)**<br>**PowerPoint (網頁)**<br> **PowerPoint (行動)**<br> **OneNote (Windows)**<br> **OneNote (Mac)**<br> **OneNote (網頁)**<br>**OneNote (行動)**<br> **團隊 (Windows)**<br> **小組 (Mac)**<br> **小組 (網頁)**<br>**(Mobile) 小組** |
