...
|4.  <br/> |[ **儲存** 空間] 圖表顯示組織中所使用的儲存量。 儲存圖表不包含封存信箱。 如需有關自動展開封存的詳細資訊，請參閱 [Microsoft 365 中的無限封存概述](../../compliance/unlimited-archiving.md)。<br/> |
...
|10.  <br/> |您也可以選取 [ **匯出** ] 連結，將報告資料匯出至 Excel .csv 檔案。  <br/> |
|||
