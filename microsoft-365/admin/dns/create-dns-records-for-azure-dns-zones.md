...
1. 若要開始，使用[這個連結](https://portal.azure.com )移至您在 Azure 的網域頁面。 系統會提示您先登入。
...
4. 在 [**新增記錄集**] 區域中，於新記錄集的方塊中選取值從下表。 
    ...
    |**名稱**|**Type**|**TTL**|**TTL 單位**|**喜好設定**|**郵件交換**|
    |:-----|:-----|:-----|:-----|:-----|:-----|
    |@  <br/> |MX  <br/> |1  <br/> |小時  <br/> |10   <br/> 如需關於優先順序的詳細資訊，請參閱[什麼是 MX 優先順序？](https://support.office.com/article/2784cc4d-95be-443d-b5f7-bb5dd867ba83.aspx) <br/> | *\<網域金鑰\>*  .mail.protection.outlook.com  <br/> **附註：** 取得您*\<網域金鑰\>* 從您的 Office 365 帳戶。   [如何找到呢？](../get-help-with-domains/information-for-dns-records.md)  
