...
4. 在 [**自訂 MX 記錄**] 區段，於新記錄的方塊中輸入或複製並貼上下表中的下列值。 
    ...
    |**MX 記錄 （必要）**|
    |:-----|
    |0  *\<網域金鑰\>*  .mail.protection.outlook.com.  <br/> **This value MUST end with a period (.)** <br/> 0 是指 MX 優先順序值。請將它新增到 MX 值的開頭，並以空格分隔該值的其餘部分。  <br/> **附註：** 取得您*\<網域金鑰\>* 從您的 Office 365 帳戶。           [如何找到呢？](../get-help-with-domains/information-for-dns-records.md)          |
