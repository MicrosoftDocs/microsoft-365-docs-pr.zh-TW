...
6. In the **Add Record** area, in the boxes for the new record, type or copy and paste the values from the following table. 
    ...
    |TXT  <br/> |（將此欄位保留空白）  <br/> |MS=ms *XXXXXXXX*  <br/> 附註： 這是範例。 Use your specific **Destination or Points to Address** value here, from the table in Office 365. [How do I find this?](../get-help-with-domains/information-for-dns-records.md)          |
...
6. 新增兩筆 SRV 記錄中的第一筆。<br/>在 [**新增記錄**] 區域中，於新記錄的方塊中輸入或複製並貼下表中第一列的值。 <br/>（從下拉式清單選擇 [**類型**] 和 [ **TTL**值）。 
    ...
    |**類型**|**服務**|**通訊協定**|**Name**|**Host (主機)**|**優先順序**|**Weight**|**Port**|**TTL**|
    |:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
