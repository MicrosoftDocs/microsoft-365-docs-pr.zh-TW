...
5. 新增第一筆 CNAME 記錄。
    ...
    |lyncdiscover  <br/> |CNAME - 正式名稱  <br/> |無  <br/> |300  <br/> |webdir.online.lync.com.  <br/> **此值必須以英文句點 (.) 結尾。** <br/> |簡易  <br/> |
    |enterpriseregistration  <br/> |CNAME - 正式名稱  <br/> |無  <br/> |300  <br/> |enterpriseregistration.windows.net.  <br/> **此值必須以英文句點 (.) 結尾。** <br/> |簡易  <br/> |
    |enterpriseenrollment  <br/> |CNAME - 正式名稱  <br/> |無  <br/> |300  <br/> |enterpriseenrollment-s.manage.microsoft.com.  <br/> **此值必須以英文句點 (.) 結尾。** <br/> |簡單  <br/> |
...
5. 在 [ **編輯記錄集** ] 區域中，于現有記錄的 [ **值：** ] 方塊中的目前專案的結尾，按下鍵盤上的 enter，以建立新行;然後，在該行) 的現有值 (下，輸入或複製並貼上下表中的值。  (您可以在表格下方的圖例中看到範例。 )  
