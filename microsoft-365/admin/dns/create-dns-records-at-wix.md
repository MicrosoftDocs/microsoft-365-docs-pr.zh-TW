...
4. In the boxes for the new record, type or copy and paste the values from the following table. 
   ...
   ||||
   |:-----|:-----|:-----|
   | 主機名稱 <br/> | TXT Value <br/> | TTL <br/> |
   |自動填入  <br/> |MS=ms *XXXXXXXX*  <br/> **附註：** 這是範例。 在這裡請使用您自己來自表格的 **[目的地或指向位址]** 值。  [如何找到呢？](../get-help-with-domains/information-for-dns-records.md)|1 小時 <br/> |          |
...
5. 在新記錄的方塊中，輸入或複製並貼上下清單格中的值：
   ...
   | 主機名稱 | 指向 | 優先順序 | TTL |
   |:-----|:-----|:-----|:-----|
   |自動填入 <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/> **附注：***\<domain-key\>* 從您的 Microsoft 帳戶取得。   [How do I find this?](../get-help-with-domains/information-for-dns-records.md) |0  <br/> 如需關於優先順序的詳細資訊，請參閱[什麼是 MX 優先順序？](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq) | 1 小時|
...
4. 在新記錄的方塊中，輸入或複製並貼上下清單格中的值：
   ...
   | 主機名稱 | Points to  | TTL |
   |:-----|:-----|:-----|
   |autodiscover  <br/> |autodiscover.outlook.com  <br/> |1 小時  <br/> |
   |sip  <br/> |sipdir.online.lync.com  <br/> |1 小時 <br/> |
   |lyncdiscover  <br/> |webdir.online.lync.com   <br/> |1 小時  <br/> |
