...
以下是要新增的主要記錄。 請依照下列步驟操作或[觀看影片](https://support.microsoft.com/office/c49698c2-6991-47fb-b5ac-18e49a505099)。 
...
在 [網路方案] 中新增這些記錄之後，您的網域就會設定為與 Microsoft 服務搭配使用。
...
6. 在新記錄的方塊中，輸入或複製並貼上下表中的值。
    ...
    |:-----|:-----|:-----|
    |10   <br/> 如需關於優先順序的詳細資訊，請參閱[什麼是 MX 優先順序？](../setup/domains-faq.yml) <br/> |3600  <br/> | *\<domain-key\>*  mail.protection.outlook.com。  <br/> **此值必須以英文句點 (.) 結尾。** <br/> **附注：***\<domain-key\>* 從您的 Microsoft 帳戶取得。 [如何找到呢？](../get-help-with-domains/information-for-dns-records.md)          |
...
請依照下列步驟操作或[觀看影片 (從 6:18 處開始)](https://support.microsoft.com/office/c49698c2-6991-47fb-b5ac-18e49a505099)。
