...
6. 在**新的 MX 記錄**表單中，輸入或複製並貼上下表中的值。 
    ...
    |**名稱**|**TTL （秒）**|**Exchange （指向位址] 或 [值）**|**為主機的完整？**|**喜好設定 （優先順序）**|
    |:-----|:-----|:-----|:-----|:-----|
    |(保留空白)  <br/> |3600 （秒）  <br/> | *\<網域金鑰\>*  .mail.protection.outlook.com  <br/> **附註：** 取得您*\<網域金鑰\>* 從您的 Office 365 帳戶。  [如何找到呢？](../get-help-with-domains/information-for-dns-records.md)      |（選取這個核取方塊）  <br/> |10   <br/> For more information about priority, see What is MX priority?  <br/> |
