...
6. 在新記錄的方塊中，輸入或複製並貼上下表中的值。 若要指派 TTL 值，請從下拉式清單中選擇 [ **個人** 化]，然後在文字方塊中輸入值。 
    ...
    |:-----|:-----|:-----|:-----|:-----|
    |MX  <br/> |(保留空白)  <br/> |3600 (秒)   <br/> |10   <br/> 如需關於優先順序的詳細資訊，請參閱[什麼是 MX 優先順序？](../setup/domains-faq.yml) <br/> |\<domain-key\>mail.protection.outlook.com。  <br/> **附注：***\<domain-key\>* 從您的 Microsoft 帳戶取得。  [如何找到呢？](../get-help-with-domains/information-for-dns-records.md)  |
