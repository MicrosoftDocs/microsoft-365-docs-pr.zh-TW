...
**摘要：** 瞭解您的業務面臨之威脅的基本術語，以及您可以採取哪些措施來保護您的資料、帳戶和裝置。 做為適用于商務用 Microsoft 365 的系統管理員，採取行動使您的業務更安全，並協助每個員工瞭解如何讓您的商務資料和裝置安全。

下列 PowerPoint 和 PDF 的連結可以以 tabloid 格式（也稱為分類帳、11 x 17 或 A3）下載及列印。
