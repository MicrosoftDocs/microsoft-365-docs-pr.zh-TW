...
系統管理應用程式是一種功能豐富的應用程式，具有超過80的功能，可協助您在無法前往電腦時管理您的組織。 以下是您可以從應用程式執行的一些工作清單：
...
觀賞有關安裝 admin 行動應用程式的簡短影片。<br><br>
...
您必須具備有效的 Microsoft 365 應用程式365，才能使用系統管理員許可權來登入及使用此應用程式。 Admin 行動裝置應用程式不是電子郵件客戶程式。 這是一種豐富的系統管理應用程式，具有超過80的功能，可協助您在旅途中協助您支援您的組織。
  
### <a name="can-i-use-the-app-with-my-microsoft-365-family-subscription"></a>我可以搭配 Microsoft 365 系列訂閱使用此應用程式嗎？

否，該應用程式僅適用于 Microsoft 365 應用程式和 Microsoft 365 商務版特優訂閱。 
...
該應用程式支援以 web 為基礎的 Microsoft 365 系統管理中心所支援的所有39語言。 
