...
- 裝置型訂閱：您可以將**microsoft 365 應用程式教育版（裝置）** 授權指派給或取消指派給 microsoft 365 系統管理中心內的裝置。 **Microsoft 365 教育版應用程式（裝置）** 是附加元件授權，可讓您將授權指派給裝置。 移至**帳單** > **產品 & 服務**，以尋找及購買授權。
