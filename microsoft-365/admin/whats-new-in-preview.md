...
### <a name="videos-training-and-docs-january"></a>影片、訓練及檔（一月）
...
### <a name="office-whats-new-management-preview"></a>Office 「新功能」管理（預覽）
...
- 裝置型訂閱：您可以將**microsoft 365 應用程式教育版（裝置）** 授權指派給或取消指派給 microsoft 365 系統管理中心內的裝置。 **Microsoft 365 教育版應用程式（裝置）** 是附加元件授權，可讓您將授權指派給裝置。 請移至**帳單**  >  **產品**以尋找並購買授權。
...
### <a name="report-an-issue-august"></a>報告問題（八月）
