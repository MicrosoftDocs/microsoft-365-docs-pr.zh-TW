...
若要深入瞭解這些新功能，請參閱 [Message center](manage/message-center.md)。

### <a name="whats-new-features"></a>新功能

我們已改進如何在 Office 應用程式中查看使用者的「新增功能」功能。 您現在可以在 [內容] 的 [新增] 窗格中看到豐富的內容，讓使用者可以看到。 您也可以在決定讓使用者瞭解該功能之前深入瞭解該功能。 如需詳細資訊，請參閱[管理「新功能」中所顯示的 Office 功能](manage/show-hide-new-features.md)。
...
- 移至 [ **使用者**]，然後在三個點 (多個動作) 功能表中，選取 [ **管理優先順序帳戶** ]，將使用者新增至清單。
...
- 搜尋方塊移至「Microsoft 365 系統管理中心」所在的頁首區域，所以現在您可以從任何頁面（而不只是首頁）進行搜尋。 我們甚至已獲得快捷方式： **Alt + S**。
- 搜尋更聰明，可提供更好的結果，甚至更快速。 請嘗試輸入 "2fa" 開始著手。
- 搜尋結果會依您可以採取的專案類型或動作進行組織。
  - **使用者**：選取使用者的名稱，您可以在其中編輯該使用者。 如果您選取 [三個點 (更多動作) ] 功能表上的名稱旁邊，您可以重設其密碼。 您可以依顯示名稱、姓氏、名字、username 或主要電子郵件地址，以及電子郵件別名進行搜尋。 但若要取得完全相符，請依主要電子郵件地址或使用者名稱進行搜尋。
...
### <a name="microsoft-365-admin-mobile-app"></a>Microsoft 365 admin 行動應用程式

您的訂閱所隨附的[Microsoft 365 系統管理行動應用程式](https://www.microsoft.com/microsoft-365/business/manage-office-365-admin-app)，可讓您從行動裝置管理 Microsoft 365，這樣您就能從您的桌面執行每日工作。 實際上，應用程式中有超過90的功能--而且我們只會新增一些功能：

- **支援 Microsoft Intune 的行動應用程式管理和條件式存取原則**：即使您的組織已開啟 Intune 的行動應用程式管理和條件式存取原則，您還是可以使用您的個人裝置管理 Microsoft 365。
- **郵件中心通知**：   >  如果您想要收到有關新的郵件中心文章的警示，請在設定 **通知** 中開啟郵件中心通知。 透過通知，我們想要確保您及時瞭解租使用者的重要資訊和事件。
- **帳單** 通知：   >  如果您想要在訂閱即將到期時，在裝置上取得帳單通知，您也可以在設定 **通知** 中開啟帳單通知。
- **深色模式**：歡迎使用行動應用程式的深邊。 這是我們最要求的功能之一。 移至 **設定**  >  **主題**，將其開啟。
...
如果組織中的某些人員並未使用 Teams、OneDrive 或 Office 應用程式，則小型和中型企業可能會在 **首頁** 上獲得建議。 當您查看建議時，您可以將 Microsoft 訓練傳送至非使用中的使用者，以協助他們開始使用應用程式，並確認您已從您的訂閱取得完整的價值。
...
- Microsoft 365 影片系列有[哪些新](https://www.youtube.com/watch?v=OVjb2lGJ4GU&t=2s)功能：本月，我們涵蓋白板中的 Teams 和網頁上可用的新功能，如何自動化使用者布建至 Azure AD、新增 Power Automate 觸發器和 Teams 中的動作等等。 並在下個月繼續深入瞭解，我們將在 Ignite 取得所有重要事情的回顧！
...
網域管理可能很複雜，而且我們已發佈新功能，讓這種情況變得更容易。 移至設定 > 網域]，然後選取網域，以取得網域和網域健康狀態的詳細資訊。
...
[Microsoft 365 影片系列有哪些新功能](https://youtu.be/m1Nu8WJgCDY)：本月，我們涵蓋網頁與行動裝置的新 Yammer 體驗，如何整合 Microsoft Teams 的 Yammer 社區應用程式、新原則套件，以支援 Firstline 工作者和主管等等。

## <a name="june-2020"></a>2020 年 6 月

### <a name="keeping-up-with-office-whats-new-management"></a>時刻 Office 新的管理

在幾個月之前，我們新增了一個設定，可讓您管理在使用者的 Office 應用程式中顯示的新訊息。 本月，我們發行的是新的首頁卡片，可協助您快速行動並追蹤您要向組織中的使用者顯示的 **新** 訊息。

### <a name="docs-training-and-videos-june"></a> (年6月的檔、訓練和影片) 

- [Teams 快速入門](../business-video/get-started-teams-small-business.md)

## <a name="may-2020"></a>2020 年 5 月

### <a name="new-update-channel-for-office"></a>Office 的新更新通道
...
### <a name="sync-message-center-posts-to-planner"></a>同步處理郵件中心至 Planner 的文章
...
隨著 Teams 的使用量增加，我們已新增一些功能來協助您進行管理。

- 系統管理中心首頁上的新建議卡會顯示哪些使用者未使用 Teams 30 天。 您可以將訓練電子郵件傳送給這些使用者，讓他們開始使用 Teams。
- 將 **人員放在一起**：請移至 [**設定**] 以查看新的頁面，以協助您開啟授權使用者的 Teams，並允許來賓存取，因此您可以使用 Teams 中的外部客戶。
- Microsoft Teams 卡片現在會固定在首頁上。 它會顯示 Teams 是否已開啟，以及是否允許來賓存取。 它也可讓您檢查是否有新授權 Teams 使用者的設定狀態，並檢查網路問題是否會影響 Teams 使用者。
- 最後，如果您購買包含 Teams 的授權，Teams 現在是初始設定流程中的步驟。

### <a name="productivity-score"></a>生產力分數
...
如果您想要深入瞭解，請參閱博客：[衡量和提高 Microsoft 生產力分數的 Microsoft 365 體驗](https://techcommunity.microsoft.com/t5/microsoft-365-blog/measure-and-improve-the-microsoft-365-experience-with-microsoft/ba-p/1348618)。 目前私人預覽中的生產力分數。 [加入生產力分數私人預覽](https://aka.ms/productivityscorepreview) 開始。

### <a name="groups-updates"></a>群組更新

本月的群組有兩個更新：

- 您現在可以編輯 Office 365 群組的電子郵件地址 (也稱為「Outlook 中的群組」，並很快稱為 Microsoft 365 群組) 。
- 我們已聽說您的意見反應，我們新增了更清晰的錯誤訊息，讓您無法將群組轉換為 Microsoft 團隊。

### <a name="docs-videos-and-training-april"></a> (四月) 的檔、影片及訓練

**Microsoft 365 影片系列的新功能**：本月，我們涵蓋秘訣和資源，協助小型企業轉變為遠端工作，包括如何進行 Microsoft Teams、遠端工作訓練資源，以與用戶端和合作夥伴保持連線，以及新的 Microsoft 365 商務語音計畫。 [Microsoft 365 的新功能](https://go.microsoft.com/fwlink/p/?linkid=2118096)

#### <a name="for-your-users"></a>為您的使用者

- [排程會議](../business-video/schedule-guest-meeting.md)
- [加入 Teams 會議](https://support.microsoft.com/office/078e9868-f1aa-4414-8bb9-ee88e9236ee4)
...
- [使用遠端工作為小型企業提供協助](https://support.microsoft.com/office/9b91a85a-39b4-40a6-a590-0f9bea0ba8e6)
...
### <a name="microsoft-teams-home-page-card"></a>首頁頁面卡片 Microsoft Teams

透過 uptick Teams 使用中，有些組織 emc 會取得一個固定的儀表板卡，使 Teams 更容易探索。 這張卡片也具有訓練及檔的連結，可協助您的組織轉換至遠端工作。 請移至 **首頁** 以查看新的卡片。
...
當系統管理員建立新的群組，並讓它同時成為小組時，他們可以指派沒有授權的擁有 Teams 的擁有者。 而且這會產生一些麻煩。 我們已更新嚮導流程，以確認擁有者有 Teams 授權，而且如果不選擇將群組轉換為小組已停用。

### <a name="microsoft-365-offerings-for-small-and-medium-businesses"></a>適用于中小型企業的 Microsoft 365 服務

我們知道這是下個月的宣告，但我們想要確保您已做好準備。

從4月21日起，我們將對中小企業的 Office 365 訂閱相關變更，並 Office 365 專業增強版。 這些產品現在會使用 Microsoft 365 商標。
...
|Office 365 專業增強版    |   Microsoft 365 企業應用程式      |

### <a name="videos-training-and-docs"></a>影片、訓練及檔

[Microsoft 365 web 系列的新](https://go.microsoft.com/fwlink/p/?linkid=2118096)功能：在這個月的劇集中，我們會反白顯示的3年周年 Microsoft Teams 和涵蓋的新功能，包括線上會議中增強的音訊品質、firstline 管理員的目標通訊，以及倒班應用程式、Teams 和 Skype 使用者互通性等等。

## <a name="february-2020"></a>2020 年 2 月

### <a name="featured-feedback-fix-multi-organization-switcher"></a>功能回饋修正：多組織切換器
...
- **Microsoft 365 影片系列的新** 功能：本月，我們主要致力於 SharePoint 線上的自訂搜尋功能，這是 Office 「新增功能」的管理功能，可讓您透過應用程式的 [說明] 窗格中的使用者來顯示或隱藏特定功能、Yammer 中的最新安全性和符合性更新等等。 以下是最新的劇集： [Microsoft 365 的新功能](https://go.microsoft.com/fwlink/p/?linkid=2118096)

- 檔 **移動**：我們會結合 Office 365 系統管理網頁與 Microsoft 365 內容，並可能注意到新的 URL。 例如，本文的用途是： **docs.microsoft.com/Office365/Admin/whats-new-in-preview**，但 URL 現在是： **docs.microsoft.com/microsoft-365/admin/whats-new-in-preview**。 如果您已將頁面加上書簽，則應該更新連結;不過，內容連結會重新導向至新的內容儲存機制。
