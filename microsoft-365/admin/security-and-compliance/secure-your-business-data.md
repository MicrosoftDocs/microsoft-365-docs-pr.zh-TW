...
|9 |[使用 ATP 安全附件防護惡意附件和檔案](secure-your-business-data.md#atp)||![包含](../../media/d238e041-6854-4a78-9141-049224df0795.png)|
|10 |[使用 ATP 安全連結防禦網路釣魚攻擊](secure-your-business-data.md#phishingatp)||![包含](../../media/d238e041-6854-4a78-9141-049224df0795.png)|
...
駭客有時候會在電子郵件或其他檔案的連結中隱藏惡意網站。 Office 365 ATP 安全連結 (ATP 安全連結) （Office 365 的部分高級威脅防護）可在電子郵件訊息和 Office 檔中，透過網頁位址的驗證， (URLs) 來協助保護您的組織。 保護是透過 ATP 安全連結原則定義。
...
如需詳細資訊，請參閱 [Office 365 ATP 中的安全連結](https://docs.microsoft.com/microsoft-365/security/office-365-security/atp-safe-links)。
