...
|**設定或選項**|**建議的設定** <br/>|
|:-----|:-----|
|姓名  <br/> |使用偵測到的惡意程式碼封鎖目前和未來的電子郵件。  <br/> |
