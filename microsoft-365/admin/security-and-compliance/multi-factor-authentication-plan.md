...
Office 365 使用多重要素驗證來協助提供額外的安全性，並從 Microsoft 365 系統管理中心管理。 Office 365 的訂閱中提供下列 Azure 多重要素驗證功能子集： 
...
1. 啟用新式驗證的用戶端：
  ...
  - 使用協力廠商目錄服務設定 Azure MFA。
    ...
    此計畫接受的特定身分識別提供者，請參閱[Azure 多重要素驗證與協力廠商的 VPN 解決方案的進階的案例](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfaserver-nps-vpn)的資訊。 
