...
您可以在精靈中新增使用者，或稍後在系統管理中心[[新增使用者]](../add-users/add-users.md)。
...
3. 在下一頁中，您可以新增使用者，他們會自動取得 Microsoft Apps 商務版授權。 新增使用者之後，您也會看到與您新增之使用者共用認證的選項。 您可以選擇列印認證、透過電子郵件傳送認證，或是下載認證。
 ...
 註冊程序完成後，系統會將您導向系統管理中心，您可以在該處新增使用者，以及指派授權。 
...
取得適用您裝置的步驟︰[Android](https://support.microsoft.com/office/6ef2ebf2-fc2d-474a-be4a-5a801365c87f) | [iOS](https://support.microsoft.com/office/0402b37e-49c4-4419-a030-f34c2013041f) | [Windows Phone](https://support.microsoft.com/office/9bccc8b8-a321-4d0d-a45e-6e06a3438e43)
...
在註冊時，您選擇了 onmicrosoft 網域。 您也可以在您的帳戶新增自訂網域，例如 *contoso.com*，以便個人化電子郵件。 如需詳細資訊，請參閱[[新增網域]](add-domain.md)。