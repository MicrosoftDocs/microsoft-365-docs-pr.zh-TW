...
您可以從 Microsoft 365 系統管理中心或 [使用 PowerShell](https://docs.microsoft.com/microsoft-365/enterprise/manage-microsoft-365-groups-with-powershel)管理您的群組。
...
任何有 Exchange Online 和 SharePoint 線上的 Microsoft 365 訂閱都會支援群組。 包括商務基本版和商務用的方案，以及 Enterprise E1、E3 和 E5 計畫。 群組會接受建立群組 (人員的授權，也稱為群組) 的「召集人」。 只要召集人具有您想要群組擁有的任何功能的適當授權，該授權就會傳遞給群組。
