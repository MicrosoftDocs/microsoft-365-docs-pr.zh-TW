...
> [!TIP]
> 如果您不是系統管理員，則可以[使用 Outlook 來新增或移除成員](https://support.office.com/article/3b650f4a-5c9b-4f94-a1bb-0cca4b1091de.aspx)。 
...
3. 在詳細資料窗格的 [**成員**] 旁，選取 [**編輯**]，然後選取 [**新增成員**]。
...
3. 在詳細資料窗格中的 [**群組成員資格**] 旁，選取 [**編輯**]，然後選取 **[新增成員資格**]。
