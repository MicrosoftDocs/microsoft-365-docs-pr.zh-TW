...
生產力分數可協助組織使用有關人員如何使用 Microsoft 365 應用程式和支援技術經驗的衡量方式，來變換工作的運作方式。 分數會反映您的組織&#39;人員和技術經驗的效能，並與您的組織（如您的組織）比較您的分數。 會議類別是人們經驗中的其中一個方法。 若要深入瞭解，請參閱 [生產力排名一覽](productivity-score.md)。

## <a name="why-your-organizations-meetings-score-matters"></a>為什麼您的組織會議得分重要
...
Microsoft 團隊會與 Outlook 行事曆整合，並提供一種功能，讓您的會議更吸引和有效。 主要的洞察力是查看您組織中的所有 Microsoft 團隊線上會議。 主要的洞察力也會追蹤至少一個小組會議的最佳作法中所遵循的會議數目。
...
:::image type="content" source="../../media/number-meeting-over-time.png" alt-text="具有最佳作法之會議的主要洞察力。":::

### <a name="scoring-framework"></a>計分架構

會議分數衡量組織中的線上 Microsoft 團隊會議遵循過去28天的最佳作法的程度。 其加權取決於您的組織中參加會議的人員人數及工期。

## <a name="explore-more-about-meetings-in-your-organization"></a>深入瞭解組織中的會議

我們也會為您提供支援資訊，以瞭解您的組織中的人員如何進行會議。 這些額外的衡量值&#39;t 會直接對您的生產力評分產生貢獻，但可協助您建立行動計畫，以支援人員的運作方式優化。

### <a name="breakdown-of-how-meetings-follow-best-practices"></a>會議遵循最佳作法的方式細目

:::image type="content" source="../../media/videouse-meetings.png" alt-text="具有最佳作法之會議的主要洞察力。":::

1. **標頭：**  強調使用主要洞察力和計分中所述的視頻最佳作法之線上 Microsoft 團隊會議所占的百分比。
2. 本文 **：** 提供在會議中使用這些作法的資訊，讓他們更參與。 
...
:::image type="content" source="../../media/percentageofpeopleusingteams.png" alt-text="具有最佳作法之會議的主要洞察力。":::

1. **標頭：** 顯示您的組織中，每週參加線上 Microsoft 團隊會議的人員占平均20小時以上的時間，取決於過去28天的活動。
2. **Body：** 提供使用會議最佳作法讓會議保持使用中或生產力的詳細資料
3. **視覺效果：** 會提供將組織中的人員的平均時間，依過去28天內每週所花費的平均時間進行分類的視圖。 每個類別會提供下列資訊：
      - **會議出席者總數：** 顯示組織中參加會議的人員人數（根據平均會議期間範圍）。 過去28天。 例如，6-10 小時類別會指出在過去28天內，參加會議的平均人數（每週平均時數小時）。
      - **具有影片的會議出席者：** 針對每個類別，顯示過去28天內，具有影片的任何會議中有多少人。
...
:::image type="content" source="../../media/distribution-meetinglength.png" alt-text="具有最佳作法之會議的主要洞察力。":::

1. **標頭：** 會顯示過去28天內，未預先排定) 線上 Microsoft 團隊會議的瞬間 (百分比（超過30分鐘長）。
2. **Body：** 提供使用立即會議立即解決問題之值的相關資訊。
3. **視覺效果：** 提供長度 (（以分鐘為單位），在過去28天內，在組織中發生的立即和排程會議) 。 分配會將每個會議分類為1-15 分鐘、16-30 分鐘、31-60 分鐘及超過60分鐘。

    > [!NOTE]
    > 排定的會議包括所有在人員 &#39;的行事曆上顯示的會議。 立即會議包括通話（包括1:1 和群組通話），以及使用 &quot; &quot; Microsoft 小組管道中的 [立即開會] 功能開始的會議。


### <a name="use-of-different-meeting-types"></a>使用不同的會議類型

:::image type="content" source="../../media/percentparticipation-meetingtypes.jpg" alt-text="具有最佳作法之會議的主要洞察力。":::
...
本節可提供與頁面上所有真知灼見相關之活動的使用者層級詳細資料，協助您採取行動。

下列各欄是在使用者層級的表格中呈現：

- [使用者 **名稱** ] 是使用者的電子郵件地址。
- [ **顯示名稱** ] 是使用者的完整名稱。
- [ **上次活動日期** ] 是使用者最後一次執行與最近28天會議內之任何真知灼見相關的活動。
- **部門：** 在 Azure Active Directory 中為使用者定義的部門 (AAD) 
- **公司：** 為 AAD 中的使用者定義的公司
- **國家/地區：** 為 AAD 中的使用者定義的國家/地區
- **狀態：** 為 AAD 中的使用者定義的狀態
- **城市：** 為 AAD 中的使用者定義的城市
- **出席會議** ：過去28天內的線上 Microsoft 團隊會議人數
- **參加畫面共用的會議：** 過去28天內具有螢幕共用功能的線上 Microsoft 團隊會議數目
- **參加影片的會議：** 過去28天內具有影片的線上 Microsoft 團隊會議數目
- **會議時間：** 過去28天內參與之線上 Microsoft 團隊會議所花費的小時數
- **參加立即會議：** 在 &quot; &quot; 過去28天內參與的管道會議中，包含1:1 通話、群組通話及立即開會的立即會議數目
- 已 **參加預定的一次性會議：** 過去28天內，已在行事曆上排定的一次性會議的數目
- 已 **參與的排程週期性會議：** 過去28天內，已在行事曆中排程的週期性會議實例數
- 已 **參加立即1:1 通話：** 過去28天內參與的 (「立即會議」) 部分的1:1 通話數目
- 已 **參加的立即群組通話：** 過去28天內參與的「立即會議」)  (一部分之群組通話的數目
- **立即對通道進行立即開會：**&quot; &quot; 最近28天內參與的「立即會議」) 中的 [立即開會] 的數目 (

## <a name="notes-and-caveats"></a>備註和警告

- 所有的 &quot; 線上 Microsoft 團隊會議參考 &quot; 都包括已排程的會議和立即會議 (1:1 通話、群組通話、立即開會，與您組織中的人員進行通話的通道) 。
- 考慮生產力排名深入瞭解的會議和通話具有下列特性：
  - 持續時間大於1分鐘
  - 至少2名人員參與
