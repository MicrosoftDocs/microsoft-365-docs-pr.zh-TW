...
生產力分數透過使用 Microsoft 365 和技術經驗，為您組織的數位轉換旅程提供深入瞭解。 組織的分數反映人員和技術經驗度量，可與類似組織的基準進行比較。 會議類別是「人員經驗」度量的一部分。 若要深入瞭解，請參閱 [生產力評分概述](productivity-score.md) ，並閱讀 [Microsoft 的隱私權聲明](https://privacy.microsoft.com/privacystatement)。

## <a name="prerequisites"></a>必要條件

若要開始使用會議深入瞭解，您組織中的人員需要獲得授權：

- Microsoft Teams

如需詳細資訊，請參閱 [將授權指派給使用者](../manage/assign-licenses-to-users.md)。

在過去28天內，在 Teams 一次以上的人員，您就會開始看到深入瞭解。

## <a name="why-your-organizations-meetings-score-matters"></a>組織會議得分的原因

會議，人們探索創意、規劃、解決問題及作出決策，都是組織生產力的基礎 pillar。 「調查」表示當人們有效使用線上會議工具時，他們每週最多可節約104分鐘。
...
Microsoft Teams 與 Outlook 的行事曆整合，並提供一種功能，讓您的會議更富有活力和有效。 主要的洞察力會顯示您組織中所持有的所有 Microsoft Teams 線上會議。 主要的洞察力也會追蹤為 Teams 會議所遵循的最佳作法中至少有多少會議。

:::image type="content" source="../../media/primaryinsights-meetings.png" alt-text="具有最佳作法之會議的主要洞察力。":::

1. **標頭：** 顯示在過去28天內，在會議中有影片或螢幕共用的 Microsoft Teams 線上會議的百分比。
2. **Body：** 提供如何在會議期間使用影片或螢幕共用（例如影片或螢幕共用）的最佳作法的詳細資訊，使會議更有效率。
3. **視覺效果 (目前狀態) ：**

      - 在這個水準橫條圖中，藍色 (彩色) 部分代表標頭中顯示的百分比。
      - 分數 (分子/分母) 可用來計算標頭中顯示的百分比
         - 分子：包括已使用影片或螢幕共用之組織之人員的線上 Microsoft Teams 會議數目。
         - 分母：線上 Microsoft Teams 會議數目，包含您的組織中過去28天內的人員。
      - 關鍵指標的對等基準值也會以百分比顯示。
1. **資源連結：** 選取此連結可查看 [說明] 內容。

#### <a name="trend-visualization-of-the-primary-insight"></a>主要洞察力的趨勢視覺化

下表顯示主要洞察力中，主要度量的分子及分母的趨勢線。 換句話說，它會顯示具有最佳作法（如影片或螢幕共用）的線上 Microsoft Teams 會議數，以及過去180天內已舉行的線上 Microsoft Teams 會議總數。 折線圖上的每個資料點都是過去28天的活動匯總。
...
組織的會議排名衡量組織中的線上 Microsoft Teams 會議在過去28天內遵循最佳作法的程度。 它會根據您的組織中參加會議和會議工期的人員人數進行加權。
...
1. **標頭：** 好友動向使用主要真知灼見和計分中所述之視頻最佳作法之線上 Microsoft Teams 會議的百分比。  
2. **Body：** Hrovides 在會議中使用這些作法的價值資訊，讓他們更參與。 
3. **視覺效果：** 視覺化效果中的分解是表示線上 Microsoft Teams 會議遵循下列每個最佳作法的程度： 
    - **影片**：彩色部分和分數代表已開啟影片之線上 Microsoft Teams 會議所占的百分比。 分數的構造來源如下： 
        - 分子：線上 Microsoft Teams 在過去28天內舉行的會議，其至少有一位參與者已開啟影片。 
        - 分母：在過去28天內，貴組織中所保留的線上 Microsoft Teams 會議總數 
    - **螢幕共用**：彩色部分和分數代表人員使用螢幕共用功能之線上 Microsoft Teams 會議的百分比。 分數包括： 
        - 分子：線上 Microsoft Teams 在過去28天內舉行，至少有一個參與者分享其畫面的會議。
        - 分母：在您的組織中，于過去28天內進行的線上 Microsoft Teams 會議總數
...
1. **標頭：** 顯示您的組織中，每個人員在平均的28天內，每週都有超過20小時參加線上 Microsoft Teams 會議的人員所占的百分比。
...
1. **標頭：** 顯示過去的28天內，未預先排定) 線上 Microsoft Teams 會議的立即 (百分比（超過30分鐘長）。
2. **Body：** 提供使用立即會議立即解決問題之值的相關資訊。
3. **視覺效果：** 會提供長度 (，以分鐘為單位，在過去28天內，在組織中發生的立即和排程會議) 。 分配會將每個會議分類為1-15 分鐘、16-30 分鐘、31-60 分鐘及超過60分鐘。

    > [!NOTE]
    > 排定的會議包括所有在人員的行事曆上顯示的會議。 立即會議包括電話，包括1:1 和群組通話，以及使用 &quot; Microsoft Teams 通道中的 [立即開會] 功能開始的會議 &quot; 。
...
1. **標頭：** 好友動向過去28天內，小於30分鐘的立即線上 Microsoft Teams 會議百分比。
2. **Body：** 提供在 &quot; &quot; Microsoft Teams 通道功能中使用 [立即開會] 之值的相關資訊。
3. **視覺效果：** 顯示出席任何線上 Microsoft Teams 會議之人員參加的會議類型。 每一種會議類型都是以水準條表示，其中色彩部分和分數代表下列專案：
    - **立即1:1 呼叫**：
        - 分子：過去28天內參加1:1 通話的人員人數
        - 分母：過去28天內，參加任何線上 Microsoft Teams 會議的人員人數
   - **立即群組呼叫**：
        - 分子：過去28天參加群組通話的人員人數
        - 分母：過去28天內，參加任何線上 Microsoft Teams 會議的人員人數
   - **立即對通道進行立即開會**：
        - 分子： &quot; &quot; 在過去28天內，) 立即會議 Microsoft Teams 通道內使用立即開會功能的人員人數 (
        - 分母：過去28天內，參加任何線上 Microsoft Teams 會議的人員人數
    - **排定的一次性會議：**
        - 分子：在過去28天內 (排程) 的行事曆上參加一次線上 Microsoft Teams 會議的人員人數。
        - 分母：過去28天內，參加任何線上 Microsoft Teams 會議的人員人數
    - **排程的週期性會議：**
