...
組織生產力的基本 pillar 是，人們可以從任何地方靈活地運作。 使用 Microsoft 365，使用者可以與 Outlook、Microsoft 團隊和 Yammer 保持連線。 人們也可以從任何位置和平臺使用 Word、Excel、PowerPoint 和 OneNote，以無縫方式共同處理內容。
...
3. **視覺效果：** 顯示在 Outlook 上使用中且使用一或多個平臺的人員百分比：
      ...
      - **僅限桌面：**
        ...
        - 分母：過去28天內，已使用 Outlook 至少一次的人員人數
      - **僅限網頁：**
        - 分子：過去28天內，只在網頁平臺上使用 Outlook 的人員人數。
        - 分母：過去28天內，已使用 Outlook 至少一次的人員人數。
      - **僅限行動裝置：**
...
3. **視覺效果：** 顯示在單一平臺或多個團隊上使用此團隊之活動的人員所占的百分比。 
    - **多種平臺：**
        - 分子：在下列兩個以上的平臺上，已使用團隊的人員人數，在過去28天內：桌面、行動裝置或 web。
        - 分母：過去28天內，已使用 Microsoft 團隊至少一次的人員人數。
    - **僅限桌面：**
        - 分子：過去28天內，僅在桌面平臺上使用 Microsoft 團隊的人員人數
        - 分母：過去28天內，已使用團隊至少一次的人員人數
    - **僅限網頁：**
        - 分子：過去28天內，僅在網頁平臺上使用 Microsoft 團隊的人員人數
        - 分母：過去28天內，已使用 Microsoft 團隊至少一次的人員人數
    - **僅限行動裝置：**
