...
## <a name="how-we-calculate-the-teamwork-score"></a>如何計算團隊合作分數

我們可深入瞭解在您的組織中包含此類別之重要度量的經驗。 然後，下列各項評分架構用於計算組織的分數。
...
組織的團隊合作排名是在匯總 (組織) 層級衡量，不論使用者在過去28天內，是否持續進行通訊或參與共用工作區中的檔案活動。

在個別使用者層級不提供分數。

## <a name="explore-more-about-teamwork-in-your-organization"></a>深入瞭解組織中的團隊合作

我們也提供有關組織中的人員如何一起運作的其他資訊。 這些額外的計量不會直接對您的生產力評分產生貢獻，但與協助您建立行動計畫做為數位轉換的一部分相關。
...
3. **視覺效果：** 專案細分會以熱度地圖的形式顯示在兩個維度中。
      ...
      - **工作區大小：** 根據成員人數，將工作區分解為三個類別：2-10 人員、11-100 人員和100人員。 [ &quot; 全部] &quot; 類別包括所有大小的類別。
