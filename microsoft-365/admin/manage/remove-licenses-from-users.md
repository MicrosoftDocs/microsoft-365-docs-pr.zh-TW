...
- 您可以[使用 Office 365 PowerShell 移除使用者帳戶中的授權](https://docs.microsoft.com/office365/enterprise/powershell/remove-licenses-from-user-accounts-with-office-365-powershell)。
