...
若要為您的使用者提供有關您行業和組織資訊的最新新聞標題，請使用新聞服務為您的組織啟用自訂的新聞摘要。 您也可以啟用每日行業更新電子郵件，以及管理 Bing 首頁和 Microsoft Edge [新增] 索引標籤頁面上的設定， (從 Edge 87) 版本開始。 
...
移至 Bing 首頁的登入使用者，請參閱您的行業新聞摘要中組織的個人化資訊。 
...
身為系統管理員，您可以控制組織的新聞摘要設定，包括所選的行業及 Bing 首頁、Microsoft Edge [新增] 索引標籤頁面 (從 Edge 87) 的版本開始，以及電子郵件經驗。 
...
1. 在 [ **新聞** ] 面板中，按一下 [ **bing 首頁** ] 索引標籤，然後選取 [ **納入 bing 首頁**]。 

    行業資訊會出現在 Bing.com 中組織的個人化資訊底下。 
