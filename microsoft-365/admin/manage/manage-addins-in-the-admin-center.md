...
> [!NOTE] 
> 防止使用者存取 office store 也會防止他們從 [網路共用的旁載 Office 增益集進行測試](/office/dev/add-ins/testing/create-a-network-shared-folder-catalog-for-task-pane-and-content-add-ins)。
