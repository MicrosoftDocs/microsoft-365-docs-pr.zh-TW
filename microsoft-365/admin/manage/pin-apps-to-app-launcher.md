...
1. 在**Azure Active Directory**中，選擇 [所有應用程式] 頁面頂端的 [**企業應用程式**] [  >  **新增應用程式**]。 **All applications**
...
您也可以為組織中的使用者建立應用程式集合。 如需相關指示，請參閱在 [Azure 入口網站中的我的應用程式入口網站上建立集合](https://docs.microsoft.com/azure/active-directory/manage-apps/access-panel-collections)。