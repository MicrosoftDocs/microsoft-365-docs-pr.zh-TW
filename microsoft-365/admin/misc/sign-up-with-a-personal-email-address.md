...
當您使用您的個人電子郵件地址註冊 Office 365，並略過新增[自訂網域](../get-help-with-domains/what-is-a-domain.md)後，就會限制您對某些功能的存取。

如果您選擇現在新增自訂網域，您可以使用下列所有的高級功能：

|**功能**|**使用個人電子郵件 Office 365**|**使用自訂網域 Office 365**|
|:-----|:-----|:-----|
|**OneDrive <sup>1，2</sup>**| [個人 OneDrive](https://onedrive.live.com/about/plans/)| [商務用 OneDrive](https://onedrive.live.com/about/en-us/business/) |
|**Office 應用程式： Word、Excel、PowerPoint、OneNote、Outlook、僅限 Access (電腦)**| 是 | 是
|**商務應用程式 <sup>3</sup> ： Microsoft 預約和 MileIQ**| 否 | 是
|**存取 Microsoft 365 系統管理中心**|  (計費、支援和網域安裝的有限存取權)  | 是
|**新增使用者**| 否 | 是
|**Office 365 服務： Exchange Online、商務用 Skype、Microsoft Teams、SharePoint 線上**| 否 | 是
|**安全性和規範工具**| 否 | 是

> <sup>1</sup>您需要將您的[個人 OneDrive 檔案遷移至商務用 OneDrive](move-email-and-data-to-office-365-business-premium.md)。<br/>
