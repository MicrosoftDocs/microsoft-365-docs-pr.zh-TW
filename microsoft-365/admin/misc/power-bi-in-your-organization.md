...
### <a name="scenario-1-your-organization-already-has-an-existing-microsoft-365-environment-and-the-user-signing-up-for-power-bi-already-has-a-microsoft-365-account"></a>案例1：您的組織已有現有的 Microsoft 365 環境，而註冊 Power BI 的使用者已有 Microsoft 365 帳戶。

在這種情況下，如果使用者已有租用戶 (例如，contoso.com) 中的公司或學校帳戶，但是還沒有 Power BI，那麼 Microsoft 只要為該帳戶啟用方案，使用者就會自動收到 Power BI 服務使用方式的通知。
  
### <a name="scenario-2-your-organization-has-an-existing-microsoft-365-environment-and-the-user-signing-up-for-power-bi-doesnt-have-a-microsoft-365-account"></a>案例2：您的組織有現有的 Microsoft 365 環境，而註冊 Power BI 的使用者沒有 Microsoft 365 帳戶。
...
您的組織不需要執行任何系統管理動作即可利用 Power BI。
...
**停用自動授權散佈：** 您可以使用這個 Windows PowerShell 指令碼，停用現有使用者的自動授權散佈。 如果您已在 (之前停用自動授權發佈，則不需要重複此程式（例如，Office 365 教育版學生、教職員和員工) ）。
...
如果使用者已註冊 Power BI，但您不再想要存取 Power BI，您可以移除該使用者的 Power BI 授權。
