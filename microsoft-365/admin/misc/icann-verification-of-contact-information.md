...
當您購買網域或變更網域的連絡人資訊時，註冊機構必須用來驗證您的連絡人資訊，以符合 ICANN 法規。

為了進行驗證，會將電子郵件傳送至報名者的位址。

 **若要驗證您的連絡人資訊，請選取驗證電子郵件中的連結。** 如果網域擁有者未驗證電子郵件地址，則會暫停網域。 然後，移至系統管理中心的 [ [網域] 頁面](https://admin.microsoft.com/adminportal/home?ref=Domains) ，並檢查您的網域狀態。
