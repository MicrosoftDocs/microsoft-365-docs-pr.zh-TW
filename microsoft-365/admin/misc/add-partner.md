 ...
 **記事**本文適用于中國由世紀運作的 Office 365。 這適用于想要讓世紀合作夥伴為他們管理其 Office 365 訂閱的組織。 
...
您選擇的合作夥伴取決於您使用的 Microsoft 服務，以及您將使用這些服務的國家或地區。 如果您要新增合作夥伴，或要變更訂閱的合作夥伴，首先必須詢問合作夥伴，取得對方的 Microsoft 合作夥伴識別碼。

::: moniker-end

::: moniker range="o365-germany"

訂閱顧問合作夥伴就是 Microsoft 授權合作夥伴並擔任訂閱顧問，負責提供您需要的銷售、支援和技術方面的專業，可協助您設定及維護訂閱。 您購買 Office 365 時或在其他時候，都可以新增訂閱顧問合作夥伴做為「記錄可查夥伴」。 如果您目前並未使用協力廠商，您也可以在[Microsoft 定點](https://pinpoint.microsoft.com)網站上找到該合作夥伴。 
...
3. 若要新增協力廠商，請展開 [**需要您的訂單協助？** ]，然後選取 [**取得 Microsoft 合作夥伴的協助**]。<br>
依照 [提供者] 頁面上的步驟進行搜尋，或取得與合作夥伴的相符。
...
1. 在系統[管理中心](https://go.microsoft.com/fwlink/p/?linkid=848041)中，移至 [**帳單** \> **購買服務**] 頁面。
...
4. 輸入您要新增之合作夥伴的 Microsoft 合作夥伴 ID、選取 [**檢查 ID**]，然後再進行**提交**。 請詢問合作夥伴，取得對方的 Microsoft 合作夥伴 ID。
...
此處理程式是由您的授權合作夥伴所啟動。 協力廠商會傳送電子郵件給您，詢問您是否要授與其許可權，以作為記錄的夥伴。 
  
若要接受此優惠
  
1. 在電子郵件中讀取合作夥伴的條款。
    
2. 若要授權合約，請選取 [連結]，該連結會移至 Office 365 中的授權頁面。
    
3. 在 [**合作夥伴關係**] 底下，選取 **[是]** 以授權夥伴成為您委派的系統管理員，然後選取 **[下一步]**。
    
4. 如果提供與試用訂閱或購買產品的合作夥伴關係，請建立您的試用版或訂閱帳戶。
...
4. 輸入您要新增之合作夥伴的新 Microsoft 合作夥伴識別碼，然後選取 [**檢查 ID**]，然後再**提交**。 請詢問合作夥伴，取得對方的 Microsoft 合作夥伴 ID。
...
6. 在 [**合作夥伴資訊**] 頁面上，清除 [**合作夥伴識別碼**] 方塊，然後選取 [**提交**]。
...
## <a name="remove-a-reseller-relationship"></a>移除轉銷商關係
