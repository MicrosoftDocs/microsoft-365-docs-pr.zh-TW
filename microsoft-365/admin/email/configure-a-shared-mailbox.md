...
3. 將切換設定為 [ **開啟**]，然後輸入一個電子郵件地址，以轉寄郵件。 它可以是任何有效的電子郵件地址。 若要轉寄至多個位址，您必須為位址 [建立通訊群組](https://docs.microsoft.com/office365/admin/setup/create-distribution-lists) ，然後在此方塊中輸入群組的名稱。
