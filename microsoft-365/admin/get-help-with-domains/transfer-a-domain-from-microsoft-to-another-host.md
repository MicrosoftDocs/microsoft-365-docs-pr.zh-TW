...
在您從 Microsoft 購買網域之後，您無法將 Microsoft 365 網域轉接給另一部註冊機構60天。

> [!NOTE]
> _Whois_   查詢會顯示 Microsoft 購買的網域報名者做為通配網域 LLC。 不過，對於您的 Microsoft 365 購買的網域，只應該聯繫 Microsoft。

請遵循下列步驟，在 Microsoft 365 取得程式碼，然後移至其他網域註冊機構網站，將您的功能變數名稱轉移至新的註冊機構。
...
> [!NOTE]
> Microsoft 365 購買的網域不足以進行名稱伺服器變更或在 Microsoft 365 組織之間傳輸網域。 若有任何一種是必要的，網域註冊必須轉移到另一個註冊機構。
