        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>將 GoDaddy 網域快速新增至 Office 365</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>了解網域</h3>
                            ...
                            <p><a href="../setup/domains-faq.md">DNS 管理在 Office 365 中的運作方式</a></p>
                            <p><a href="https://go.microsoft.com/fwlink/p/?LinkId=402693">閱讀 Office 365 服務描述的網域</a></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="cardText">
                        <h3>入門</h3>
                            ...
                            <p><a href="information-for-dns-records.md">收集您需要建立 DNS 記錄的資訊</a></p>
                            <p><a href="find-your-domain-registrar.md">尋找您的網域註冊機構</a></p>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>建立 Office 365 的 DNS 記錄</h3>
                            <p><a href="../dns/create-dns-records-at-godaddy.md">在 GoDaddy 建立 DNS 記錄</a></p>
                            <p><a href="../dns/create-dns-records-at-1-1-internet.md">在 1 建立 DNS 記錄&1 IONOS</a></p>
                            <p><a href="../dns/create-dns-records-at-network-solutions.md">在 Network Solutions 建立 DNS 記錄</a></p>
                            <p><b>許多較熱門的提供者的說明：</b></p> 
                            <P><a href="create-dns-records-at-any-dns-hosting-provider.md">管理您的 DNS 記錄時建立 Office 365 的 DNS 記錄</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>將名稱伺服器變更為 Office 365</h3>
                            <p><a href="../dns/change-nameservers-at-1-1-internet.md">變更名稱伺服器以設定 Office 365 1&1 IONOS</a></p>
                            <p><a href="../dns/change-nameservers-at-network-solutions.md">變更名稱伺服器以設定 Office 365 使用 Network Solutions</a></p>
                            <p><a href="domain-connect.md">將 GoDaddy 網域快速新增至 Office 365</a></p>
                            <p><b>許多其他受歡迎的網域註冊機構的說明：</b></P> 
                            <p><a href="../get-help-with-domains/set-up-your-domain-host-specific-instructions.md">Office 365 變更名稱伺服器，因此您已設定記錄</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>進行變更</h3>
                            <p><a href="find-and-fix-issues.md">尋找並修正問題之後變更您的網域名稱或 DNS 記錄</a></p>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>更多影片</h3>
                            <p><a href="../dns/create-dns-records-at-godaddy.md">在 Office 365 中設定 GoDaddy 網域</a></p>
                    </div>
                </div>
            </div>
        </div>
