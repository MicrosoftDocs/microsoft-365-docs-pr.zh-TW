...
Microsoft 365 使用方式分析目前不適用於 Power BI 政府客戶。
...
### <a name="what-sharepoint-site-collections-are-included-in-the-sharepoint-reports"></a>SharePoint 報告包含哪些 SharePoint 網站集合？
...
範本應用程式中的資料可透過 Microsoft 365 APIs （預覽）進行檢索。 當其運送至實際生產環境時，將會在[Microsoft Graph 報告 APIs](https://go.microsoft.com/fwlink/p/?linkid=848843)中合併。 
...
您可以使用 Power BI Desktop 來連線至 Microsoft 365 APIs （在預覽中），以將其他資料來源與範本應用程式資料合併。
