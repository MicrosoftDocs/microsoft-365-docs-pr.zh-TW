...
- 如果您的企業訂閱如 Office 365 企業版 E3，您可以將已刪除之使用者帳戶的信箱資料，將其變成非使用中的 *信箱*，以加以保留。 To learn more, see [Manage inactive mailboxes in Exchange Online](../../compliance/inactive-mailboxes-in-office-365.md).
...
2. 選取您要刪除的使用者名稱，然後選取 [ **更多選項** (**...**) ]，然後選擇 [  **刪除使用者**]。
...
2. 如果您有多個) ，請選取 [訂閱 (]，然後選取 [ **新增/移除** 授權以刪除授權]，以便在您雇用其他人員之前不必支付。  
...
請參閱 [Remove-MsolUser](https://docs.microsoft.com/powershell/module/msonline/remove-msoluser) PowerShell Cmdlet。
