...
- **您刪除了某個使用者，但對方的名稱仍在您的全域通訊錄中出現** 。 如果公司使用 Active Directory，就會發生這個問題。 您必須刪除 Active Directory 中的使用者帳戶。 如需相關指示，請參閱 [刪除使用者帳戶。](https://go.microsoft.com/fwlink/p/?linkid=841808)
