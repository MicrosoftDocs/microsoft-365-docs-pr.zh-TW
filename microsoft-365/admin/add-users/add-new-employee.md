 ...
 **不是系統管理員？** [深入瞭解 Microsoft 365](https://support.office.com/article/office-basics-video-training-396b8d9e-e118-42d0-8a0d-87d1f2f055fb) ，以協助商務和家庭使用者設定。 
  
 **您計畫中沒有任何 Office 應用程式？** 請遵循下列步驟，但略過安裝應用程式的區段。 請改為使用[Office 的 Online 版本](https://support.office.com/article/91a4ec74-67fe-4a84-a268-f6bdf3da1804.aspx)。 
...
與他們共用[Microsoft 365 的員工快速設定](https://support.office.com/article/employee-quick-setup-b9700090-ce64-4046-ab92-ce8488a7bc0f)，以登入、安裝軟體、設定電子郵件等等。 
