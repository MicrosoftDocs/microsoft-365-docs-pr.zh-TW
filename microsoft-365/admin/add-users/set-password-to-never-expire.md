...
Microsoft cloud service 的全域系統管理員可以使用 Microsoft Azure AD Module for Windows PowerShell，將密碼設為不會到期的特定使用者。 您也可以使用 Windows PowerShell Cmdlet 來移除永不過期的設定，或查看哪些使用者密碼設定為永不過期。
