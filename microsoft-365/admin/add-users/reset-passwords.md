...
這些步驟僅適用于使用 Microsoft 365 for business plan 的人員。 若要這麼做，您必須使用 Microsoft 365 系統管理員帳戶登入。 [什麼是系統管理員帳戶？](../admin-overview/admin-overview.md)
...
## <a name="reset-my-admin-password"></a>重設系統管理員密碼
...
[讓使用者重設自己的密碼](let-users-reset-passwords.md)
