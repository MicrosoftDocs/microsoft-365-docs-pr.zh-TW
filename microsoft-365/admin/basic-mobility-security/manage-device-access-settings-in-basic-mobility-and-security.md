...
如果您使用基本行動性和安全性，則可能是無法使用基本行動性和安全性來管理的裝置。 如果是的話，您應該封鎖 Exchange ActiveSync app 存取 Microsoft 365 電子郵件，以供基本行動及安全性所不支援的行動裝置使用。 這可協助您保護組織中的資訊，使其超過多種裝置。
...
若要瞭解基本行動性和安全性可支援哪些裝置，請參閱 [基本行動性和安全性的功能](capabilities-of-basic-mobility-and-secruity.md)。