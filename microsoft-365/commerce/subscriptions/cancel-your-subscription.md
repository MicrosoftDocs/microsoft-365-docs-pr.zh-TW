...
如果您在字詞結束之前取消訂閱，則訂閱會直接移到停用的狀態。 對大部分國家和地區的多數訂閱來說，停用狀態會持續 90 天。 當訂閱處於停用狀態時，系統管理員仍能存取和備份組織資料，不過我們建議系統管理員在取消訂閱前就先[備份資料](back-up-data-before-switching-plans.md)，尤其那是您唯一訂閱的情況下。 您所留下的任何資料在 90 天後可能會遭到刪除，並且會在取消後的 180 天內全部刪除。
