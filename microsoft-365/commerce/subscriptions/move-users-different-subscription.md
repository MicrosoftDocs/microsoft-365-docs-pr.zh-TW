...
您必須是全域、授權或使用者系統管理員，才可指派授權。 如需詳細資訊，請參閱[關於 Microsoft 365 系統管理員角色](https://docs.microsoft.com/microsoft-365/admin/add-users/about-admin-roles?view=o365-worldwide)。
...
[購買另一部 Microsoft 365 for business 訂閱](../buy-another-subscription.md)（文章）