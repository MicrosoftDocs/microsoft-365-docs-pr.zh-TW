...
3. *信用卡和銀行帳戶客戶：*  在 [ **變更付款明細** ] 頁面上，選取您要更新的信用卡或銀行帳戶，選取 [ **編輯詳細資料**]，更新您的帳單位址，然後選取 [ **提交**]。
  
    > [!NOTE]
    > 某些國家或地區未提供以銀行帳戶付款的能力。

     *發票客戶：*  在 [ **變更付款明細** ] 頁面上，更新您的帳單位址，然後選取 [ **提交**]。
  
    > [!NOTE]
    > 在某些國家或地區無法使用以支票支付發票的功能。
...
3. 在 [ **編輯服務使用位址** ] 窗格中，更新您的位址，然後選取 [ **提交**]。
