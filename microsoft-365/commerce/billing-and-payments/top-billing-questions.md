...
## <a name="i-have-a-question-about-my-bill-how-can-i-get-help"></a>我有關于我的帳單的問題。 如何取得説明？
...
::: moniker range="o365-worldwide"
## <a name="can-i-get-a-copy-of-my-billing-statement-sent-via-email"></a>我是否可以取得透過電子郵件傳送的帳單報表副本？
...
顯示在 [帳單] 頁面上的合計是「發票餘額」（發票日期的總金額）。 若要查看您目前的訂單餘額，請查看您最近的訂單或發票。 
...
## <a name="why-dont-i-see-any-bills"></a>為什麼我看不到任何匯票？

如果您只有試用版訂閱，或是您使用購買于零售店或合作夥伴購買的預付產品金鑰，您就不會有任何帳單。
