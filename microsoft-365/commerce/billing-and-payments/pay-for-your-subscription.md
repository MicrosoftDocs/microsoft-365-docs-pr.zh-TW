...
**只是想知道要在哪裡傳送發票付款嗎？** 如果您要以支票或電匯 (EFT) 支付發票，請參閱[我要在哪裡送出我的支票或是 EFT 付款？](#where-do-i-send-my-check-or-eft-payment)
...
您可以使用信用卡或轉帳卡或銀行帳戶來支付訂閱的費用。 當您使用其中一種付款方法付款時，我們會持續透過該付款方法收取費用，直到訂閱到期或取消。 您可以隨時[管理付款方式](manage-payment-methods.md)。 您也可以選擇[透過電子郵件接收帳單明細的複本](view-your-bill-or-invoice.md#receive-a-copy-of-your-billing-statement-in-email)。

## <a name="paying-by-invoice"></a>透過發票付款

在某些情況下，您可以使用支票或 EFT 透過發票支付訂閱費用。 若要符合透過發票付款的資格，您必須：

- 成為已建立的客戶
- 訂閱費用超過特定金額 (此金額因服務位置而異)
- 通過信用查核

如果需要信用查核，當您購買訂閱時會收到通知。 如果您同意連絡，將會收到一封電子郵件，其中包括有關適用於信用核准的詳細資訊。 信用查核通常會在兩個工作天內完成。
...
如果以發票支付訂閱款項，您會在帳單明細可供檢視時收到電子郵件通知。 此電子郵件不含帳單複本。 不過，您可以選擇[透過電子郵件接收帳單明細的複本](view-your-bill-or-invoice.md#receive-a-copy-of-your-billing-statement-in-email)。 帳單明細內包括各種付款方式以及要寄送到哪裡的詳細資料。 如果您在購買訂閱時輸入了採購單 (PO) 編號，它會顯示在帳單上。 如需存取帳單明細的相關資訊，請參閱[檢視您的帳單或發票](view-your-bill-or-invoice.md)。

## <a name="what-if-i-have-an-outstanding-balance"></a>如果我有未付餘額，該怎麼辦？

如果我們無法對記載的付款方式收費，將會傳送一封電子郵件，讓您知道發生問題。 電子郵件會簡短說明問題所在，並包含您可以檢查未付餘額的連結。 我們會繼續每隔幾天重試交易達 30 天，在此期間訂閱會處於寬限期。 每次交易失敗時，您會收到有關失敗的電子郵件警示。
...
如果您沒有新增用來支付訂閱的付款方式，您必須以先前新增的付款方式或以新的付款方式取代該付款方式。

## <a name="where-do-i-send-my-check-or-eft-payment"></a>我要在哪裡送出我的支票或是 EFT 付款？

[檢查您的發票](view-your-bill-or-invoice.md)以了解相關的付款指示。 您也可以使用下方的下拉式清單，以尋找您國家或地區的付款指示。 如果您不確定應付金額，可以在 [帳單與付款 <a href="https://go.microsoft.com/fwlink/p/?linkid=2102895" target="_blank">]</a> 頁面的 [發票 **]** 索引標籤上檢查帳單和線上帳單記錄。
...
您無法在線上支付您的發票。 您必須透過支票或 EFT 支付款項。

## <a name="can-i-change-from-my-current-payment-method-to-paying-by-invoice"></a>我可以從目前的付款方式變更為透過發票付款嗎？

只有在您的訂閱費用超過特定金額時，才能變更為透過發票付款。 您必須先使用信用卡或轉帳卡或銀行帳戶支付任何未付餘額，之後才能變更為透過發票付款。 若要了解如何變更付款方式，請參閱[變更單一訂閱的付款方式](manage-payment-methods.md#change-a-payment-method-for-a-single-subscription)。

## <a name="can-i-change-from-paying-by-invoice-to-using-a-different-payment-method"></a>我可以從透過發票付款變更為使用不同的付款方式嗎？

您無法自動由從發票付款變更為以不同的付款方法付款。 相反地，您必須[購買不同的訂閱](../try-or-buy-microsoft-365.md#buy-a-different-subscription)，透過信用卡或轉帳卡或銀行帳戶支付，[將所有使用者移至新訂閱](../subscriptions/move-users-different-subscription.md)，然後[取消舊的訂閱](../subscriptions/cancel-your-subscription.md)。

## <a name="related-content"></a>相關內容

[管理付款方式](manage-payment-methods.md) (文章)\
[檢視帳單](view-your-bill-or-invoice.md) (文章)\
[了解您的帳單或發票](understand-your-invoice2.md) (文章)
