...
如果您的付款條件與帳單設定檔相關聯，而且也用來直接支付任何訂閱，請先變更與帳單設定檔相關聯的支付方式。 接下來，變更用來支付訂閱費用的支付方式。 然後，您就可以刪除支付方式。
...
::: moniker range="o365-21vianet"
## <a name="troubleshooting-credit-cards-and-bank-accounts"></a>疑難排解信用卡或銀行帳戶

|**問題**|**疑難排解步驟**|
|:-----|:-----|
|**我收到錯誤訊息指出「瀏覽器目前的設定為封鎖 Cookie」。** <br/> |將您的瀏覽器設為允許協力廠商 Cookie，然後再試一次。  <br/> |
|**我的信用卡遭到拒絕。** <br/> |如果您是以信用卡支付，而且您的信用卡遭到拒絕，您會收到無法處理付款的電子郵件。 確認信用卡詳細資料（信用卡號碼、到期日、信用卡上的名稱，以及位址，包括市/縣、省/郵遞區號）和您的信用卡帳單上的顯示方式完全相同。 您可以使用 [**立即付款**] 功能更新您的信用卡資訊，並立即送出付款。 如需詳細資訊，請參閱[什麼是我的信用卡遭到拒絕和我的付款逾期？](pay-for-your-subscription.md#what-if-my-credit-card-was-declined-and-my-payment-is-past-due)。  <br/><br/>  如果還是繼續看到 [拒絕] 訊息，請連絡您的銀行。 您的信用卡可能無法使用。 如果您最近在具有更新到期日的郵件中接收信用卡，請確定已啟用該卡。 您的銀行也可以告訴您，您的信用卡是否未獲批准線上、國際或重複的交易。  <br/> |
|**我想要更新信用卡或銀行帳戶號碼。** <br/> |您無法變更現有的信用卡或銀行帳戶號碼。 如果已變更您的信用卡或銀行帳戶號碼，請新增[新的信用卡或銀行帳戶](#add-a-credit-card-or-bank-account)，將[您的訂閱變更為該信用卡或銀行帳戶](#change-the-credit-card-or-bank-account-used-to-pay-for-a-subscription)，然後[刪除舊的信用卡或銀行帳戶](#remove-a-credit-card-or-bank-account)。 |
|**我的帳戶只有一張信用卡或一個銀行帳戶，而我想移除它。** <br/> |如果您只有一張信用卡或銀行帳戶，當您嘗試移除它時，會看到錯誤訊息。 若要修正錯誤，請確定您正在使用不同的付款條件支付您的所有訂閱，然後重新嘗試移除信用卡或銀行帳戶。  <br/> |
|**我無法新增我的信用卡或銀行帳戶。** <br/> |如果您無法輸入您的信用卡或銀行帳戶資訊，您可以[連絡客戶支援](../../admin/contact-support-for-business-products.md)。  <br/> |
...
|**我收到錯誤訊息指出「瀏覽器目前的設定為封鎖 Cookie」。** <br/> |將您的瀏覽器設為允許協力廠商 Cookie，然後再試一次。  <br/> |
|**我的信用卡遭到拒絕。** <br/> |如果您是以信用卡支付，而且您的信用卡遭到拒絕，您會收到無法處理付款的電子郵件。 確認信用卡詳細資料（信用卡號碼、到期日、信用卡上的名稱，以及位址，包括市/縣、省/郵遞區號）和您的信用卡帳單上的顯示方式完全相同。 您可以使用 [**立即付款**] 功能更新您的信用卡資訊，並立即送出付款。 如需詳細資訊，請參閱[什麼是我的信用卡遭到拒絕和我的付款逾期？](pay-for-your-subscription.md#what-if-my-credit-card-was-declined-and-my-payment-is-past-due)。  <br/><br/>  如果還是繼續看到 [拒絕] 訊息，請連絡您的銀行。 您的信用卡可能無法使用。 如果您最近在具有更新到期日的郵件中接收信用卡，請確定已啟用該卡。 您的銀行也可以告訴您，您的信用卡是否未獲批准線上、國際或重複的交易。  <br/> |
|**我想要更新信用卡或銀行帳戶號碼。** <br/> |您無法變更現有的信用卡或銀行帳戶號碼。 如果已變更您的信用卡或銀行帳戶號碼，請新增[新的信用卡或銀行帳戶](#add-a-credit-card-or-bank-account-1)，將[您的訂閱變更為該信用卡或銀行帳戶](#change-the-credit-card-or-bank-account-used-to-pay-for-a-subscription-1)，然後[刪除舊的信用卡或銀行帳戶](#remove-a-credit-card-or-bank-account-1)。 |
|**我的帳戶只有一張信用卡或一個銀行帳戶，而我想移除它。** <br/> |如果您只有一張信用卡或銀行帳戶，當您嘗試移除它時，會看到錯誤訊息。 若要修正錯誤，請確定您正在使用不同的付款條件支付您的所有訂閱，然後重新嘗試移除信用卡或銀行帳戶。  <br/> |
|**我無法新增我的信用卡或銀行帳戶。** <br/> |如果您無法輸入您的信用卡或銀行帳戶資訊，您可以[連絡客戶支援](../../admin/contact-support-for-business-products.md)。  <br/> |
...
[變更您的帳單地址](change-your-billing-addresses.md)
