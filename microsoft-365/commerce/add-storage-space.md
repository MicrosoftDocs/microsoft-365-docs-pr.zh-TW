...
2. 在 [ **購買服務** ] 頁面底部的 [ **附加** 元件] 區段中，尋找 [ **Office 365 額外檔案儲存區**]，然後選取 [ **詳細資料**]。
...
如果您已透過 **Office 365 額外檔案儲存區** 購買額外的檔案存放區，您可以使用這些步驟來增加或減少訂閱的額外儲存空間。 您可以將儲存體縮小為低達 1 gb。 若要移除所有額外的儲存空間， [請與支援人員聯繫](../business-video/get-help-support.md)。
...
[管理網站儲存量限制](/sharepoint/manage-site-collection-storage-limits) (篇文章) \
