...
所有使用者都應該登入 Microsoft 365 for business，並設定其 OneDrive 的商務用。 若要這麼做，請移至 [office.com](https://office.com)，使用 Microsft 365 的商務用認證登入，然後選擇 OneDrive。
...
1. 選擇 [ **應用程式**、 **Google Workspace Marketplace 應用** 程式] 及 [ **新增應用程式至網域安裝] 清單**。
...
1. 然後，我們會使用來源路徑、目的地路徑及標記的格式建立 CSV 檔案。 
    ...
    新增目的地路徑 URL 時，請移除共用檔之後的所有專案例如，此完整 URL 將無法運作： `https://TENANT01.sharepoint.com/sites/SiteName/Shared Documents/Forms/AllItems.aspx`
