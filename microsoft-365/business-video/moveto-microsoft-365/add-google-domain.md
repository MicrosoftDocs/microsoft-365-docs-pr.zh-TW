...
將您的 Google Workspace 網域新增至 Microsoft 365 供商務使用，這樣您就可以繼續使用您的商務電子郵件地址。

## <a name="try-it"></a>試試看吧！

1. 移至[Microsoft 365 系統管理中心](https://admin.microsoft.com)。
1. 在 Microsoft 365 系統管理中心的左側導覽中，選取 [**全部顯示**]、[**設定**] 和 [**網域**]。
...
1. 針對每個使用者重複此程式。 
    ...
    當您完成時，您就可以安裝 Office 應用程式，並將您的電子郵件和行事曆專案遷移至 Microsoft 365。 