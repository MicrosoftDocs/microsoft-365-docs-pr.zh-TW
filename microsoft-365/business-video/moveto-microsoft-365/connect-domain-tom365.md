...
---
# <a name="connect-your-domain-to-microsoft-365-for-business"></a>將您的網域連線為商務 Microsoft 365

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE4LFpy?autoplay=false]

在您設定 Microsoft 365，並將電子郵件資料從 Google Workspace 移出後，您就可以將您的網域連線到 Microsoft 365。 

首先，您將需要從 Google 刪除現有的 DNS 記錄，然後可以從 Microsoft 365 中新增 DNS 記錄。
...
1. 向下滾動至 **自訂資源記錄**，並刪除任何出現的現有 DNS 記錄，包括您先前可能為 Microsoft 365 建立的任何 DNS 記錄。
1. 移至[Microsoft 365 系統管理中心](https://admin.microsoft.com)。
1. 在左側導覽中，選擇 [**全部**]、[**設定**]、[**網域**]。
1. 然後選擇您的預設網域。
1. 選取 [ **繼續安裝**]，然後按一下 [  **繼續**]。
