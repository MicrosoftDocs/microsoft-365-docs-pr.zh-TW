...
## <a name="watch-add-a-user"></a>觀賞：新增使用者

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE1FOfN?autoplay=false]

當新人員加入您的公司時，您必須將他們新增至您的 Microsoft 365 商務進階版訂閱成為新的使用者。

## <a name="try-it"></a>試試看吧！

1. 在 Microsoft 365 系統管理中心，移至 [**使用者管理**]，然後選取 [新增使用者]。
...
1. 確認使用者已成功建立：在 [Microsoft 365 系統管理中心] 的左功能窗格中，選取 [**使用者**]，然後選取 [作用中的 **使用者**]。 應該會列出新的使用者，以及其指派的授權。