...
您是否有 Microsoft 365 用於商務用的新功能？ :::image type="icon" source="../media/video-call-icon.png" border="false":::請 [觀看這段影片](../business/microsoft-365-business-start.md) 以瞭解。 接著執行下列步驟。
...
## <a name="2-download-and-install-office-apps"></a>2. 下載和安裝 Office 應用程式
...
- 從 Office 應用程式的 [**另存** 新檔] 功能表中，將檔儲存至 **OneDrive** 。
...
- 或將檔案從您的桌面或檔案複製到 **OneDrive**。
    ...
    > [!TIP]
    > 您也可以在 Microsoft 365 中儲存[網站](https://support.microsoft.com/office/d18d21a0-1f9f-4f6c-ac45-d52afa0a4a2e)上的檔案。
...
## <a name="6-get-outlook-on-your-phone"></a>6. 在您的手機上取得 Outlook

- 從應用程式存放區或 Google Play 商店取得您手機上的 **Outlook** 。 開啟它，然後選擇 [**入門**] 並新增您的電子郵件和密碼。
- 或者，開啟 iOS 或 Android 裝置上的 Outlook，然後移至 [**設定**]。

    選擇 [ **新增帳戶** 然後 **新增電子郵件帳戶** ]，然後輸入您的電子郵件和密碼。
- 在 **Windows Phone** 上，選擇 [**設定**、**電子郵件 + 帳戶**]、[**新增帳戶**]，然後 **Exchange**]。