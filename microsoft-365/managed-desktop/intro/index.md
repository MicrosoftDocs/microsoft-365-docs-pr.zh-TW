...
如果 Microsoft 受管理的電腦看來適合您的組織，您可以深入研究其他文件，其中會詳細說明該服務、如何讓組織準備好進行註冊、如何開始使用該服務，以及之後的持續性作業，包含您和您的使用者如何在必要時輕鬆取得協助。 如果您已經準備好要開始使用，請先連絡您的[當地帳戶團隊](https://pages.email.office.com/contactmmd/)。
