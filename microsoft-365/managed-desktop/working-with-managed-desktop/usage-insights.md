...
![使用狀況] 窗格中。 裝置使用量圖表 （與時間百分比使用率） 在左上方。 右上方應用程式使用狀況] 表格。 裝置清單表格與資料行的裝置名稱、 模型、 序號、 顯示名稱、 使用者名稱、 目前狀態 （使用中、 低，或非使用中），底端之間的總裝置使用量在上班時間及作用中的日數。](../../media/insights_usage.png)
