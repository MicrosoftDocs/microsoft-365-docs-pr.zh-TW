...
|**電子郵件** <br> (Exchange Online) | - 準備好[使用 Exchange 部署助理進行 Exchange 混合式](https://technet.microsoft.com/exdeploy2013)移轉  <br> - 使用 [Exchange 移轉建議程式](https://aka.ms/office365setup)來取得自訂設定指導方針  <br> - [設定 Exchange Online Protection](../security/office-365-security/set-up-your-eop-service.md) |
