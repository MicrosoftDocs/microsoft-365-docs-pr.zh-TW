...
Microsoft 365 系統管理中心提供許多不同的報告。 不過，這些報告只會提供如此多的資訊，而且有時候您需要更多。 這就是當您需要 Microsoft 365 PowerShell。
...
- 使用者帳戶和授權的報告：
  ...
  - [使用 PowerShell 查看已授權和未經許可之使用者的 Microsoft 365](view-licensed-and-unlicensed-users-with-microsoft-365-powershell.md)
    
  - [使用 PowerShell 來查看 Microsoft 365 帳戶授權與服務詳細資料](view-account-license-and-service-details-with-microsoft-365-powershell.md)
    
  - [使用 PowerShell 來查看 Microsoft 365 使用者帳戶](view-user-accounts-with-microsoft-365-powershell.md)
