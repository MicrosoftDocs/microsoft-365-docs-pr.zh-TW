...
>[!Note]
>瞭解如何使用 Microsoft 365 系統管理中心[還原使用者帳戶](https://docs.microsoft.com/microsoft-365/admin/add-users/restore-user)。 如需其他資源的清單，請參閱 [管理使用者和群組](https://docs.microsoft.com/microsoft-365/admin/add-users/)。
>   
