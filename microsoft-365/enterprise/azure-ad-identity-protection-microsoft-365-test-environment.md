...
---
# <a name="azure-ad-identity-protection-for-your-microsoft-365-for-enterprise-test-environment"></a>適用于企業測試環境的 Microsoft 365 Azure AD 身分識別保護
...
在適用于企業測試環境的 Microsoft 365 中設定 Azure AD 身分識別保護包括兩個階段：
...
1. [https://portal.azure.com](https://portal.azure.com)使用您的企業版測試環境 Microsoft 365 的全域系統管理員帳戶，開啟瀏覽器的私人實例並登入 Azure 入口網站。
