...
#### [步驟 2： 保護您的特殊權限設定身分識別](identity-designate-protect-admin-accounts.md)
...
#### [步驟 6： 使用更輕鬆的管理群組](identity-self-service-group-management.md)
...
#### [步驟 3： 設定增強的安全性的 Microsoft 365](infoprotect-configure-increased-security-office-365.md)
...
## [步驟 1：裝置和應用程式整備](step-1-device-and-app-readiness.md) (英文)
