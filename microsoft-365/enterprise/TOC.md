...
#### [步驟 2：保護全域管理員帳戶](identity-designate-protect-admin-accounts.md)
#### [步驟 3：設定隨選全域管理員](identity-privileged-identity-management.md)
#### [步驟 4：簡化密碼重設](identity-password-reset.md)
#### [步驟 5：設定多重要素驗證](identity-multi-factor-authentication.md)
#### [步驟 6：防護認證洩露](identity-azure-ad-identity-protection.md)
#### [步驟 7：同步處理目錄](identity-azure-ad-connect.md)
#### [步驟 8：監控同步處理健全狀況](identity-azure-ad-connect-health.md)
#### [步驟 9：簡化密碼更新](identity-password-writeback.md)
#### [步驟 10：簡化使用者登入](identity-single-sign-on.md)
#### [步驟 11：自訂 Office 365 登入頁面](identity-customize-office-365-sign-in.md)
#### [步驟 12：設定自動授權](identity-group-based-licensing.md)
#### [步驟 13：監控租用戶和登入活動](identity-azure-ad-access-usage-reporting.md)
#### [步驟 14：允許使用者建立及管理自己的群組](identity-self-service-group-management.md)
#### [步驟 15：設定動態群組成員資格](identity-automatic-group-membership.md)
...
#### [步驟 3：設定增強的 Office 365 安全性](infoprotect-configure-increased-security-office-365.md)
#### [步驟 4：設定 Office 365 的特殊權限存取管理](infoprotect-configure-privileged-access-management.md)
#### [資訊保護允出準則](infoprotect-exit-criteria.md)
### [部署現有的基礎結構](deploy-with-existing-infrastructure.md)
...
# [現代化電腦的部署中心](desktop-deployment-center-home.md)
...
## [步驟 7：Windows 和 Office 即服務](step-7-windows-and-office-as-a-service.md)
## [步驟 8：使用者的通訊和訓練](step-8-user-communications-and-training.md)
## [現代化電腦部署及管理實驗室套件](modern-desktop-deployment-and-management-lab.md)
## [尋找您部署的說明](find-help-for-modern-desktop-deployment.md)
## [獲得領導力：探索價值和商務案例](https://transform.microsoft.com)
...
## [ISO — 建議使用的行動計劃](../compliance/iso-action-plan.md)
## [ — 建議使用的行動計劃](../compliance/nist-action-plan.md) 
...
#### [Microsoft 支援服務與專業服務](../compliance/gdpr-arc-prof-services.md)
...
#### [Microsoft 支援服務與專業服務](../compliance/gdpr-breach-Microsoft-Support-Professional-Services.md?toc=/microsoft-365/enterprise/toc.json)
