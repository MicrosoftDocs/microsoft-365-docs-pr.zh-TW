...
# [Microsoft 365 企業版概述](microsoft-365-overview.md)
...
#### [網路結束準則](networking-exit-criteria.md)
...
#### [身分識別的出口準則](identity-exit-criteria.md)
...
#### [步驟 4: 監視裝置健康情況及合規性](windows10-enable-windows-analytics.md)
#### [步驟 5: 部署安全性功能](windows10-enable-security-features.md)
#### [Windows 10 企業版的出口準則](windows10-exit-criteria.md)
### [階段 4：Office 365 專業增強版](office365proplus-infrastructure.md)
#### [Office 365 專業增強版 exit criteria](office365proplus-exit-criteria.md)
### [階段 5：行動裝置管理](mobility-infrastructure.md)
#### [行動裝置管理的出口準則](mobility-infrastructure-exit-criteria.md)
...
#### [步驟 6: 設定 Office 365 的特殊許可權存取管理](infoprotect-configure-privileged-access-management.md)
#### [資訊保護的出口準則](infoprotect-exit-criteria.md)
### [部署策略](deployment-strategies-microsoft-365-enterprise.md)
### [使用現有基礎結構進行部署](deploy-with-existing-infrastructure.md)
### [部署非企業版](deploy-foundation-infrastructure-non-enterprises.md)
...
### [高管制資料的小組和網站](teams-sharepoint-online-sites-highly-regulated-data.md)
## [測試實驗室指南](m365-enterprise-test-lab-guides.md)
### [基本設定]()
#### [羽量級](lightweight-base-configuration-microsoft-365-enterprise.md)
...
## [Windows 7 至 Windows 10 手動升級](windows-7-to-windows-10-upgrade-manual.md)
## [Windows 7 至 Windows 10 自動升級](windows-7-to-windows-10-upgrade-automated.md)
## [Windows 和 Office 部署和實驗室套件](modern-desktop-deployment-and-management-lab.md)
...
##[必要條件工作](identity-access-prerequisites.md)
...
## [ISO-建議的行動計畫](../compliance/iso-action-plan.md)
## [NIST-建議的行動計畫](../compliance/nist-action-plan.md) 
## [GDPR](../compliance/gdpr.md?toc=/microsoft-365/enterprise/toc.json)

### [GDPR 的建議動作計畫](../compliance/gdpr-action-plan.md)

### [責任就緒狀況檢查清單](../compliance/gdpr-arc.md)
