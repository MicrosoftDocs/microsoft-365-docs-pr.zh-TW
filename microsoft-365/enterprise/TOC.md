...
#### [步驟 4： 加入您的使用者帳戶](identity-add-user-accounts.md)
#### [步驟 5： 使用群組來管理](identity-use-group-management.md)
#### [步驟 6： 設定身分識別管理](identity-configure-identity-governance.md)
...
#### [步驟 7： 設定 Office 365 的特殊權限的存取管理](infoprotect-configure-privileged-access-management.md)
...
### [適用於非企業部署](deploy-foundation-infrastructure-non-enterprises.md)
...
### [讓遠端員工](empower-people-to-work-remotely.md)
...
## [Windows 10 手動升級的 Windows 7](windows-7-to-windows-10-upgrade-manual.md)
## [為 Windows 10 的 Windows 7 自動升級](windows-7-to-windows-10-upgrade-automated.md)
