...
您已[保護 Office 365 全域系統管理員帳戶](https://docs.microsoft.com/office365/enterprise/protect-your-global-administrator-accounts)，以避免可能會導致違反 Office 365 訂閱規定的洩露認證。
...
您已使用「[Office 365 部署多重要素驗證方案](https://docs.microsoft.com/office365/admin/security-and-compliance/multi-factor-authentication-plan)」與「[為 Office 365 使用者設定多重要素驗證](https://docs.microsoft.com/office365/admin/security-and-compliance/set-up-multi-factor-authentication)」來啟用使用者帳戶的多重要素驗證 (MFA)。
