...
在您進行階段 3 之前，請確認您的身分識別基礎結構符合這些條件。另請參閱[先決條件](https://docs.microsoft.com/microsoft-365-enterprise/identity-access-policies#prerequisites)以了解對身分識別基礎結構的其他建議。
...
|||
|:-------|:-----|
|![](./media/deploy-foundation-infrastructure/win10enterprise_icon-small.png)| Microsoft 365 企業版 端對端部署程序的下一個階段是 [Windows 10 企業版](windows10-infrastructure.md)。 |
