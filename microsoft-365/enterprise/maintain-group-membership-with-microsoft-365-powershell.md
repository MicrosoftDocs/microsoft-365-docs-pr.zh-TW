...
您可以使用 Microsoft 365 的 PowerShell 代替 microsoft 365 系統管理中心，以維護 Microsoft 365 中的安全性群組成員資格。 

>[!Note]
>瞭解如何使用 Microsoft 365 admin center[維護 microsoft 365 群組成員資格](../admin/create-groups/add-or-remove-members-from-groups.md)。 如需其他資源的清單，請參閱 [管理使用者和群組](../admin/add-users/index.yml)。
>
