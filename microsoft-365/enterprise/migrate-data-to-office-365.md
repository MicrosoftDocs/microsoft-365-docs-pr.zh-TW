...
- [線上及 OneDrive 遷移至 SharePoint](/sharepointmigration/migrate-to-sharepoint-online)。  (管理員) 
- [SharePoint 伺服器的混合](/SharePoint/hybrid/configuration-roadmaps)式設定藍圖。  (管理員) 

## <a name="migrate-skype-for-business-users"></a>移轉商務用 Skype 使用者
- [移轉至商務用 Skype Online](/SkypeForBusiness/hybrid/move-users-between-on-premises-and-cloud?bc=%2fSkypeForBusiness%2fbreadcrumb%2ftoc.json&toc=%2fSkypeForBusiness%2ftoc.json) (英文)。(系統管理員)
