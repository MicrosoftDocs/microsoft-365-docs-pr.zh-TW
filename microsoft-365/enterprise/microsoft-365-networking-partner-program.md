...
若要將商業網路完美連接至 Microsoft 365，客戶常常依靠網路解決方案供應商、內部部署或雲端式安全性服務，以及系統整合裝置，來規劃、設計及實施雲端服務的網路連線能力。 客戶通常會詢問 Microsoft 其網路架構和解決方案是否與 Microsoft 365 搭配使用，以及是否與 microsoft 的 microsoft 網路連線原則搭配使用， [以供 microsoft 365](./microsoft-365-network-connectivity-principles.md)使用。
...
如果您是 Microsoft 365 客戶，可透過此頁面讓您的網路解決方案提供者知道此程式 [https://aka.ms/Office365NPP]() 。
