...
使用者推出的圖形陰影指出，透過使用結構化或有條理的方法 (例如群組、部門或區域)，在貴組織中從 0% 到 100% 完整推出。
...
- 我於 10 月取得裝置註冊和 App，並套用條件式存取原則。(行動裝置管理)
...
- 我於 7 月取得裝置註冊和 App，並套用條件式存取原則。(行動裝置管理)
...
- 在目前階段的使用者推出期間，使用者推出下一階段的方式是，沒有使用者同時處理多個階段的推出。這假設您以相同方式透過區域、部門或其他方法推出底層基礎結構的每一階段。
...
- 我於 3 月取得裝置註冊和 App，並套用條件式存取原則。(行動裝置管理)
...
- 我於 4 月取得裝置註冊和 App，並套用條件式存取原則。(行動裝置管理)
