...
---
# <a name="deploy-microsoft-365-enterprise-for-your-organization"></a>為您的組織部署 Microsoft 365 企業版

您準備好部署 Microsoft 365 企業版、整合它與您的內部部署基礎結構，以及讓員工能夠利用雲端式生產力和共同作業嗎？

本文說明兩種部署選項，不論您是要協助或自行執行。 在每個案例中，Microsoft 都會為您提供指導，讓您遵循部署成功的途徑。

## <a name="guided-microsoft-365-enterprise-setup-process-with-fasttrack"></a>使用 FastTrack 進行的導向 Microsoft 365 企業版安裝程式
...
## <a name="do-it-yourself-guided-deployment-of-microsoft-365-enterprise"></a>Microsoft 365 企業版的自行指導部署

您必須先部署 Microsoft 365 企業版，才能進行設計決策，以簡化 Microsoft 365 服務設定和使用者採用的設計決策。 請在 [這裡](get-your-organization-ready-for-office-365.md)開始您的規劃。

若要在完成規劃後自行部署 Microsoft 365 企業版，這些是建議的步驟。
...
4. [部署用戶端軟體](/DeployOffice/deployment-guide-microsoft-365-apps)
   ...
   包括部署先前命名為 Office 365 專業增強版)  (的 Microsoft 365 Apps 企業版，雲端更新及永遠-目前版本的 Office 套件 (Word、Excel、PowerPoint，以及其他) 在您的裝置上。 每個 Microsoft 365 用戶端授權都包含 Microsoft 365 Apps 企業版的授權。
...
5. [設定行動裝置管理](https://support.office.com/article/set-up-mobile-device-management-mdm-in-office-365-dd892318-bc44-4eb1-af00-9db5430be3cd)
   ...
   Microsoft 365 企業版包括可協助您保護和管理使用者行動裝置的行動裝置管理功能。
 
6. [設定服務和應用程式](configure-services-and-applications.md)

   包含資料移轉的相關資訊，以及可讓您在重要 Microsoft 365 生產力應用程式（如 Exchange Online、SharePoint 線上及 Teams）上開始的文章連結。
...
>[!Note]
>這些步驟也適用于想要從 Microsoft 365 企業版的自訂部署開始的企業和[非營利組織](https://go.microsoft.com/fwlink/?LinkId=627221)。 
>