...
您必須先啟動 Rights management service (RMS) ，才能使用 Microsoft 365 應用程式和服務的資訊版權管理 (IRM) 功能。 啟動 RMS 後，您的組織可以開始使用 Azure RMS 來保護重要的檔和電子郵件。 此資訊保護解決方案可以保護所有檔案類型，並與用戶端應用程式（如 Excel、Microsoft Word 和其他使用者）、Exchange Online 和 SharePoint 線上，以及 microsoft Exchange 和 microsoft SharePoint 等伺服器整合。
...
- 如需有關為 Microsoft 365 啟用 RMS 的指示，請參閱[從 Azure 資訊保護啟用保護服務](/azure/information-protection/activate-service)。