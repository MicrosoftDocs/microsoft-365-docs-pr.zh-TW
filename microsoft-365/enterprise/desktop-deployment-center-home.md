...
<table border="0">
 ...
 <td>
    ...
    <tr>
    <td>
使用 SCCM 的組織所需之目錄和網絡整備步驟的部分 </td>
    <td>
電腦 App 保證可提供說明的裝置和應用程式的整備步驟的部分 </td>
    <td>
保留使用者的電腦所需的 OS 部署及功能更新步驟的部分 </td>
    </tr>
</table>
...
<td><p><strong><a href="https://aka.ms/mdd1">步驟 1：裝置和應用程式整備</a></strong> (英文)</p>
