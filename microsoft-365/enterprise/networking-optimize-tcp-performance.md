...
---
# <a name="step-5-optimize-client-and-microsoft-365-service-performance"></a>步驟 5：最佳化用戶端和 Microsoft 365 服務效能

*此為選用步驟，且同時適用於 Microsoft 365 企業版 E3 和 E5 版本*

![階段 1 - 網路](../media/deploy-foundation-infrastructure/networking_icon-small.png)

您可以透過微調傳輸控制通訊協定 (TCP) 在用戶端裝置與 Microsoft 365 服務間的運作方式來增加效能。
...
針對 Microsoft 365 服務，請參閱這些額外的資源以最佳化效能：
