...
如需進一步的保護，請參閱[保護您的全域系統管理員帳戶](https://docs.microsoft.com/office365/enterprise/protect-your-global-administrator-accounts#additional-protections-for-enterprise-organizations) (部分機器翻譯)。
...
若要啟用特殊權限存取管理，請參閱[設定特殊權限存取管理](https://docs.microsoft.com/office365/securitycompliance/privileged-access-management-configuration) (部分機器翻譯) 主題。

如需詳細資訊，請參閱[特殊權限存取管理](https://docs.microsoft.com/office365/securitycompliance/privileged-access-management-overview) (部分機器翻譯) 主題。
