...
---
# <a name="device-compliance-policies-for-your-microsoft-365-for-enterprise-test-environment"></a>適用于企業測試環境 Microsoft 365 的裝置合規性原則

*此測試實驗室指南僅可用於企業測試環境的 Microsoft 365。*

本文說明如何為 Windows 10 裝置新增 Intune 裝置符合性原則，以及 Microsoft 365 Apps 企業版企業測試環境的 Microsoft 365。
...
在此階段中，您會為 Windows 10 裝置建立裝置符合性原則。 此階段使用 Microsoft Intune 和[Microsoft 端點管理員系統管理中心](https://go.microsoft.com/fwlink/?linkid=2109431)新增群組，並建立符合性原則。

1. 移至[Microsoft 365 系統管理中心](https://admin.microsoft.com)，並以全域系統管理員帳戶登入您的 Microsoft 365 測試實驗室訂閱。 選取 [**端點管理員** 系統管理中心]。 [端點管理員系統管理中心](https://go.microsoft.com/fwlink/?linkid=2109431)隨即開啟。
    ...
    端點管理員系統管理中心著重于裝置管理及應用程式管理。 如需此系統管理中心的導覽，請參閱 Microsoft 端點管理員中的[教學課程：逐步 Intune](/mem/intune/fundamentals/tutorial-walkthrough-endpoint-manager)。

2. 在 **[群組**] 中，使用 **指派** 的成員資格類型，新增名為 **Managed Windows 10 裝置使用者** 的新 **Microsoft 365** 或 **安全** 組。 在後續步驟中，您會將您的相容性原則指派給此群組。 

    如需特定步驟，以及 **Microsoft 365** 或 **安全性** 群組的詳細資訊，請參閱 [新增群組以組織使用者和裝置](/mem/intune/fundamentals/groups-add)。

3. 在 [**裝置**] 中，建立 Windows 10 合規性原則。 將此原則指派給您建立的 **受管理的 Windows 10 裝置使用者** 群組。
...
完成時，您會有裝置規範原則，可用於測試 **Managed Windows 10 裝置使用者** 群組中的成員。
...
[在您的 Microsoft 365 中註冊企業測試環境的 iOS 和 Android 裝置](enroll-ios-and-android-devices-in-your-microsoft-enterprise-365-dev-test-environ.md)
