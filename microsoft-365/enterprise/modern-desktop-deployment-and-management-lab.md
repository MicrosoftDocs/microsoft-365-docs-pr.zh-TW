...
* 使用內部主控台更新，可將已安裝的基準版本2002更新為版本2010。 請使用廣泛的頻寬下載此內容，以增強您的下載體驗，並允許自動布建的30-45 分鐘。 實驗室環境至少需要16GB 的可用記憶體和150GB 可用磁碟空間。 為了達到最佳效能，建議32GB 可用記憶體和300GB 可用空間。 實驗室于2021年2月7日到期。 在到期之前會發佈新的版本。
