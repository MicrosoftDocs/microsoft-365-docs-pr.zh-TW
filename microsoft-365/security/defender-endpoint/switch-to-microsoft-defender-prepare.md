...
最佳作法是將組織的裝置和端點保持在最新狀態。 請確定現有的 endpoint protection 和防病毒方案是最新的，而且您組織的作業系統和應用程式也會有最新的更新。 現在這樣做可以協助您在遷移至 Microsoft Defender 以進行端點和 Microsoft Defender 防毒軟體時，避免發生問題。
...
> [!NOTE]
> Microsoft Defender 資訊安全中心有時稱為端點入口網站，可于中存取 [https://aka.ms/MDATPportal](https://aka.ms/MDATPportal) 。 
...
|防毒 |macOS： <br/>-11.3.1 (大型 Sur) <br/>-10.15 (Catalina) <br/>-10.14 (Mojave)  |[MacOS 上的 Microsoft Defender for Endpoint： Network connections](microsoft-defender-endpoint-mac.md#network-connections) |
