...
---
# <a name="configure-and-manage-microsoft-threat-experts-capabilities"></a>設定和管理 Microsoft 威脅專家功能
...
> [!NOTE]
> 請先與您的 Microsoft 技術服務提供者和帳戶小組討論資格需求，然後再套用至 Microsoft 威脅專家目標的攻擊通知受管理威脅搜尋服務。

確定您在環境中部署裝置時，您已有已註冊的端點，而不只是實驗室設定。

如果您是 Endpoint 客戶的 Defender，您必須針對 **Microsoft 威脅專家目標攻擊通知** 進行套用，以取得特殊的洞察力和分析，以協助找出最嚴重的威脅，讓您能快速回應這些威脅。 請與您的帳戶小組或 Microsoft 代表聯繫，以訂閱 **Microsoft 威脅專家的專家**，以諮詢我們對相關偵測和敵人的威脅專家。

## <a name="apply-for-microsoft-threat-experts---targeted-attack-notifications-service"></a>適用于 Microsoft 威脅專家目標的攻擊通知服務 
如果您已經是 Endpoint 客戶的 Defender，您可以透過 Microsoft Defender 資訊安全中心加以套用。 

1. 在功能窗格中，移至 **設定 > 一般 > 高級功能 > Microsoft 威脅專家已設定攻擊通知**。
...
這是提供訂閱服務。 如果您已經是 Endpoint 客戶的 Defender，您可以聯繫您的 Microsoft 代表，以訂閱 Microsoft 威脅專家的要求。 
...
您可以合作 Microsoft 威脅專家誰可以直接從 Microsoft Defender 資訊安全中心中直接參與，以進行及時且準確的回應。 專家會提供深入瞭解複雜威脅、您取得的目標攻擊通知，或者您需要相關資訊的詳細資訊，如您在入口網站儀表板上看到的警示、可能受損的裝置或威脅情報內容等相關資訊。 
...
2. 從右上方的功能表中，按一下 [ **？** ] 圖示。 然後，選取 [ **對威脅專家進行協商**]。 
    ...
    下列畫面會顯示當您是在完全 Microsoft 威脅專家專家的點播訂閱上時。
...
## <a name="sample-investigation-topics-that-you-can-consult-with-microsoft-threat-experts---experts-on-demand"></a>範例調查主題，您可以根據需求 Microsoft 威脅專家專家進行參考 
...
- 我收到來自 Microsoft 威脅專家的目標攻擊通知。 您可以為我們提供哪些資料，讓我們能夠傳遞給我們的事件回應小組？
  ...
  >[!NOTE]
  >Microsoft 威脅專家是受管理 cybersecurity 搜尋服務，並非事件回應服務。 不過，當必要時，專家可將調查順利轉換至 Microsoft Cybersecurity 解決方案群組 (CSG) 的偵測和回應小組 (DART) 服務。 您也可以選擇與您自己的事件回應小組合作，以解決需要事件回應的問題。 

## <a name="scenario"></a>案例

### <a name="receive-a-progress-report-about-your-managed-hunting-inquiry"></a>接收受管理搜尋查詢的進度報告 
Microsoft 威脅專家的回應會根據您的查詢而有所不同。 他們會透過電子郵件傳送進度報告給您，讓您參考兩天內的 **威脅專家** 查詢，以便從下列類別傳達調查狀態： 
- 需要有其他資訊才能繼續進行調查 
...
- [Microsoft 365 概覽中的 Microsoft 威脅專家](/microsoft-365/security/mtp/microsoft-threat-experts)
