...
若尚未這麼做，請將您的 Microsoft 365 Defender 入口網站設定為查看提醒、設定威脅防護功能，以及查看組織整體安全性狀況的詳細資訊。 請參閱[Microsoft Defender 資訊安全中心](microsoft-defender-security-center.md)。 您也可以設定使用者在 Microsoft 365 Defender 入口網站中是否可以看見的功能和使用者。
