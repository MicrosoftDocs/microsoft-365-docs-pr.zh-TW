...
#### [階段 3：上線](switch-to-microsoft-defender-onboard.md)
### [移轉後管理適用於端點的 Defender]()
#### [管理適用於端點的 Defender 概觀](manage-atp-post-migration.md)
...
##### [管理 Microsoft Defender 更新的漸進式推出程序](manage-gradual-rollout.md)
