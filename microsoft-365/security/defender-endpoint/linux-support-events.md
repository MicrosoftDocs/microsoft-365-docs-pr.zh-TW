...
---
# <a name="troubleshoot-missing-events-or-alerts-issues-for-microsoft-defender-for-endpoint-for-linux"></a>針對適用于 Linux 的 Microsoft Defender for Endpoint 進行遺失的事件或警示問題進行疑難排解

[!INCLUDE [Microsoft 365 Defender rebranding](../../includes/microsoft-defender.md)]

**適用於：**

- [適用于 Linux 的 Microsoft Defender for Endpoint](microsoft-defender-endpoint-linux.md)
