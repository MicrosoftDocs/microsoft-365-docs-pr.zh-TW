...
---
# <a name="detect-and-block-potentially-unwanted-applications-with-microsoft-defender-for-endpoint-for-linux"></a>使用 Microsoft Defender for Linux，偵測並封鎖可能有害的應用程式
