...
您可以 [開始免費試用版](https://www.microsoft.com/microsoft-365/windows/microsoft-defender-atp)，評估您組織中的 Microsoft Defender for Endpoint。

您也可以使用下列指示，評估 Microsoft Defender for Endpoint 中的不同安全性功能。

## <a name="evaluate-attack-surface-reduction"></a>評估攻擊面減少

這些功能可協助防止攻擊和 exploitations 感染您的組織。
...
[Microsoft Defender for Endpoint 簡介](microsoft-defender-advanced-threat-protection.md)
