...
---
# <a name="run-antivirus-scan-api"></a>執行防病毒掃描 API
...
在裝置上開始 Microsoft Defender 防毒軟體掃描。
...
ScanType|   字串  | 定義掃描類型。 **必要欄位**。

**ScanType** 控制要執行的掃描類型，可為下列其中一項：
...
如果成功，這個方法會傳回201、在回應內文中建立的回應碼和 _MachineAction_ 物件。
