...
|工作|可深入了解的資源|
|---|---|
|**管理 Microsoft Defender 防毒軟體** <p> 查看反惡意程式碼保護的狀態、設定防病毒掃描的喜好設定 & 更新，以及對您的防防毒保護進行其他變更。|[使用 PowerShell Cmdlet 來設定及管理 Microsoft Defender 防毒軟體](/windows/security/threat-protection/microsoft-defender-antivirus/use-powershell-cmdlets-microsoft-defender-antivirus) <p> [使用 PowerShell Cmdlet 以啟用雲端提供的保護](/windows/security/threat-protection/microsoft-defender-antivirus/enable-cloud-protection-microsoft-defender-antivirus#use-powershell-cmdlets-to-enable-cloud-delivered-protection)|
|**設定 exploit protection** ，以減輕組織裝置的威脅 <p> *我們建議您先在 [稽核模式](/microsoft-365/security/defender-endpoint/evaluate-exploit-protection#powershell) 中使用 exploit protection。如此一來，您就可以看到使用方式保護會如何影響組織所使用的應用程式。*|[自訂利用保護](/microsoft-365/security/defender-endpoint/customize-exploit-protection) <p> [PowerShell 用於 exploit protection 的 Cmdlet](/microsoft-365/security/defender-endpoint/customize-exploit-protection#powershell-reference)|
|使用 PowerShell **設定攻擊面降低規則** <p> *您可以使用 PowerShell，從攻擊面減少規則中排除檔案和資料夾。*|[自訂攻擊面降減規則：使用 PowerShell 排除檔案 & 資料夾](/microsoft-365/security/defender-endpoint/customize-attack-surface-reduction#use-powershell-to-exclude-files-and-folders) <p> 此外，請參閱 [António Vasconcelo 的圖形使用者介面工具，以使用 PowerShell 來設定攻擊面降減規則](https://github.com/anvascon/MDATP_PoSh_Scripts/tree/master/ASR%20GUI)。|
|使用 PowerShell **啟用網路保護** <p> *您可以使用 PowerShell 來啟用網路保護。*|[使用 PowerShell 開啟網路保護](/microsoft-365/security/defender-endpoint/enable-network-protection#powershell)|
|**設定受管理的資料夾存取** 權以防護勒索軟體 <p> *「[受管理的資料夾存取](/microsoft-365/security/defender-endpoint/controlled-folders)」也稱為 antiransomware protection。*|[啟用 PowerShell 的可控資料夾存取](/microsoft-365/security/defender-endpoint/enable-controlled-folders#powershell)|
|**設定 Microsoft Defender 防火牆** ，以封鎖進出組織裝置的未授權網路流量|[使用 Windows PowerShell 進行高級安全性管理的 Microsoft Defender 防火牆](/windows/security/threat-protection/windows-firewall/windows-firewall-with-advanced-security-administration-with-windows-powershell)|
|**設定加密和 BitLocker** ，以保護組織執行 Windows 的裝置資訊|[BitLocker PowerShell 參考手冊](/powershell/module/bitlocker/)|
...
|**檢索、修改和更新** Microsoft Defender 防毒軟體的設定|[使用 WMI 設定及管理 Microsoft Defender 防毒軟體] (/windows/security/threat-protection/microsoft-defender-antivirus/use-wmi-microsoft-defender-antivirus <p> [檢查可用 WMI 類別和範例腳本的清單](/previous-versions/windows/desktop/defender/windows-defender-wmiv2-apis-portal) <p> 另請參閱封存的[Windows Defender WMIv2 提供者參考資訊](/previous-versions/windows/desktop/defender/windows-defender-wmiv2-apis-portal?redirectedfrom=MSDN)|
...
- [取得威脅與弱點管理的概觀](/microsoft-365/security/defender-endpoint/next-gen-threat-and-vuln-mgt)
