...
---
# <a name="microsoft-defender-for-endpoint-device-timeline-event-flags"></a>Microsoft Defender for Endpoint 裝置的時間表事件旗標
...
## <a name="flag-an-event"></a>旗標事件
1. 尋找您要標示的事件
2. 按一下 [旗標] 欄中的旗標圖示。 
![裝置時程表旗標的影像](images/device-flags.png)
