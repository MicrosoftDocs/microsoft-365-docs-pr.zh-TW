...
**歡迎使用 [從 Symantec 遷移至 Defender for Endpoint](symantec-to-microsoft-defender-endpoint-migration.md#the-migration-process)的準備階段**。 

此遷移階段包含下列步驟：

1. [更新您組織的裝置](#update-your-organizations-devices)。
...
## <a name="update-your-organizations-devices"></a>更新您組織的裝置

最佳作法是將組織的裝置和端點保持在最新狀態。 請確定現有的 endpoint protection 和防病毒方案是最新的，而且您組織的作業系統和應用程式也會有最新的更新。 現在這樣做可以協助您在遷移至更新至 Defender 時，避免發生問題。

### <a name="make-sure-symantec-is-up-to-date"></a>請確定 Symantec 是最新版本

保留現有的 endpoint protection 方案，並確定您組織的裝置具有最新的安全性更新。

需要協助？ 請參閱 Broadcom 的檔： [Symantec Endpoint Protection 安裝與管理指南](https://techdocs.broadcom.com/us/en/symantec-security-software/endpoint-security-and-management/endpoint-protection/all.html)

### <a name="make-sure-your-endpoints-are-up-to-date"></a>確定您的端點是最新的
...
1. 立即購買或試用 Endpoint for Endpoint。 [請造訪用於端點的 Defender，以開始免費試用版或要求報價](https://aka.ms/mdatp)。 
...
|防毒 |macOS： <p>11.3.1 (大型 Sur) <p>10.15 (Catalina) <p>10.14 (Mojave)   |[Mac 版上端點的 Defender：網路連接](microsoft-defender-endpoint-mac.md#network-connections) |
...
**恭喜**！ 您已完成 [從 Symantec 遷移至 Defender For Endpoint](symantec-to-microsoft-defender-endpoint-migration.md#the-migration-process)的 **準備** 階段！
- [繼續設定端點的 Defender](symantec-to-microsoft-defender-atp-setup.md)。
