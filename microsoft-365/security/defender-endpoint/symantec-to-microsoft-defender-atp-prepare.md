...
|![階段1：準備](images/phase-diagrams/prepare.png)<br/>階段1：準備 |[![階段2：設定](images/phase-diagrams/setup.png)](symantec-to-microsoft-defender-atp-setup.md)<br/>[階段2：設定](symantec-to-microsoft-defender-atp-setup.md) |[![階段3：板載](images/phase-diagrams/onboard.png)](symantec-to-microsoft-defender-atp-onboard.md)<br/>[階段3：板載](symantec-to-microsoft-defender-atp-onboard.md) |
|--|--|--|
|*您在這裡！*| | |


**歡迎使用 [從 Symantec 遷移至 Microsoft Defender for Endpoint](symantec-to-microsoft-defender-atp-migration.md#the-migration-process)的準備階段**。 
...
|防毒 |macOS： <br/>-10.15 (Catalina) <br/>-10.14 (Mojave)  <br/>-10.13 (高塞拉里昂)  |[適用于 Mac 的 Microsoft Defender 端點：網路連接](https://docs.microsoft.com/microsoft-365/security/defender-endpoint/microsoft-defender-atp-mac#network-connections) |
...
**恭喜**！ 您已完成 [從 Symantec 遷移至 Microsoft Defender For Endpoint](symantec-to-microsoft-defender-atp-migration.md#the-migration-process)的 **準備** 階段！
