...
瞭解如何在使用 Jamf Pro 的 macOS 上部署 Microsoft Defender for Endpoint。

> [!NOTE]
> 如果您使用 macOS Catalina (10.15.4) 或更新版本的 macOS，請參閱 [新的設定設定檔以取得 MacOS Catalina 和更新版本的 macOS](https://docs.microsoft.com/microsoft-365/security/defender-endpoint/mac-sysext-policies)。

這是一個多重步驟過程。 您必須完成下列所有步驟：

- [登入至 Jamf 入口網站](mac-install-jamfpro-login.md)
- [在 Jamf Pro 的 macOS 裝置群組上設定 Microsoft Defender for Endpoint](mac-jamfpro-device-groups.md)
- [在 Jamf Pro 的 macOS 原則上設定 Microsoft Defender for Endpoint](mac-jamfpro-policies.md)
- [在 macOS 裝置上為 Jamf Pro 註冊 Microsoft Defender for Endpoint](mac-jamfpro-enroll-devices.md)
