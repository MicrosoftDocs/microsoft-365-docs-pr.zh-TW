...
## <a name="enable-and-configure-always-on-protection-in-group-policy"></a><span data-ttu-id="9bfe5-109">啟用並設定群組原則中的 always on 保護</span><span class="sxs-lookup"><span data-stu-id="9bfe5-109">Enable and configure always-on protection in Group Policy</span></span>
...
2. <span data-ttu-id="9bfe5-117">在 [**本機群組原則編輯器**] 的左窗格中，展開 [**電腦設定] 系統**  >  **管理範本**  >  **Windows 元件**  >  **Microsoft Defender 防毒軟體** 的樹狀目錄。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-117">In the left pane of **Local Group Policy Editor**, expand the tree to **Computer Configuration** > **Administrative Templates** > **Windows Components** > **Microsoft Defender Antivirus**.</span></span> 
...
4. <span data-ttu-id="9bfe5-134">設定 Microsoft Defender 防毒軟體即時保護原則設定。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-134">Configure the Microsoft Defender Antivirus real-time protection policy settings.</span></span> <span data-ttu-id="9bfe5-135">若要執行這項作業：</span><span class="sxs-lookup"><span data-stu-id="9bfe5-135">To do this:</span></span>
    ...
    1. <span data-ttu-id="9bfe5-138">在 [ **即時保護** 詳細資料] 窗格的 [許可權] 中，按兩下下表所指定的原則設定：</span><span class="sxs-lookup"><span data-stu-id="9bfe5-138">In the **Real-time Protection** details pane on right, double-click the policy setting as specified in the following table:</span></span>  
       ...
       | <span data-ttu-id="9bfe5-174">設定本機設定覆寫以監控電腦上的檔案和程式活動</span><span class="sxs-lookup"><span data-stu-id="9bfe5-174">Configure local setting override for monitoring file and program activity on your computer</span></span> | <span data-ttu-id="9bfe5-175">設定本機覆寫，以監視電腦上的檔案和程式活動。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-175">Configure a local override for the configuration of monitoring for file and program activity on your computer.</span></span> <span data-ttu-id="9bfe5-176">此設定只可由「群組原則」設定。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-176">This setting can only be set by Group Policy.</span></span> <span data-ttu-id="9bfe5-177">如果您啟用此設定，則本機偏好設定會優先于「群組原則」。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-177">If you enable this setting, the local preference setting will take priority over Group Policy.</span></span> <span data-ttu-id="9bfe5-178">如果您停用或未設定此設定，群組原則將優先于本機偏好設定。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-178">If you disable or do not configure this setting, Group Policy will take priority over the local preference setting.</span></span>| <span data-ttu-id="9bfe5-179">Enabled</span><span class="sxs-lookup"><span data-stu-id="9bfe5-179">Enabled</span></span> |
       | <span data-ttu-id="9bfe5-180">設定本機設定覆寫以開啟即時保護</span><span class="sxs-lookup"><span data-stu-id="9bfe5-180">Configure local setting override to turn on real-time protection</span></span> | <span data-ttu-id="9bfe5-181">設定本機覆寫設定，以開啟即時保護。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-181">Configure a local override for the configuration to turn on real-time protection.</span></span> <span data-ttu-id="9bfe5-182">此設定只可由「群組原則」設定。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-182">This setting can only be set by Group Policy.</span></span> <span data-ttu-id="9bfe5-183">如果您啟用此設定，則本機偏好設定會優先于「群組原則」。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-183">If you enable this setting, the local preference setting will take priority over Group Policy.</span></span> <span data-ttu-id="9bfe5-184">如果您停用或未設定此設定，群組原則將優先于本機偏好設定。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-184">If you disable or do not configure this setting, Group Policy will take priority over the local preference setting.</span></span>| <span data-ttu-id="9bfe5-185">Enabled</span><span class="sxs-lookup"><span data-stu-id="9bfe5-185">Enabled</span></span> |
       | <span data-ttu-id="9bfe5-186">設定針對內送和外寄檔案活動進行監視的本機設定覆寫</span><span class="sxs-lookup"><span data-stu-id="9bfe5-186">Configure local setting override for monitoring for incoming and outgoing file activity</span></span> | <span data-ttu-id="9bfe5-187">設定本機覆寫，以監視傳入和傳出檔案活動的監視。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-187">Configure a local override for the configuration of monitoring for incoming and outgoing file activity.</span></span> <span data-ttu-id="9bfe5-188">此設定只可由「群組原則」設定。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-188">This setting can only be set by Group Policy.</span></span> <span data-ttu-id="9bfe5-189">如果您啟用此設定，則本機偏好設定會優先于「群組原則」。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-189">If you enable this setting, the local preference setting will take priority over Group Policy.</span></span> <span data-ttu-id="9bfe5-190">如果您停用或未設定此設定，群組原則將優先于本機偏好設定。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-190">If you disable or do not configure this setting, Group Policy will take priority over the local preference setting.</span></span> | <span data-ttu-id="9bfe5-191">Enabled</span><span class="sxs-lookup"><span data-stu-id="9bfe5-191">Enabled</span></span> |
       | <span data-ttu-id="9bfe5-192">設定對內送和外寄檔案和程式活動的監控</span><span class="sxs-lookup"><span data-stu-id="9bfe5-192">Configure monitoring for incoming and outgoing file and program activity</span></span> | <span data-ttu-id="9bfe5-193">指定監視是否應該發生在內送、撥出、兩者或兩者的方向。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-193">Specify whether monitoring should occur on incoming, outgoing, both, or neither direction.</span></span> <span data-ttu-id="9bfe5-194">這適用于您已定義特定伺服器或伺服器角色的 Windows 伺服器安裝，只會在一個方向上看到大量的檔案變更，且您想要提升網路效能。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-194">This is relevant for Windows Server installations where you have defined specific servers or Server Roles that see large amounts of file changes in only one direction and you want to improve network performance.</span></span> <span data-ttu-id="9bfe5-195">完全更新的端點 (和伺服器) 在網路上，不論檔變更的數目或方向，都只會對效能造成影響。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-195">Fully updated endpoints (and servers) on a network will see little performance impact irrespective of the number or direction of file changes.</span></span> | <span data-ttu-id="9bfe5-196">已啟用兩個方向 () </span><span class="sxs-lookup"><span data-stu-id="9bfe5-196">Enabled (both directions)</span></span> |

    1. <span data-ttu-id="9bfe5-197">設定適當的設定，然後按一下 **[確定]**。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-197">Configure the setting as appropriate, and click **OK**.</span></span>
    
    1. <span data-ttu-id="9bfe5-198">針對表格中的每個設定，重複上述步驟。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-198">Repeat the previous steps for each setting in the table.</span></span>

5. <span data-ttu-id="9bfe5-199">設定 Microsoft Defender 防毒軟體掃描原則設定。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-199">Configure the Microsoft Defender Antivirus scanning policy setting.</span></span> <span data-ttu-id="9bfe5-200">若要執行這項作業：</span><span class="sxs-lookup"><span data-stu-id="9bfe5-200">To do this:</span></span>  

    1. <span data-ttu-id="9bfe5-201">在左窗格的 [ **Microsoft Defender 防毒軟體**] 樹狀目錄中，按一下 [**掃描**]。</span><span class="sxs-lookup"><span data-stu-id="9bfe5-201">From the **Microsoft Defender Antivirus** tree on left pane, click **Scan**.</span></span>
    
       ![Microsoft Defender 防毒軟體掃描選項](images/gpedit-windows-defender-antivirus-scan.png)

    1. <span data-ttu-id="9bfe5-203">在右側的 [ **掃描** 詳細資料] 窗格中，按兩下下清單格所指定的原則設定：</span><span class="sxs-lookup"><span data-stu-id="9bfe5-203">In the **Scan** details pane on right, double-click the policy setting as specified in the following table:</span></span>
...
- [<span data-ttu-id="9bfe5-227">設定行為、啟發學習法和即時保護</span><span class="sxs-lookup"><span data-stu-id="9bfe5-227">Configure behavioral, heuristic, and real-time protection</span></span>](configure-protection-features-microsoft-defender-antivirus.md)
