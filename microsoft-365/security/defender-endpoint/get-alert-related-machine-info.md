...
---
# <a name="get-alert-related-machine-information-api"></a>取得警示相關的機器資訊 API
...
如果成功及警示和裝置都存在-200 OK。 如果找不到警示或未找到裝置-找不到404。
