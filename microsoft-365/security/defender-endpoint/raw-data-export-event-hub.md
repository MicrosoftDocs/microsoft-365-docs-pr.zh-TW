...
1. 在您的租使用者中建立 [事件中樞](https://docs.microsoft.com/azure/event-hubs/) 。

2. 登入您的 [Azure 租](https://ms.portal.azure.com/)使用者，移至 [*] 訂閱 > 訂閱 > 資源提供者 > 註冊至 **Microsoft。**

## <a name="enable-raw-data-streaming"></a>啟用原始資料資料流程：

1. 以 ***全域管理員** _ 或 _ *_安全性管理員_* * 的身分登入 [Microsoft Defender 安全中心](https://securitycenter.windows.com)。

2. 移至 Microsoft Defender Security Center 上的 [ [資料匯出設定] 頁面](https://securitycenter.windows.com/interoperability/dataexport) 。
...
1. 登入 [Microsoft Defender Security Center](https://securitycenter.windows.com) ，然後移至 [ [高級搜尋] 頁面](https://securitycenter.windows.com/hunting-package)。
...
- [疑難排解連線問題-Azure 事件中樞](https://docs.microsoft.com/azure/event-hubs/troubleshooting-guide)
