...
## <a name="microsoft-software-license-terms-microsoft-report-message-and-report-phishing-add-in"></a>Microsoft 軟體授權條款： Microsoft Report Message 和 Report 仿冒增益集

> [!IMPORTANT]
> 如果您生活中或公司的經營地點是以美國為基礎，請閱讀 Section 7，系結 *仲裁和類別動作棄權*。 說明如何解決爭議。

> [!NOTE]
> *英文：* 因為此軟體是在加拿大發佈的，所以本合約中的部分條款 (專門于法文中提供的區段10、11和 12) 。
>
> *En Français* Ce logiciel étant distribué au 加拿大，certaines des 子句 dans ce contrat (spécifiquement dans les 區段10，11 et 12) sont fournies ci-dessous en français。
...
如果您遵循這些授權條款，您必須具備下列權利。 使用軟體，您接受這些條款。
...
10. *英文：* **使用者權限;地區變化** 此合約會說明某些法律權利。 You may have other rights, including consumer rights, under the laws of your state, province, or country. Separate and apart from your relationship with Microsoft, you may also have rights with respect to the party from which you acquired the software. This agreement does not change those other rights if the laws of your state, province, or country do not permit it to do so. 
    ...
    *在英文版中 (此區段中不提供更多法文轉譯) ：* 例如，如果您已在下列其中一個地區取得軟體，或套用必要的國家法律，則下列規定適用于您：
...
11. *英文：* **擔保免責聲明。** 軟體會以「目前」授權。 貴用戶須自行承擔使用風險。 Microsoft 不提供任何明示擔保、保證或條件。 若要在適用的法律規定的範圍內，Microsoft 排除所有默示的保證，包括適售性、特定用途的適用性，以及未侵權。
...
12. *英文：* **損害限制和排除。** 如果您有任何依據上述擔保免責聲明而復原損害的基準，您可以從 Microsoft 和其供應商處復原，只會直接對美國 $5.00 的損害。 您無法復原任何其他損毀，包括後果性、遺失利潤、特殊、間接或偶然的損害。

    此限制適用于) 與軟體、服務、內容 (（包括協力廠商網際網路網站上的程式碼) 或協力廠商應用程式）相關的任何專案 (;和 (b) 違反合約、擔保、擔保或條件的宣告;嚴格責任、疏忽或其他侵權行為;或任何其他宣告;在每個案例中，以適用法律允許的程度。

    It also applies even if Microsoft knew or should have known about the possibility of the damages. The above limitation or exclusion may not apply to you because your state, province, or country may not allow the exclusion or limitation of incidental, consequential, or other damages.

    *En Français：* **限制 DES DOMMAGES-INTÉRÊTS ET DE RESPONSABILITÉ澆築 LES DOMMAGES。** Vous pouvez obtenir de Microsoft et de se fournisseurs une indemnisation en cas de dommages 導向 uniquement à hauteur de 5，00 $ US。 Vous ne pouvez prétendre à aucune indemnisation pour les autres dommages, y compris les dommages spéciaux, indirects ou accessoires et pertes de bénéfices.

    Cette limitation concerne:

    - tout ce qui est relié au logiciel, aux services ou au contenu (y compris le code) figurant sur des sites Internet tiers ou dans des programmes tiers; et
    - les réclamations au titre 消除非法 de contrat ou de garantie，ou au titre de responsabilité stricte，de négligence ou d'une autre faute dans la limite autorisée par la loi en vigueur。
