...
- 您必須是 Office 365 全域系統管理員，或具有安全性與[ &amp;合規性中心](https://protection.office.com)中所指派的安全性系統管理員角色（例如安全性管理員）。 （請參閱[Office 365 安全性&amp;與合規性中心的許可權](permissions-in-the-security-and-compliance-center.md)）
...
使用 Office 365 安全性 & 規範中心和 Microsoft Defender Security Center，將 Office 365 ATP 與 Microsoft Defender ATP 整合。
  
1. 若為 Office 365 全域系統管理員或安全性管理員，請移[https://protection.office.com](https://protection.office.com)至並登入。
