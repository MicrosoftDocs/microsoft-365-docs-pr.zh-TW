...
|[適用於端點的 Microsoft Defender](/windows/security/threat-protection/)|Azure 中主控的 HTTPS 端點 <p> REST API|[將提醒納入您的 SIEM 工具](/windows/security/threat-protection/microsoft-defender-atp/configure-siem)|
