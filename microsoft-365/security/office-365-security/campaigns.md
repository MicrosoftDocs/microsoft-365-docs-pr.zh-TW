...
如果您有 Microsoft Defender for Endpoint 訂閱，您可以按一下 [ **WDATP** ]，以使用 microsoft Defender for endpoint 連線或中斷市場活動資訊的連線。 如需詳細資訊，請參閱將 [Microsoft defender For Office 365 與 Microsoft defender For Endpoint 整合](https://docs.microsoft.com/microsoft-365/security/office-365-security/integrate-office-365-ti-with-wdatp)。
