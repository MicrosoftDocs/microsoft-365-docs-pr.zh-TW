...
2. 在 Office 365 安全性與合規性中心的左側瀏覽窗格中，於 **[威脅管理]** 底下，選擇 **[原則]** \> **[安全附件]**。 <br/>![在安全性與合規性中心選擇 [威脅管理] \> [原則]](../media/08849c91-f043-4cd1-a55e-d440c86442f2.png)
  
3. 選取 **[開啟適用於 SharePoint、OneDrive 與 Microsoft Teams 的 ATP]**。<br/>![開啟適用於 SharePoint Online、商務用 OneDrive 與 Microsoft Teams 的進階威脅防護](../media/48cfaace-59cc-4e60-bf86-05ff6b99bdbf.png)
  
4. 按一下 **[儲存]**。
    
5. 檢閱 (並視需要編輯) 組織的 [[安全附件原則]](set-up-atp-safe-attachments-policies.md) 和 [[安全連結原則]](set-up-atp-safe-links-policies.md)。
    
6. (建議) 身為全域系統管理員或 SharePoint Online 系統管理員，請執行 **[Set-SPOTenant](https://docs.microsoft.com/powershell/module/sharepoint-online/Set-SPOTenant?view=sharepoint-ps)** Cmdlet，並將 **DisallowInfectedFileDownload** 參數設為 *true*。 <br/>
...
1. 在 [[Office 365 安全性與合規性中心]](https://protection.office.com) 中，選擇 **[警示]** \> **[管理警示]**。
...
若要深入了解這些警示，請參閱[在 Office 365 安全性與合規性中心建立活動警示](../../compliance/create-activity-alerts.md)。 
