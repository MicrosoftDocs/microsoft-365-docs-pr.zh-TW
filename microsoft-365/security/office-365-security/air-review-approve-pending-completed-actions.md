...
- [控制中心](https://security.microsoft.com/action-center/pending)
- 自行調查 (透過事件或警示存取) 
- [調查和修正調查佇列](https://security.microsoft.com/airinvestigation)

## <a name="incident-queue"></a>事件佇列
1. 請移至[Microsoft 365 的安全性中心](https://security.microsoft.com)並登入。
...
3. 在螢幕右側的窗格中，選取適當的動作 (**移至 [收件** 匣]、[ **移至垃圾** 郵件]、[ **移至刪除的郵件**]、[* 虛刪除] 或 [ **實刪除** ]) 。
