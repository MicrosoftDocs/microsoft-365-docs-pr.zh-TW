...
- **電子郵件保護類型的優先順序**：此順序並不是可設定的，如下表所述：
  ...
  ****
  ...
  |位<sup>\*</sup>|使用者模擬 (受保護的網域) |UIMP|[設定 ATP 防網路釣魚原則](configure-atp-anti-phishing-policies.md)|
  |6<sup>\*</sup>|網域模擬 (受保護的使用者) |DIMP|[設定 ATP 防網路釣魚原則](configure-atp-anti-phishing-policies.md)|
