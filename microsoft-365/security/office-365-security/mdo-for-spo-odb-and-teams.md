...
從2018年5月的 SharePoint、OneDrive 及 Microsoft Teams 的安全附件，將檔案識別為惡意檔時，也會在隔離區中使用該檔案。 如需詳細資訊，請參閱[Use the security center to manage Office 365 的 Defender 中的隔離](manage-quarantined-messages-and-files.md#use-the-security-center-to-manage-quarantined-files-in-defender-for-office-365)檔案。
