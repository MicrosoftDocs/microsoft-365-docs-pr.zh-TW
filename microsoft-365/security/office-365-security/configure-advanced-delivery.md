...
您可以使用 Microsoft 365 中的 _高級傳遞原則_ ，避免這些 _特定案例中_ 的郵件受到篩選 <sup>\*</sup> 。 高級傳遞原則可確保不會篩選這些案例中的郵件：

- EOP 和 Microsoft Defender for Office 365 中的篩選器不會對這些郵件採取任何動作。<sup>\*</sup>
...
- [適用于 Office 365 方案2之 Defender 中的威脅瀏覽器/即時偵測](threat-explorer.md)
