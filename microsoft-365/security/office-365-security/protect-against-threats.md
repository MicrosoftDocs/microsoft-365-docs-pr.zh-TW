...
Microsoft 365 包含各種威脅防護功能。 以下是一個快速入門手冊，您可以用來做為檢查清單，以確保為您的組織設定威脅防護功能。 如果您是 Office 365 中威脅防護功能的新功能，或您不確定開始的位置，請使用下列指南做為開始點。
...
若要深入瞭解，請參閱[安全性&amp;與合規性中心的許可權](permissions-in-the-security-and-compliance-center.md)。
