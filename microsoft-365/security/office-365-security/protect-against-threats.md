...
SharePoint、OneDrive 和小組等工作負載都是為了共同作業而建立的。 使用適用于 Office 的 Defender 365 可協助封鎖和偵測在小組網站和文件庫中識別為惡意的檔案。 您可以在 [這裡](https://docs.microsoft.com/microsoft-365/security/office-365-security/atp-for-spo-odb-and-teams)進一步閱讀該功能的詳細資訊。
