...
- 如需 Exchange Online 中郵件流程規則的相關資訊，請參閱 [mail flow rules (transport rules) In Exchange online](https://docs.microsoft.com/Exchange/security-and-compliance/mail-flow-rules/mail-flow-rules)
