...
- 永遠將 misclassified 郵件提交給 Microsoft。 系統管理員可以使用[提交的 Explorer 瀏覽器](admin-submission.md)，或使用者可以使用 [[使用報告訊息] 增益集](https://support.office.com/article/b5caa9f1-cdf3-4443-af8c-ff724ea719d2)來報告訊息。
