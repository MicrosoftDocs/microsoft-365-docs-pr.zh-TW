...
- **驗證您的組織設定**：留意允許郵件略過垃圾郵件篩選的設定 (例如，如果您將自己的網域新增至反垃圾郵件原則) 中的允許網域清單。 如需建議的設定，請參閱 [EOP 和 Office 365 ATP security 的建議設定](recommended-settings-for-eop-and-office365-atp.md) ，並 [建立安全的寄件者清單](create-safe-sender-lists-in-office-365.md)。
