...
- 在 Outlook 網頁版中，圖示如下所示：
  ...
  > [!div class="mx-imgBorder"]
  > ![web 報表郵件增益集圖示上的 Outlook](../../media/owa-report-message-icon.png)
...
1. 在 Microsoft 365 系統管理中心，移至 [前往 **設定** \> **增益集**] 頁面 <https://admin.microsoft.com/AdminPortal/Home#/Settings/AddIns> 。 如果您看不到 [**增益集**] 頁面，請移至 [整合式應用程式] 頁面頂端的 [**設定** \> **整合式應用程式** \> **增益集**] 連結。 
