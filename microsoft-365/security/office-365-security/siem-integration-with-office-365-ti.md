...
Office 365 活動管理 API 會從您組織的 Microsoft 365 和 Azure Active Directory 活動記錄檔中，檢索使用者、系統管理員、系統及原則動作和事件的相關資訊。 如果貴組織的 microsoft defender Office 365 方案1或2，或是 Office 365 E5，您可以使用[microsoft defender 來 Office 365 架構](/office/office-365-management-api/office-365-management-activity-api-schema#office-365-advanced-threat-protection-and-threat-investigation-and-response-schema)。
...
|41|ThreatIntelligenceUrl|保管庫從 Microsoft Defender 針對 Office 365 連結區塊時間與封鎖覆寫事件。|
...
> [!IMPORTANT]
> 您必須是全域系統管理員或已在 Microsoft 365 Defender 入口網站中指派安全性系統管理員角色，才能設定 Office 365 的 Microsoft Defender 整合 SIEM。 如需詳細資訊，請參閱 [Microsoft 365 Defender 入口網站中的權限](permissions-microsoft-365-security-center.md)。
>
