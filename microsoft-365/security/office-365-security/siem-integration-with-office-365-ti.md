...
如果您的組織使用安全性事件和事件管理 (SIEM) server，您可以將 Office 365 的高級威脅防護與 SIEM 伺服器整合。 SIEM 整合可讓您在 SIEM 伺服器報告中查看 Office 365 Advanced Protection 偵測到的惡意程式碼或網路釣魚資訊（例如惡意程式碼或網路釣魚）。 若要設定 SIEM 整合，您可以使用[Office 365 活動管理 API](https://docs.microsoft.com/office/office-365-management-api/office-365-management-activity-api-reference)。
...
[安全性與 &amp; 合規性中心的智慧報告和洞察力](reports-and-insights-in-security-and-compliance.md)
