...
---
# <a name="configure-global-settings-for-safe-links-in-office-365-atp"></a>針對 Office 365 ATP 中的安全連結設定全域設定
...
您可以在安全連結原則中設定大多數的安全連結設定。 如需相關指示，請參閱 [設定 Office 365 ATP 中的安全連結原則](set-up-atp-safe-links-policies.md)。
...
您可以使用 Exchange Online 中的信箱，在 Security & 合規性中心或 PowerShell (Exchange Online PowerShell 中設定全域安全連結設定，以取得適用的 Microsoft 365 組織。獨立 EOP PowerShell 適用于沒有 Exchange Online 信箱的組織，但使用 Office 365 ATP 附加元件訂閱) 。

## <a name="what-do-you-need-to-know-before-you-begin"></a>開始之前有哪些須知？

- 安全連結的全域設定所提供的功能僅適用于包含在使用中安全連結原則中的使用者。 沒有內建或預設的安全連結原則，因此您必須建立至少一個安全連結原則，這些全域設定才會作用。 如需相關指示，請參閱 [設定 Office 365 ATP 中的安全連結原則](set-up-atp-safe-links-policies.md)。
