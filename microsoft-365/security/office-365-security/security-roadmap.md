...
|身分識別和存取管理|<ul><li>[啟用 Azure Active Directory Identity Protection](https://docs.microsoft.com/azure/active-directory/active-directory-identityprotection-enable)。</li><li>針對同盟身分識別環境，強制執行帳戶安全性 (密碼長度、年齡、複雜度等 ) 。</li></ul>|
...
|身分識別和存取管理|<ul><li>調整原則及工作處理程式。</li><li>使用 Azure AD Identity Protection 來識別內幕威脅。</li></ul>|
