...
4. 若要篩選結果，請按一下 [篩選]****。 可用的篩選條件如下：
   ...
   - **隔離原因**：
     ...
     - **大量郵件**
     - **網路釣魚**：垃圾郵件篩選判定為 **網路釣魚電子郵件** 或反網路釣魚防護隔離郵件 ([欺騙設定](set-up-anti-phishing-policies.md#spoof-settings) 或 [模仿保護](set-up-anti-phishing-policies.md#impersonation-settings-in-atp-anti-phishing-policies)) 。
     - **惡意程式碼**
     - **垃圾郵件**
     - **高信賴網路釣魚**
