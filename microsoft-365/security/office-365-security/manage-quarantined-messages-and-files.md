...
當您在清單中選取一封電子郵件時，會出現下列 [詳細資料] 浮出項目中的訊息詳細資料：
...
選取郵件後，您可以使用多個選項來處理 [詳細資料] 快顯視窗中的訊息：

- **發行訊息**：在出現的浮出控制項中，選擇下列選項：
...
當您在清單中選取多個隔離郵件 (最多 100) 時，會出現 [ **大量動作** ] 快顯視窗，您可以採取下列動作：
...
當您選取清單中的檔案時，會在開啟的 [詳細資料] 浮出控制項中使用下列檔案詳細資料：
...
當您選取清單中的檔案時，您可以對 [詳細資料] 快顯視窗中的檔案採取下列動作：
...
當您在清單中選取多個隔離的檔案 (直到 100) 時，會出現 [ **大量動作** ] 快顯視窗，您可以採取下列動作：
