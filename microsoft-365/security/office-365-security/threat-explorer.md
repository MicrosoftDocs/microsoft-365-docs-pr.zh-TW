...
<span data-ttu-id="0b5ca-116">您可以使用此報告：</span><span class="sxs-lookup"><span data-stu-id="0b5ca-116">With this report, you can:</span></span>
...
### <a name="tags-in-threat-explorer"></a><span data-ttu-id="0b5ca-135">威脅瀏覽器中的標記</span><span class="sxs-lookup"><span data-stu-id="0b5ca-135">Tags in Threat Explorer</span></span>
...
<span data-ttu-id="0b5ca-146">您可以使用標記做為篩選。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-146">You can use tags as a filter.</span></span> <span data-ttu-id="0b5ca-147">只需在優先順序帳戶或特定使用者標記案例中尋找。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-147">Hunt just across priority accounts or specific user tags scenarios.</span></span> <span data-ttu-id="0b5ca-148">您也可以排除包含某些標記的結果。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-148">You can also exclude results that have certain tags.</span></span> <span data-ttu-id="0b5ca-149">將此功能與其他篩選器結合，以縮小您的調查範圍。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-149">Combine this functionality with other filters to narrow your scope of investigation.</span></span>

<span data-ttu-id="0b5ca-150">[![篩選標記](../../media/tags-filter-normal.png)](../../media/tags-filter-normal.png#lightbox)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-150">[![Filter tags](../../media/tags-filter-normal.png)](../../media/tags-filter-normal.png#lightbox)</span></span>

> [!div class="mx-imgBorder"]
> <span data-ttu-id="0b5ca-151">![不篩選標記](../../media/tags-filter-not.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-151">![Not filter tags](../../media/tags-filter-not.png)</span></span>

#### <a name="email-detail-flyout"></a><span data-ttu-id="0b5ca-152">電子郵件詳細資料快顯視窗</span><span class="sxs-lookup"><span data-stu-id="0b5ca-152">Email detail flyout</span></span>
...
- <span data-ttu-id="0b5ca-227">組織原則允許：組織的安全小組設定原則或 Exchange 郵件流程規則 (也稱為傳輸規則) ，可允許寄件者和網域的組織中的使用者。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-227">Allowed by org policy: The organization's security teams set policies or Exchange mail flow rules (also known as transport rules) to allow senders and domains for users in their organization.</span></span> <span data-ttu-id="0b5ca-228">這可供一組使用者或整個組織使用。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-228">This can be for a set of users or the entire organization.</span></span>
...
> [!div class="mx-imgBorder"]
> <span data-ttu-id="0b5ca-235">![瀏覽器中的系統覆寫格線](../../media/System_Overrides_Grid.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-235">![System Overrides Grid in Explorer](../../media/System_Overrides_Grid.png)</span></span>

### <a name="improvements-for-the-url-and-clicks-experience"></a><span data-ttu-id="0b5ca-236">URL 及點擊體驗的增強功能</span><span class="sxs-lookup"><span data-stu-id="0b5ca-236">Improvements for the URL and clicks experience</span></span>

<span data-ttu-id="0b5ca-237">改進功能包括：</span><span class="sxs-lookup"><span data-stu-id="0b5ca-237">The improvements include:</span></span>

- <span data-ttu-id="0b5ca-238">顯示已完全按一下的 URL (包括 url 任何部分之 URL 的任何查詢參數) 在 URL 快顯視窗的 [ **點擊** ] 區段中。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-238">Show the full clicked URL (including any query parameters that are part of the URL) in the **Clicks** section of the URL flyout.</span></span> <span data-ttu-id="0b5ca-239">目前，URL 網域和路徑會出現在標題列中。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-239">Currently, the URL domain and path appear in the title bar.</span></span> <span data-ttu-id="0b5ca-240">我們正在擴充該資訊以顯示完整的 URL。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-240">We're extending that information to show the full URL.</span></span>

- <span data-ttu-id="0b5ca-241">跨 URL 篩選器的修正 (*url* 與 *url 網域* *，以及 url 網域和路徑*) ：更新會影響包含 URL/按一下判定之郵件的搜尋。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-241">Fixes across URL filters (*URL* versus *URL domain* versus *URL domain and path*): The updates affect searching for messages that contain a URL/click verdict.</span></span> <span data-ttu-id="0b5ca-242">我們為通訊協定不可知的搜尋啟用支援，因此您可以在不使用的情況下搜尋 URL `http` 。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-242">We enabled support for protocol-agnostic searches, so you can search for a URL without using `http`.</span></span> <span data-ttu-id="0b5ca-243">根據預設，URL 搜尋會對應至 HTTP，除非明確指定另一個值。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-243">By default, the URL search maps to http, unless another value is explicitly specified.</span></span> <span data-ttu-id="0b5ca-244">例如：</span><span class="sxs-lookup"><span data-stu-id="0b5ca-244">For example:</span></span>
  - <span data-ttu-id="0b5ca-245">`http://`在 [ **url**]、[ **url 網域**] 及 [ **url 網域] 和 [路徑** 篩選] 欄位中，使用或不使用前置詞進行搜尋。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-245">Search with and without the `http://` prefix in the **URL**, **URL Domain**, and **URL Domain and Path** filter fields.</span></span> <span data-ttu-id="0b5ca-246">搜尋應該會顯示相同的結果。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-246">The searches should show the same results.</span></span>
  - <span data-ttu-id="0b5ca-247">`https://`在 **URL** 中搜尋前置詞。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-247">Search for the `https://` prefix in **URL**.</span></span> <span data-ttu-id="0b5ca-248">若未指定任何值，則 `http://` 會假設首碼。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-248">When no value is specified, the `http://` prefix is assumed.</span></span>
...
### <a name="timezone-improvements"></a><span data-ttu-id="0b5ca-273">時區改進</span><span class="sxs-lookup"><span data-stu-id="0b5ca-273">Timezone improvements</span></span>
...
### <a name="chart-drilldown-to-add-to-filters"></a><span data-ttu-id="0b5ca-286">新增至篩選的圖表深入分析</span><span class="sxs-lookup"><span data-stu-id="0b5ca-286">Chart drilldown to add to filters</span></span>
...
## <a name="extended-capabilities-in-threat-explorer"></a><span data-ttu-id="0b5ca-294">威脅瀏覽器中的延伸功能</span><span class="sxs-lookup"><span data-stu-id="0b5ca-294">Extended capabilities in Threat Explorer</span></span>
...
### <a name="exchange-transport-rules"></a><span data-ttu-id="0b5ca-303">Exchange 傳輸規則</span><span class="sxs-lookup"><span data-stu-id="0b5ca-303">Exchange transport rules</span></span>
...
>
> > [!div class="mx-imgBorder"]
> > <span data-ttu-id="0b5ca-323">![Exchange 傳輸規則](../../media/ETR_Details.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-323">![Exchange Transport Rules](../../media/ETR_Details.png)</span></span>
...
> [!div class="mx-imgBorder"]
> <span data-ttu-id="0b5ca-330">![連接器詳細資料](../../media/Connector_Details.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-330">![Connector details](../../media/Connector_Details.png)</span></span>
...
<span data-ttu-id="0b5ca-340">若要查看網路釣魚郵件和搜尋模擬的使用者或網域，請使用瀏覽器的 [電子郵件 > 網路釣魚視圖](threat-explorer-views.md) 。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-340">To review phish messages and search for impersonated users or domains, use the [Email > Phish view](threat-explorer-views.md) of Explorer.</span></span>
...
> [!TIP]
> <span data-ttu-id="0b5ca-413">當您使用瀏覽器或關聯的協力廠商工具來搜尋識別碼時，網路郵件識別碼會對應按一下 [回復至特定郵件]。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-413">The Network Message ID maps the click back to specific mails when you search on the ID through Explorer or associated third-party tools.</span></span> <span data-ttu-id="0b5ca-414">這類搜尋會識別與按一下結果關聯的電子郵件。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-414">Such searches identify the email associated with a click result.</span></span> <span data-ttu-id="0b5ca-415">讓相關網路郵件識別碼能夠更快速且更強大的分析。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-415">Having the correlated Network Message ID makes for quicker and more powerful analysis.</span></span>

> [!div class="mx-imgBorder"]
> <span data-ttu-id="0b5ca-416">![瀏覽器中的按一下 tab 鍵](../../media/tp_ExportClickResultAndNetworkID.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-416">![Clicks tab in Explorer](../../media/tp_ExportClickResultAndNetworkID.png)</span></span>

## <a name="see-malware-detected-in-email-by-technology"></a><span data-ttu-id="0b5ca-417">查看透過技術在電子郵件中偵測到的惡意程式碼</span><span class="sxs-lookup"><span data-stu-id="0b5ca-417">See malware detected in email by technology</span></span>

<span data-ttu-id="0b5ca-418">假設您想要查看透過 Microsoft 365 技術排序的電子郵件中偵測到惡意程式碼。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-418">Suppose you want to see malware detected in email sorted by Microsoft 365 technology.</span></span> <span data-ttu-id="0b5ca-419">若要這麼做，請使用瀏覽器的 [電子郵件 > 惡意](threat-explorer-views.md#email--malware) 代碼視圖 (或即時偵測) 。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-419">To do this, use the [Email > Malware](threat-explorer-views.md#email--malware) view of Explorer (or Real-time detections).</span></span>

1. <span data-ttu-id="0b5ca-420">在安全性與合規性中心 (<https://protection.office.com>) 選擇 **[威脅管理]** \> **[總管]** (或 **[即時偵測]**)。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-420">In the Security & Compliance Center (<https://protection.office.com>), choose **Threat management** \> **Explorer** (or **Real-time detections**).</span></span> <span data-ttu-id="0b5ca-421">(此範例使用總管。)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-421">(This example uses Explorer.)</span></span>

2. <span data-ttu-id="0b5ca-422">在 [ **視圖** ] 功能表中，選擇 [ **電子郵件** \> **惡意** 代碼]。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-422">In the **View** menu, choose **Email** \> **Malware**.</span></span>

   > [!div class="mx-imgBorder"]
   > <span data-ttu-id="0b5ca-423">![總管的檢視功能表](../../media/ExplorerViewEmailMalwareMenu.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-423">![View menu for Explorer](../../media/ExplorerViewEmailMalwareMenu.png)</span></span>

3. <span data-ttu-id="0b5ca-424">按一下 [ **寄件者**]，然後選擇 [ **基本** \> **偵測技術**]。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-424">Click **Sender**, and then choose **Basic** \> **Detection technology**.</span></span>

   <span data-ttu-id="0b5ca-425">您的偵測技術現在可做為報告的篩選器。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-425">Your detection technologies are now available as filters for the report.</span></span>

   > [!div class="mx-imgBorder"]
   > <span data-ttu-id="0b5ca-426">![惡意程式碼偵測技術](../../media/ExplorerEmailMalwareDetectionTech.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-426">![Malware detection technologies](../../media/ExplorerEmailMalwareDetectionTech.png)</span></span>

4. <span data-ttu-id="0b5ca-427">選擇 [選項]。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-427">Choose an option.</span></span> <span data-ttu-id="0b5ca-428">然後選取 [重新整理] **按鈕，套用** 該篩選。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-428">Then select the **Refresh** button to apply that filter.</span></span>

   > [!div class="mx-imgBorder"]
   > <span data-ttu-id="0b5ca-429">![選取的偵測技術](../../media/ExplorerEmailMalwareDetectionTechATP.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-429">![Selected detection technology](../../media/ExplorerEmailMalwareDetectionTechATP.png)</span></span>

<span data-ttu-id="0b5ca-430">報告會進行重新整理，以顯示惡意程式碼在電子郵件中偵測到的結果，並使用您選取的技術選項。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-430">The report refreshes to show the results that malware detected in email, using the technology option you selected.</span></span> <span data-ttu-id="0b5ca-431">您可以從這裡進行進一步分析。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-431">From here, you can conduct further analysis.</span></span>

## <a name="view-phishing-url-and-click-verdict-data"></a><span data-ttu-id="0b5ca-432">查看網路釣魚 URL，然後按一下 [已判定資料]</span><span class="sxs-lookup"><span data-stu-id="0b5ca-432">View phishing URL and click verdict data</span></span>

<span data-ttu-id="0b5ca-433">假設您想要查看透過電子郵件中的 URL 進行的網路釣魚攻擊，包括允許、封鎖及覆寫的 URL 清單。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-433">Suppose that you want to see phishing attempts through URLs in email, including a list of URLs that were allowed, blocked, and overridden.</span></span> <span data-ttu-id="0b5ca-434">若要識別所按一下的 URLs，必須設定 [安全連結](safe-links.md) 。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-434">To identify URLs that were clicked, [Safe Links](safe-links.md) must be configured.</span></span> <span data-ttu-id="0b5ca-435">請確定您已設定 [安全連結原則](set-up-safe-links-policies.md) 的 [保護] 和 [記錄] 按一下 [安全連結] 中的 [verdicts]。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-435">Make sure that you set up [Safe Links policies](set-up-safe-links-policies.md) for time-of-click protection and logging of click verdicts by Safe Links.</span></span>

<span data-ttu-id="0b5ca-436">若要查看郵件中的網路釣魚 URLs，並按一下網路釣魚郵件中 URLs，請使用瀏覽器或即時偵測的 [**電子郵件**  >  **網路釣魚**](threat-explorer-views.md#email--phish)視圖。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-436">To review phish URLs in messages and clicks on URLs in phish messages, use the [**Email** > **Phish**](threat-explorer-views.md#email--phish) view of Explorer or Real-time detections.</span></span>

1. <span data-ttu-id="0b5ca-437">在安全性與合規性中心 (<https://protection.office.com>) 選擇 **[威脅管理]** \> **[總管]** (或 **[即時偵測]**)。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-437">In the Security & Compliance Center (<https://protection.office.com>), choose **Threat management** \> **Explorer** (or **Real-time detections**).</span></span> <span data-ttu-id="0b5ca-438">(此範例使用總管。)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-438">(This example uses Explorer.)</span></span>

2. <span data-ttu-id="0b5ca-439">在 [ **視圖** ] 功能表中，選擇 [ **電子郵件** \> **釣魚網絡**]。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-439">In the **View** menu, choose **Email** \> **Phish**.</span></span>

   > [!div class="mx-imgBorder"]
   > <span data-ttu-id="0b5ca-440">![網路釣魚內容中瀏覽器的視圖功能表](../../media/ExplorerViewEmailPhishMenu.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-440">![View menu for Explorer in phishing context](../../media/ExplorerViewEmailPhishMenu.png)</span></span>

3. <span data-ttu-id="0b5ca-441">按一下 [ **寄件者**]，然後選擇 **URLs** \> **按一下 [判定**]。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-441">Click **Sender**, and then choose **URLs** \> **Click verdict**.</span></span>

4. <span data-ttu-id="0b5ca-442">選取一個或多個選項（例如 **封鎖** 和 **封鎖**），然後在與套用該篩選的選項相同的列上選取 [重新整理 **] 按鈕。**</span><span class="sxs-lookup"><span data-stu-id="0b5ca-442">Select one or more options, such as **Blocked** and **Block overridden**, and then select the **Refresh** button on the same line as the options to apply that filter.</span></span> <span data-ttu-id="0b5ca-443">(請勿重新整理瀏覽器視窗。)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-443">(Don't refresh your browser window.)</span></span>

   > [!div class="mx-imgBorder"]
   > <span data-ttu-id="0b5ca-444">![URL 和按一下結果](../../media/ThreatExplorerEmailPhishClickVerdictOptions.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-444">![URLs and click verdicts](../../media/ThreatExplorerEmailPhishClickVerdictOptions.png)</span></span>

   <span data-ttu-id="0b5ca-445">報告會重新整理以在報告下的 [URL] 索引標籤上顯示兩個不同的 URL 表格：</span><span class="sxs-lookup"><span data-stu-id="0b5ca-445">The report refreshes to show two different URL tables on the URL tab under the report:</span></span>

   - <span data-ttu-id="0b5ca-446">**Top URLs** 是您篩選的郵件中 URLs，以及每個 URL 的電子郵件傳遞動作計數。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-446">**Top URLs** are the URLs in the messages that you filtered down to and the email delivery action counts for each URL.</span></span> <span data-ttu-id="0b5ca-447">在網路釣魚電子郵件視圖中，此清單通常包含合法的 URLs。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-447">In the Phish email view, this list typically contains legitimate URLs.</span></span> <span data-ttu-id="0b5ca-448">攻擊者會在其郵件中混合使用良好和不良的 URLs，以嘗試傳遞，但它們會使惡意連結看起來更有趣。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-448">Attackers include a mix of good and bad URLs in their messages to try to get them delivered, but they make the malicious links look more interesting.</span></span> <span data-ttu-id="0b5ca-449">URLs 的表格依總的電子郵件總數排序，但是此欄位是隱藏的，以簡化視圖。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-449">The table of URLs is sorted by total email count, but this column is hidden to simplify the view.</span></span>

   - <span data-ttu-id="0b5ca-450">**上** 指按一下的安全連結-包裝 URLs，依總按一下計數排序。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-450">**Top clicks** are the Safe Links-wrapped URLs that were clicked, sorted by total click count.</span></span> <span data-ttu-id="0b5ca-451">此欄位也不會顯示，以簡化視圖。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-451">This column also isn't displayed, to simplify the view.</span></span> <span data-ttu-id="0b5ca-452">依資料行的總計數表示每個點擊過的 URL 的安全連結按一下結果計數。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-452">Total counts by column indicate the Safe Links click verdict count for each clicked URL.</span></span> <span data-ttu-id="0b5ca-453">在網路釣魚電子郵件視圖中，這些通常是可疑或惡意的 URLs。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-453">In the Phish email view, these are usually suspicious or malicious URLs.</span></span> <span data-ttu-id="0b5ca-454">不過，此視圖可以包含不是威脅的 URLs，但位於網路釣魚郵件中。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-454">But the view could include URLs that aren't threats but are in phish messages.</span></span> <span data-ttu-id="0b5ca-455">在這裡未顯示 URL 按一下已開啟的連結。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-455">URL clicks on unwrapped links don't show up here.</span></span>

   <span data-ttu-id="0b5ca-456">這兩個 URL 表格會依照傳送動作和位置，顯示網路釣魚電子郵件中的最上層 URLs。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-456">The two URL tables show top URLs in phishing email messages by delivery action and location.</span></span> <span data-ttu-id="0b5ca-457">[！注意] 表格會顯示因警告而封鎖或訪問的 URL 按一下，因此您可以看到使用者的潛在不良連結，以及使用者已按一下的連結。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-457">The tables show URL clicks that were blocked or visited despite a warning, so you can see what potential bad links were presented to users and that the user's clicked.</span></span> <span data-ttu-id="0b5ca-458">您可以從這裡進行進一步分析。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-458">From here, you can conduct further analysis.</span></span> <span data-ttu-id="0b5ca-459">例如，在圖表下方，您可以在組織環境中所封鎖的電子郵件訊息中看到最上層 URLs。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-459">For example, below the chart you can see the top URLs in email messages that were blocked in your organization's environment.</span></span>

   > [!div class="mx-imgBorder"]
   > <span data-ttu-id="0b5ca-460">![已封鎖的總管 URL](../../media/ExplorerPhishClickVerdictURLs.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-460">![Explorer URLs that were blocked](../../media/ExplorerPhishClickVerdictURLs.png)</span></span>

   <span data-ttu-id="0b5ca-461">選取 URL 以檢視更多詳細資訊。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-461">Select a URL to view more detailed information.</span></span>

   > [!NOTE]
   > <span data-ttu-id="0b5ca-462">在 [URL 飛入] 對話方塊中，會移除電子郵件上的篩選，以顯示您環境中 URL 公開的完整視圖。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-462">In the URL flyout dialog box, the filtering on email messages is removed to show the full view of the URL's exposure in your environment.</span></span> <span data-ttu-id="0b5ca-463">這可讓您在瀏覽器中篩選您關心的電子郵件訊息，找出潛在威脅的特定 URLs，然後透過 [URL 詳細資料] 對話方塊，展開您環境中的 URL 公開知識 () 而不必將 URL 篩選器新增至瀏覽器視圖本身。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-463">This lets you filter for email messages you're concerned about in Explorer, find specific URLs that are potential threats, and then expand your understanding of the URL exposure in your environment (via the URL details dialog box) without having to add URL filters to the Explorer view itself.</span></span>

### <a name="interpretation-of-click-verdicts"></a><span data-ttu-id="0b5ca-464">按一下 verdicts 的轉譯</span><span class="sxs-lookup"><span data-stu-id="0b5ca-464">Interpretation of click verdicts</span></span>

<span data-ttu-id="0b5ca-465">在電子郵件或 URL flyouts 中，按一下上方和篩選體驗內，您會看到不同的按一下判定值：</span><span class="sxs-lookup"><span data-stu-id="0b5ca-465">Within the Email or URL flyouts, Top Clicks as well as within our filtering experiences, you'll see different click verdict values:</span></span>

- <span data-ttu-id="0b5ca-466">**無：** 無法捕獲 URL 的判定。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-466">**None:** Unable to capture the verdict for the URL.</span></span> <span data-ttu-id="0b5ca-467">使用者可能已按一下透過 URL。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-467">The user might have clicked through the URL.</span></span>
- <span data-ttu-id="0b5ca-468">**允許：** 允許使用者流覽至 URL。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-468">**Allowed:** The user was allowed to navigate to the URL.</span></span>
- <span data-ttu-id="0b5ca-469">**封鎖：** 已封鎖使用者流覽至 URL。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-469">**Blocked:** The user was blocked from navigating to the URL.</span></span>
- <span data-ttu-id="0b5ca-470">**擱置的判定：** 使用者呈現在引爆擱置的頁面上。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-470">**Pending verdict:** The user was presented with the detonation-pending page.</span></span>
- <span data-ttu-id="0b5ca-471">**封鎖已被取代：** 封鎖使用者直接流覽至 URL。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-471">**Blocked overridden:** The user was blocked from navigating directly to the URL.</span></span> <span data-ttu-id="0b5ca-472">但使用者 overrode 區塊以流覽至 URL。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-472">But the user overrode the block to navigate to the URL.</span></span>
- <span data-ttu-id="0b5ca-473">**擱置的判定略過：** 使用者呈現的是 [引爆] 頁面。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-473">**Pending verdict bypassed:** The user was presented with the detonation page.</span></span> <span data-ttu-id="0b5ca-474">但使用者 overrode 郵件以存取 URL。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-474">But the user overrode the message to access the URL.</span></span>
- <span data-ttu-id="0b5ca-475">**錯誤：** 使用者呈現錯誤頁面，或捕獲判定結果時發生錯誤。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-475">**Error:** The user was presented with the error page, or an error occurred in capturing the verdict.</span></span>
- <span data-ttu-id="0b5ca-476">**失敗：** 捕獲判定時，發生未知的例外狀況。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-476">**Failure:** An unknown exception occurred while capturing the verdict.</span></span> <span data-ttu-id="0b5ca-477">使用者可能已按一下透過 URL。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-477">The user might have clicked through the URL.</span></span>

## <a name="review-email-messages-reported-by-users"></a><span data-ttu-id="0b5ca-478">檢閱使用者回報的電子郵件訊息</span><span class="sxs-lookup"><span data-stu-id="0b5ca-478">Review email messages reported by users</span></span>

<span data-ttu-id="0b5ca-479">假設您想要查看組織中的使用者已透過 [報告郵件增益集](enable-the-report-message-add-in.md)或 [報告網路釣魚增益集](enable-the-report-phish-add-in.md)舉報為 *垃圾* 郵件、*非垃圾* 郵件或 *網路釣魚* 的電子郵件訊息。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-479">Suppose that you want to see email messages that users in your organization reported as *Junk*, *Not Junk*, or *Phishing* through the [Report Message add-in](enable-the-report-message-add-in.md) or the [Report Phishing add-in](enable-the-report-phish-add-in.md).</span></span> <span data-ttu-id="0b5ca-480">若要查看，請使用瀏覽器的 [**電子郵件**  >  **提交**](threat-explorer-views.md#email--submissions)視圖 (或即時偵測) 。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-480">To see them, use the [**Email** > **Submissions**](threat-explorer-views.md#email--submissions) view of Explorer (or Real-time detections).</span></span>

1. <span data-ttu-id="0b5ca-481">在安全性與合規性中心 (<https://protection.office.com>) 選擇 **[威脅管理]** \> **[總管]** (或 **[即時偵測]**)。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-481">In the Security & Compliance Center (<https://protection.office.com>), choose **Threat management** \> **Explorer** (or **Real-time detections**).</span></span> <span data-ttu-id="0b5ca-482">(此範例使用總管。)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-482">(This example uses Explorer.)</span></span>

2. <span data-ttu-id="0b5ca-483">在 [ **View** ] 功能表中，選擇 [ **電子郵件** \> **提交**]。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-483">In the **View** menu, choose **Email** \> **Submissions**.</span></span>

   > [!div class="mx-imgBorder"]
   > <span data-ttu-id="0b5ca-484">![電子郵件瀏覽器的視圖功能表](../../media/explorer-view-menu-email-user-reported.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-484">![View menu for Explorer for emails](../../media/explorer-view-menu-email-user-reported.png)</span></span>

3. <span data-ttu-id="0b5ca-485">按一下 [ **寄件者**]，然後選擇 [ **基本** \> **報表類型**]。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-485">Click **Sender**, and then choose **Basic** \> **Report type**.</span></span>

4. <span data-ttu-id="0b5ca-486">選取選項，**例如 [** **網路釣魚**]，然後選取 [重新整理] 按鈕。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-486">Select an option, such as **Phish**, and then select the **Refresh** button.</span></span>

   > [!div class="mx-imgBorder"]
   > <span data-ttu-id="0b5ca-487">![使用者回報的網路釣魚](../../media/EmailUserReportedReportType.png)</span><span class="sxs-lookup"><span data-stu-id="0b5ca-487">![User-reported phish](../../media/EmailUserReportedReportType.png)</span></span>

<span data-ttu-id="0b5ca-488">報告會重新整理以顯示組織中的人員報告為網路釣魚企圖的電子郵件相關資料。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-488">The report refreshes to show data about email messages that people in your organization reported as a phishing attempt.</span></span> <span data-ttu-id="0b5ca-489">您可以使用這項資訊進行進一步的分析，必要時，調整 [Microsoft Defender For Office 365 中的反網路釣魚原則](configure-atp-anti-phishing-policies.md)。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-489">You can use this information to conduct further analysis, and, if necessary, adjust your [anti-phishing policies in Microsoft Defender for Office 365](configure-atp-anti-phishing-policies.md).</span></span>

## <a name="start-automated-investigation-and-response"></a><span data-ttu-id="0b5ca-490">啟動自動調查及回應</span><span class="sxs-lookup"><span data-stu-id="0b5ca-490">Start automated investigation and response</span></span>

> [!NOTE]
> <span data-ttu-id="0b5ca-491">*Microsoft Defender For Office 365 方案 2* 和 *Office 365 E5* 中提供自動調查和回應功能。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-491">Automated investigation and response capabilities are available in *Microsoft Defender for Office 365 Plan 2* and *Office 365 E5*.</span></span>

<span data-ttu-id="0b5ca-492">[自動化調查和回應](automated-investigation-response-office.md) 可儲存您的安全性運作小組時間和精力，以調查及緩解 cyberattacks。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-492">[Automated investigation and response](automated-investigation-response-office.md) can save your security operations team time and effort spent investigating and mitigating cyberattacks.</span></span> <span data-ttu-id="0b5ca-493">除了設定會觸發安全性劇本的警示，您可以在總管中的檢視啟動自動化調查及回應程序。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-493">In addition to configuring alerts that can trigger a security playbook, you can start an automated investigation and response process from a view in Explorer.</span></span> <span data-ttu-id="0b5ca-494">如需詳細資訊，請參閱 [範例：安全性管理員會從瀏覽器觸發調查](automated-investigation-response-office.md#example-a-security-administrator-triggers-an-investigation-from-threat-explorer)。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-494">For details, see [Example: A security administrator triggers an investigation from Explorer](automated-investigation-response-office.md#example-a-security-administrator-triggers-an-investigation-from-threat-explorer).</span></span>

## <a name="more-ways-to-use-explorer-and-real-time-detections"></a><span data-ttu-id="0b5ca-495">更多使用 Explorer 和即時偵測的方式</span><span class="sxs-lookup"><span data-stu-id="0b5ca-495">More ways to use Explorer and Real-time detections</span></span>

<span data-ttu-id="0b5ca-496">除了本文所述的案例之外，您還可以使用更多報表選項，以供 Explorer (或即時偵測) 。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-496">In addition to the scenarios outlined in this article, you have many more reporting options available with Explorer (or Real-time detections).</span></span> <span data-ttu-id="0b5ca-497">請參閱下列文章：</span><span class="sxs-lookup"><span data-stu-id="0b5ca-497">See the following articles:</span></span>

- [<span data-ttu-id="0b5ca-498">尋找並調查傳送的惡意電子郵件</span><span class="sxs-lookup"><span data-stu-id="0b5ca-498">Find and investigate malicious email that was delivered</span></span>](investigate-malicious-email-that-was-delivered.md)
- [<span data-ttu-id="0b5ca-499">檢視在 SharePoint Online、OneDrive 和 Microsoft Teams 中偵測到的惡意檔案</span><span class="sxs-lookup"><span data-stu-id="0b5ca-499">View malicious files detected in SharePoint Online, OneDrive, and Microsoft Teams</span></span>](./mdo-for-spo-odb-and-teams.md)
- [<span data-ttu-id="0b5ca-500">取得威脅瀏覽器中的視圖 (和即時偵測的概覽) </span><span class="sxs-lookup"><span data-stu-id="0b5ca-500">Get an overview of the views in Threat Explorer (and Real-time detections)</span></span>](threat-explorer-views.md)
- [<span data-ttu-id="0b5ca-501">威脅防護狀態報告</span><span class="sxs-lookup"><span data-stu-id="0b5ca-501">Threat protection status report</span></span>](view-email-security-reports.md#threat-protection-status-report)
- [<span data-ttu-id="0b5ca-502">Microsoft 365 Defender 的自動化調查和回應</span><span class="sxs-lookup"><span data-stu-id="0b5ca-502">Automated investigation and response in Microsoft 365 Defender</span></span>](../defender/m365d-autoir.md)

## <a name="required-licenses-and-permissions"></a><span data-ttu-id="0b5ca-503">必要的授權和權限</span><span class="sxs-lookup"><span data-stu-id="0b5ca-503">Required licenses and permissions</span></span>

<span data-ttu-id="0b5ca-504">您必須擁有 [Microsoft Defender For Office 365](defender-for-office-365.md) ，才能使用 Explorer 或即時偵測。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-504">You must have [Microsoft Defender for Office 365](defender-for-office-365.md) to use Explorer or Real-time detections.</span></span>

- <span data-ttu-id="0b5ca-505">Explorer 會包含在 Office 365 的 Defender for Office 中方案2。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-505">Explorer is included in Defender for Office 365 Plan 2.</span></span>
- <span data-ttu-id="0b5ca-506">Office 365 方案1中包含即時偵測報告。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-506">The Real-time detections report is included in Defender for Office 365 Plan 1.</span></span>
- <span data-ttu-id="0b5ca-507">規劃為所有應受 Defender for Office 365 保護的使用者指派授權。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-507">Plan to assign licenses for all users who should be protected by Defender for Office 365.</span></span> <span data-ttu-id="0b5ca-508">瀏覽器和即時偵測顯示已授權使用者的偵測資料。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-508">Explorer and Real-time detections show detection data for licensed users.</span></span>

<span data-ttu-id="0b5ca-509">若要查看和使用 Explorer 或即時偵測，您必須具有適當的許可權，例如授與安全性管理員或安全性讀者的許可權。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-509">To view and use Explorer or Real-time detections, you must have appropriate permissions, such as those granted to a security administrator or security reader.</span></span>

- <span data-ttu-id="0b5ca-510">針對安全性 & 合規性中心，您必須已指派下列角色之一：</span><span class="sxs-lookup"><span data-stu-id="0b5ca-510">For the Security & Compliance Center, you must have one of the following roles assigned:</span></span>

  - <span data-ttu-id="0b5ca-511">組織管理</span><span class="sxs-lookup"><span data-stu-id="0b5ca-511">Organization Management</span></span>
  - <span data-ttu-id="0b5ca-512">安全性管理員 (可以在 Azure Active Directory 系統管理中心 (中指派 <https://aad.portal.azure.com>) </span><span class="sxs-lookup"><span data-stu-id="0b5ca-512">Security Administrator (this can be assigned in the Azure Active Directory admin center (<https://aad.portal.azure.com>)</span></span>
  - <span data-ttu-id="0b5ca-513">安全性讀取者</span><span class="sxs-lookup"><span data-stu-id="0b5ca-513">Security Reader</span></span>

- <span data-ttu-id="0b5ca-514">若為 Exchange Online，您必須在 Exchange 系統管理中心中指派下列其中一個角色 (<https://admin.protection.outlook.com/ecp/>) 或 [exchange Online PowerShell](/powershell/exchange/exchange-online-powershell)：</span><span class="sxs-lookup"><span data-stu-id="0b5ca-514">For Exchange Online, you must have one of the following roles assigned in either the Exchange admin center (<https://admin.protection.outlook.com/ecp/>) or [Exchange Online PowerShell](/powershell/exchange/exchange-online-powershell):</span></span>

  - <span data-ttu-id="0b5ca-515">組織管理</span><span class="sxs-lookup"><span data-stu-id="0b5ca-515">Organization Management</span></span>
  - <span data-ttu-id="0b5ca-516">僅限檢視組織管理</span><span class="sxs-lookup"><span data-stu-id="0b5ca-516">View-Only Organization Management</span></span>
  - <span data-ttu-id="0b5ca-517">僅限檢視收件者</span><span class="sxs-lookup"><span data-stu-id="0b5ca-517">View-Only Recipients</span></span>
  - <span data-ttu-id="0b5ca-518">合規性管理</span><span class="sxs-lookup"><span data-stu-id="0b5ca-518">Compliance Management</span></span>

<span data-ttu-id="0b5ca-519">若要深入了解角色和權限，請參閱下列資源：</span><span class="sxs-lookup"><span data-stu-id="0b5ca-519">To learn more about roles and permissions, see the following resources:</span></span>

- [<span data-ttu-id="0b5ca-520">安全性與合規性中心的權限</span><span class="sxs-lookup"><span data-stu-id="0b5ca-520">Permissions in the Security & Compliance Center</span></span>](permissions-in-the-security-and-compliance-center.md)
- [<span data-ttu-id="0b5ca-521">Exchange Online 中的功能權限</span><span class="sxs-lookup"><span data-stu-id="0b5ca-521">Feature permissions in Exchange Online</span></span>](/exchange/permissions-exo/feature-permissions)

## <a name="differences-between-threat-explorer-and-real-time-detections"></a><span data-ttu-id="0b5ca-522">威脅瀏覽器與即時偵測的差異</span><span class="sxs-lookup"><span data-stu-id="0b5ca-522">Differences between Threat Explorer and Real-time detections</span></span>

- <span data-ttu-id="0b5ca-523">您可以在 Office 365 的 Defender for Office 方案1中取得 *即時* 偵測報告。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-523">The *Real-time detections* report is available in Defender for Office 365 Plan 1.</span></span> <span data-ttu-id="0b5ca-524">*威脅瀏覽器* 適用于 Office 365 方案2的 Defender。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-524">*Threat Explorer* is available in Defender for Office 365 Plan 2.</span></span>
- <span data-ttu-id="0b5ca-525">即時偵測報告可讓您即時查看偵測。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-525">The Real-time detections report allows you to view detections in real time.</span></span> <span data-ttu-id="0b5ca-526">威脅瀏覽器也會這麼做，但也會提供特定攻擊的其他詳細資料。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-526">Threat Explorer does this as well, but it also provides additional details for a given attack.</span></span>
- <span data-ttu-id="0b5ca-527">*所有的電子郵件* view 都可用於威脅瀏覽器，但不會出現在即時偵測報告中。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-527">An *All email* view is available in Threat Explorer but not in the Real-time detections report.</span></span>
- <span data-ttu-id="0b5ca-528">威脅瀏覽器中包含更多篩選功能和可用的動作。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-528">More filtering capabilities and available actions are included in Threat Explorer.</span></span> <span data-ttu-id="0b5ca-529">如需詳細資訊，請參閱 [Microsoft defender For office 365 服務說明：每個 Defender For office 365 方案中可用的功能](/office365/servicedescriptions/office-365-advanced-threat-protection-service-description#feature-availability-across-advanced-threat-protection-atp-plans)。</span><span class="sxs-lookup"><span data-stu-id="0b5ca-529">For more information, see [Microsoft Defender for Office 365 Service Description: Feature availability across Defender for Office 365 plans](/office365/servicedescriptions/office-365-advanced-threat-protection-service-description#feature-availability-across-advanced-threat-protection-atp-plans).</span></span>

## <a name="other-articles"></a><span data-ttu-id="0b5ca-530">其他文章</span><span class="sxs-lookup"><span data-stu-id="0b5ca-530">Other articles</span></span>

[<span data-ttu-id="0b5ca-531">使用電子郵件實體頁面調查電子郵件</span><span class="sxs-lookup"><span data-stu-id="0b5ca-531">Investigate emails with the Email Entity Page</span></span>](mdo-email-entity-page.md)
