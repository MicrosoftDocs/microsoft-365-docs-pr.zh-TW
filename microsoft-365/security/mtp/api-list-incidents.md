...
需要有下列其中一個許可權才能呼叫此 API。 若要深入瞭解，包括如何選擇許可權，請參閱 [Access Microsoft 威脅防護 APIs](api-access.md)
...
| serviceSource                             | 警示產生來源的服務，例如 Microsoft Defender ATP、Microsoft Cloud App Security、Azure ATP 或 Office 365 ATP。                                                                                                                                                                                                                                                                     | MicrosoftCloudAppSecurity                                                                                                                                                                                                                         |
