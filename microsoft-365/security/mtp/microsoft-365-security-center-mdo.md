...
[適用於 Office 365 的 Microsoft Defender 文章](../office-365-security/office-365-atp.md)的[快速入門](../office-365-security/office-365-atp.md#getting-started)小節包含的邏輯早期設定區塊，看起來像這樣：
...
- [自訂偵測規則](/windows/security/threat-protection/microsoft-defender-atp/custom-detection-rules)
