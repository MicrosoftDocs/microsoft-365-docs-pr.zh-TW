...
您目前在設定階段。 請先開始存取 Microsoft 365 的安全性中心，然後安裝您的試用實驗室環境。
...
![影像 of_page](../../media/mtp-eval-9.png) <br>
  
2. 輸入您的電子郵件地址（個人或公司）以完成試用註冊。 按一下 [**設定帳戶**]。
![影像 of_page](../../media/mtp-eval-10.png) <br> 
...
![影像 of_page](../../media/mtp-eval-12.png) <br>

5. 為您的租使用者設定自訂的功能變數名稱，然後按 **[下一步]**。
<br>![影像 of_page](../../media/mtp-eval-13.png) <br>
 
6. 設定將成為租使用者之全域管理員的第一個身分識別。 填入**名稱**和**密碼**。 按一下 [**註冊**]。
![影像 of_page](../../media/mtp-eval-14.png) <br>
c
7. 按一下 [**移至設定**] 以完成 Office 365 E5 試用租使用者布建。
<br>![影像 of_page](../../media/mtp-eval-15.png) <br>

8. 將公司網域連線到 Office 365 租使用者。 選選擇 **[連線您已擁有的網域]** ，然後輸入您的功能變數名稱。 按 [下一步]****。
<br>![影像 of_page](../../media/mtp-eval-16.png) <br>
 
9. 您將需要新增 TXT 或 MX 記錄以驗證網域擁有權。 將 TXT 或 MX 記錄新增至您的網域後，請選取 [**驗證**]。
<br>![影像 of_page](../../media/mtp-eval-17.png) <br>
 
10. 選為您的租使用者建立更多使用者帳戶。 您可以按 **[下一步]** 略過此步驟。
![影像 of_page](../../media/mtp-eval-18.png) <br>
 
11. 選下載 Office 應用程式。 按 **[下一步]** 略過此步驟。 
<br>![影像 of_page](../../media/mtp-eval-19.png) <br>

12. 選遷移電子郵件。 您也可以略過此步驟。
<br>![影像 of_page](../../media/mtp-eval-20.png) <br>
 
13. 選擇 [線上服務]。 選取 [ **Exchange** ] 並按 **[下一步]**。 
<br>![影像 of_page](../../media/mtp-eval-21.png) <br>

14. 將 MX、CNAME 和 TXT 記錄新增至您的網域。 完成時，選取 [**驗證**]。
<br>![影像 of_page](../../media/mtp-eval-22.png) <br>
 
15. 恭喜，您已完成布建您的 Office 365 租使用者。
<br>![影像 of_page](../../media/mtp-eval-23.png) <br>
...
![影像 of_page](../../media/mtp-eval-24.png) <br>

3. 選擇您的驗證喜好設定：透過短信或來電。 決定之後，請輸入電話號碼、選取 [**文字**] 或 [**呼叫我**]，視您的選擇而定。
![影像 of_page](../../media/mtp-eval-25.png) <br>
 
4. 輸入驗證碼，然後按一下 [**開始免費試用**]。 
<br>![影像 of_page](../../media/mtp-eval-26.png) <br>

5. 按一下 [**立即試用**] 以確認您的 Microsoft 365 E5 試用版。
<br>![影像 of_page](../../media/mtp-eval-27.png) <br>
 
6. 移至**Microsoft 365 Admin Center** > **使用者** > 作用中的**使用者**。 選取您的使用者帳戶，選取 [**管理產品授權**]，然後將 Office 365 e5 的授權交換至**Microsoft 365 E5**。 按一下 [儲存]****。
![影像 of_page](../../media/mtp-eval-28.png) <br>
 
7. 再次選取全域管理員帳戶，然後按一下 [**管理使用者名稱**]。
<br>![影像 of_page](../../media/mtp-eval-29.png) <br>

8. 選根據您在先前步驟中選取的專案，將網域從*onmicrosoft.com*變更為您自己的網域。 按一下 [儲存變更]****。
<br>![影像 of_page](../../media/mtp-eval-30.png) <br>
