...
2.  驗證測試網域控制站設定：
    ...
    - 確認 [Microsoft Defender 的身分識別和 Microsoft Cloud App Security integration](https://docs.microsoft.com/cloud-app-security/aatp-integration) 已啟用。
...
**警示：觀察到的可疑程式注入 (來源： Microsoft Defender for Endpoint EDR)**
...
**警示：以無命令列引數執行程式所觀察到的意外行為 (來源： Microsoft Defender for Endpoint EDR)**
...
**警示：使用者和 IP 位址偵測 (SMB)  (來源： Microsoft Defender 身分識別)**
