...
如果您有其中一個支援的 Microsoft 產品的授權，您會看到這些產品的建議。 不管授權版、訂閱或計畫，我們都會向您顯示一套完整的產品改進功能，讓您瞭解安全性最佳作法，並改善您的分數。 您的絕對安全性狀態是以安全分數表示，不論貴組織擁有特定產品的授權為何都會保持相同。 請記住，安全性應該與可用性進行平衡，而不是每個建議都適用于您的環境。
