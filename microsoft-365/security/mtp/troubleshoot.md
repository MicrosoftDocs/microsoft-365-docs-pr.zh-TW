...
如需詳細資訊，請參閱 [Microsoft Defender For Identity integration](https://docs.microsoft.com/cloud-app-security/aatp-integration)。

## <a name="where-is-the-settings-page-for-turning-the-service-on"></a>開啟服務的設定頁面位於何處？
若要開啟 Microsoft 365 Defender，請從 Microsoft 365 安全性中心的功能窗格存取 **設定** 。 只有當您具有 [必要許可權和授權](mtp-enable.md#check-license-eligibility-and-required-permissions)時，才會顯示此導覽專案。
