...
| Microsoft 雲端 App 安全性 | -偵測 unsanctioned cloud app and services (shadow) <br />-向雲端應用程式公開資料<br />-Cloud app 相關聯的威脅活動 | 雲端應用程式 |
...
| 服務 | 布建指示 | 初始設定 |
| ------ | ------ | ------ |
| 適用於端點的 Microsoft Defender | [Microsoft Defender for Endpoint 部署指南](/windows/security/threat-protection/microsoft-defender-atp/deployment-phases) | *請參閱布建指示* |
|適用於 Office 365 的 Microsoft Defender | *無，使用 Office 365 布建* | [設定適用於 Office 365 的 Microsoft Defender 原則](../office-365-security/office-365-atp.md#configure-atp-policies) |
...
| Microsoft 雲端 App 安全性 | *無* | [快速入門： Microsoft Cloud App Security 快速入門](/cloud-app-security/getting-started-with-cloud-app-security) |
