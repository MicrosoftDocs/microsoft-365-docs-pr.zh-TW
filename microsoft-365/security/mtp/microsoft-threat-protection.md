...
與 Microsoft 365 E5 或對等的授權的客戶可以使用 Microsoft Threat Protection。 若要開始，請啟用[security.microsoft.com](https://security.microsoft.com)在 Microsoft 365 安全性中心中的服務。 如需詳細資訊，請閱讀：
