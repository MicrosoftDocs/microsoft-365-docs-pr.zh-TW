...
|階段 | 描述 | 
|:-------|:-----|
| ![階段1：準備](../../media/prepare.png)<br>[階段1：準備](prepare-mtpeval.md)| 深入瞭解在試用實驗室環境中部署 Microsoft 威脅防護時，需要考慮的事項： <br><br>-專案關係人和簽核關 <br> -環境考慮 <br>-Access <br>-Azure Active Directory 安裝程式 <br> -設定順序
|  ![階段2：設定](../../media/setup.png) <br>[階段2：設定](setup-mtpeval.md)|  請先取得存取 Microsoft 365 Security Center 的初始步驟，以設定您的 Microsoft 威脅防護試用實驗室環境。 您將會得到指導：<br><br>-註冊 Microsoft 365 E5 試用版 <br>  -設定網域<br>-指派 Microsoft 365 E5 授權<br>-完成入口網站中的設定向導|
|  ![階段3：設定板載 &](../../media/config-onboard.png) <br>[階段3：設定板載 &](config-mtpeval.md) | 設定每個 Microsoft 威脅防護 pillar 和板載端點。 您將會得到指導：<br><br>-設定 Office 365 的高級威脅防護<br>-設定 Microsoft Cloud App Security<br>-設定 Azure 高級威脅防護<br>-設定 Microsoft Defender 高級威脅防護 
...
-   設定可能會與 Microsoft Defender ATP 整合的協力廠商解決方案
-   實際執行環境中的滲透測試
