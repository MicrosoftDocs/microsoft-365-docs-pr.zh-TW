...
- **全域 Azure Active Directory (Azure AD) 角色**
- **自訂角色存取**

已指派下列 **全域 AZURE AD 角色** 的帳戶可存取 Microsoft 365 Defender 功能和資料：
- 全域管理員
- 安全性系統管理員
- 安全性操作員
- 全域讀取者
...
>!記本文僅適用于管理全域 Azure AD 角色。 如需使用自訂角色型存取控制的詳細資訊，請參閱 [自訂角色的自訂角色的存取控制](custom-roles.md)
