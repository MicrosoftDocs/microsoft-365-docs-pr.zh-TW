...
![您應開啟 Azure ATP 整合切換的 [影像 of_the 設定] 頁面，然後按一下 [儲存]](../../media/mtp-eval-55.png) <br>
>[!NOTE]
...
恭喜！ 您剛剛建立的是 Microsoft 威脅防護試用實驗室或試驗環境！ 現在，您可以熟悉 Microsoft 威脅防護使用者介面！ 查看您可以從哪些儀表板學習並瞭解如何使用每個儀表板做為日常安全性作業工作： [Microsoft 威脅防護互動指南](https://aka.ms/MTP-Interactive-Guide)。
