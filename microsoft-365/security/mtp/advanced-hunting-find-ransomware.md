...
---
# <a name="hunt-for-ransomware"></a>勒索軟體的搜尋
...
勒索軟體已快速演變為簡單的商品惡意程式碼，可影響個別電腦使用者對行業和政府機構產生嚴重影響的企業威脅。 雖然 [Microsoft 365 Defender](microsoft-threat-protection.md) 提供許多功能可偵測和封鎖勒索軟體和相關的入侵活動，但執行主動型檢查是否有損損的功能可協助您保護您的網路。
