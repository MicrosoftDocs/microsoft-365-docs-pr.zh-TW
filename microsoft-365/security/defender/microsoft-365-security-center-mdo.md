...
- [適用於 Office 365 的 Microsoft Defender](/microsoft-365/security/defender-365-security/defender-for-office-365)
...
| [攻擊模擬訓練](../defender-365-security/attack-simulation-training-insights.md)   | 使用攻擊模擬訓練在組織中執行真實化的攻擊案例。 這些模擬攻擊可協助在真實的攻擊影響您的組織之前訓練您的員工。 攻擊模擬訓練包括更多選項、增強的報告，以及改善的訓練流程，可協助讓您的攻擊模擬與訓練案例更易於傳遞和管理。  |

這些區域沒有變更：
- [總管](../defender-365-security/threat-explorer.md)
- [原則與規則](../../compliance/alert-policies.md)
- [行銷活動](../defender-365-security/campaigns.md)
- [提交](../defender-365-security/admin-submission.md)
- [檢閱](./m365d-action-center.md)
- [威脅追蹤程式](../defender-365-security/threat-trackers.md)
...
[適用於 Office 365 的 Microsoft Defender 文章](/microsoft-365/security/defender-365-security/defender-for-office-365)的[快速入門](/microsoft-365/security/defender-365-security/defender-for-office-365.md#getting-started)小節包含的邏輯早期設定區塊，看起來像這樣：
...
還有可直接進入並在第 1 天便完成設定的[連結](../defender-365-security/protect-against-threats.md)。
...
- [建立網路釣魚攻擊模擬](../defender-365-security/attack-simulation-training.md)並[建立用於訓練您的人員的承載](../defender-365-security/attack-simulation-training-payloads.md)
