...
---
# <a name="create-the-microsoft-365-defender-evaluation-environment"></a>建立 Microsoft 365 Defender 評估環境

在評估的下一個步驟中，有兩種常見的方式。 本檔假設您已有實際執行 M365 租使用者，並將啟動 E5 試用授權，以評估 *目前環境中的* M365 Defender。 就地評估功能可讓您在評估期限過後，使用購買授權來保留任何安全性方法。

第二個是針對評估目的[設定 Microsoft 365 Defender 試用實驗室環境](setup-m365deval.md)。 它可能不會有許多來自公司的實際信號，因此請注意這一點。

## <a name="to-activate-e5-trial-licenses-to-evaluate-microsoft-365-defender"></a>啟用 E5 試用授權以評估 Microsoft 365 Defender 
1. 登入您現有的 M365 租使用者管理入口網站。
2. 從流覽功能表中選取 [ *購買服務* ]。
3. 向下滾動至 [ *Office 365* ] 區段，然後選取 [Office 365 E5 授權] 底下的 [詳細資料] 按鈕。
...
[啟用身分識別的 Microsoft 365](eval-defender-identity-overview.md)
