...
>[!NOTE]
>大多數 Microsoft Defender for Endpoint 客戶可以 [使用不含額外授權的 microsoft 365 Defender](prerequisites.md#licensing-requirements)。 若要開始從 Endpoint for Endpoint 轉換您的高級搜尋工作流程，請 [開啟 Microsoft 365 Defender](m365d-enable.md)。
