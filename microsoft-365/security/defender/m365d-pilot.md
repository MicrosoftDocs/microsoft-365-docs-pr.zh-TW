...
本指南提供如何設定試驗專案 Microsoft 365 Defender 及逐步指示的概述。 

Microsoft 365Defender 是一種整合的後續企業防護套件，其可在所有端點、身分識別、電子郵件和應用程式上共同協調保護、偵測、防護、調查和回應，以提供複雜攻擊的整合式防護。 這樣做的方式是將下列功能結合到單一安全性解決方案中：
...
| [製備](m365d-evaluation.md) <br>大約2天|  Access Microsoft 365 的安全性中心設定 Microsoft 365 的 Defender 試驗環境。 您將會指導您：<br><br>-識別利益關係人，並尋找您試驗的登出 <br> -環境考慮 <br>-Access <br>-Azure Active Directory 安裝程式 <br> -設定順序 <br> -註冊 Microsoft 365 E5 試用版 <br> -設定網域 <br>-指派 Microsoft 365 E5 授權 <br> -完成入口網站中的設定向導|
