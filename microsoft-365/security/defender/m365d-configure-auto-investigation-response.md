...
Microsoft 365Defender 包含強大的[自動化調查和回應功能](m365d-autoir.md)，可節約您的安全性運作小組許多時間和精力。 透過 [自我修復](m365d-autoir.md#how-automated-investigation-and-self-healing-works)，這些功能會模仿安全性分析員調查和回應威脅的採取步驟，只會加快，而且可擴充規模的能力。 本文說明如何在 Microsoft 365 Defender 中設定自動調查和回應。
...
|需求 |詳細資料 |
|:----|:----|
|訂閱需求 |其中一項訂閱： <br/>-Microsoft 365 E5<br/>-Microsoft 365 A5<br/>-Microsoft 365 E5 安全性<br/>-Microsoft 365 A5 安全性<br/>-Office 365 e5 加 Enterprise Mobility + Security e5 加上 Windows e5<p> 請參閱[Microsoft 365 Defender 授權需求](./prerequisites.md#licensing-requirements)。|
...
Microsoft 提供內建的 [警示原則](../../compliance/alert-policies.md) ，可協助識別特定風險。 這些風險包括 Exchange 系統管理許可權濫用、惡意程式碼活動、潛在的外部和內部威脅，以及資訊控管風險。 某些提醒可[在 Office 365 中觸發自動調查和回應](../office-365-security/office-365-air.md)。 請確定已正確設定您[的 Microsoft Defender Office 365](/microsoft-365/security/office-365-security/defender-for-office-365)功能。
...
2. 在功能窗格中，尋找 **事件**、 **動作中心** 及 **搜尋**，如上圖所示。
   - 如果您看到 **事件**、**動作中心** 及 **搜尋**，Microsoft 365 Defender 已開啟。 請參閱本文中 () [的裝置群組，查看或變更其自動化層級](#review-or-change-the-automation-level-for-device-groups) 。
   - 如果您 *沒有* 看到 [**事件**]、[**動作中心**] 或 [**搜尋**]，則 Microsoft 365 Defender 可能並未開啟。 在此情況下，請繼續 [前往) 的「動作中心](m365d-action-center.md) 」。
