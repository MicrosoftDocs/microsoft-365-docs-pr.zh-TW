...
ms.locfileid: "53288788"
---
# <a name="getbyuniqueid"></a><span data-ttu-id="ebdf2-103">GetByUniqueId</span><span class="sxs-lookup"><span data-stu-id="ebdf2-103">GetByUniqueId</span></span>

<span data-ttu-id="ebdf2-104">取得或更新 SharePoint Syntex 文件了解模型的資訊 (查看[範例](rest-getbyuniqueid-method.md#examples))。</span><span class="sxs-lookup"><span data-stu-id="ebdf2-104">Gets or updates information about a SharePoint Syntex document understanding model (see [example](rest-getbyuniqueid-method.md#examples)).</span></span>

## <a name="http-request"></a><span data-ttu-id="ebdf2-105">HTTP 要求</span><span class="sxs-lookup"><span data-stu-id="ebdf2-105">HTTP request</span></span>

```HTTP
GET /_api/machinelearning/models/getbyuniqueid('{modelUniqueId}') HTTP/1.1
```

<span data-ttu-id="ebdf2-106">這個相同的方法也可以用來刪除模型。</span><span class="sxs-lookup"><span data-stu-id="ebdf2-106">This same method can be used for deleting a model, too.</span></span> 

```HTTP
DELETE /_api/machinelearning/models/getbyuniqueid('{modelUniqueId}') HTTP/1.1
```
## <a name="uri-parameters"></a><span data-ttu-id="ebdf2-107">URI 參數</span><span class="sxs-lookup"><span data-stu-id="ebdf2-107">URI parameters</span></span>

|<span data-ttu-id="ebdf2-108">名稱</span><span class="sxs-lookup"><span data-stu-id="ebdf2-108">Name</span></span> |<span data-ttu-id="ebdf2-109">於</span><span class="sxs-lookup"><span data-stu-id="ebdf2-109">In</span></span> |<span data-ttu-id="ebdf2-110">必要項目</span><span class="sxs-lookup"><span data-stu-id="ebdf2-110">Required</span></span>|<span data-ttu-id="ebdf2-111">類型</span><span class="sxs-lookup"><span data-stu-id="ebdf2-111">Type</span></span>|<span data-ttu-id="ebdf2-112">描述</span><span class="sxs-lookup"><span data-stu-id="ebdf2-112">Description</span></span>|
|-----|---|--------|----|-----------|
|<span data-ttu-id="ebdf2-113">modelUniqueId</span><span class="sxs-lookup"><span data-stu-id="ebdf2-113">modelUniqueId</span></span>|<span data-ttu-id="ebdf2-114">查詢</span><span class="sxs-lookup"><span data-stu-id="ebdf2-114">query</span></span>|<span data-ttu-id="ebdf2-115">對</span><span class="sxs-lookup"><span data-stu-id="ebdf2-115">True</span></span>|<span data-ttu-id="ebdf2-116">string</span><span class="sxs-lookup"><span data-stu-id="ebdf2-116">string</span></span>|<span data-ttu-id="ebdf2-117">Syntex 模型檔案的識別碼。</span><span class="sxs-lookup"><span data-stu-id="ebdf2-117">ID of the Syntex model file.</span></span>|

## <a name="request-headers"></a><span data-ttu-id="ebdf2-118">要求標頭</span><span class="sxs-lookup"><span data-stu-id="ebdf2-118">Request headers</span></span>

| <span data-ttu-id="ebdf2-119">頁首</span><span class="sxs-lookup"><span data-stu-id="ebdf2-119">Header</span></span> | <span data-ttu-id="ebdf2-120">值</span><span class="sxs-lookup"><span data-stu-id="ebdf2-120">Value</span></span> |
|--------|-------|
|<span data-ttu-id="ebdf2-121">Accept</span><span class="sxs-lookup"><span data-stu-id="ebdf2-121">Accept</span></span>|<span data-ttu-id="ebdf2-122">application/json;odata=verbose</span><span class="sxs-lookup"><span data-stu-id="ebdf2-122">application/json;odata=verbose</span></span>|

## <a name="request-body"></a><span data-ttu-id="ebdf2-123">要求內文</span><span class="sxs-lookup"><span data-stu-id="ebdf2-123">Request body</span></span>

<span data-ttu-id="ebdf2-124">對於 GET，不需要要求主體。</span><span class="sxs-lookup"><span data-stu-id="ebdf2-124">For GET, no request body is needed.</span></span>

## <a name="responses"></a><span data-ttu-id="ebdf2-125">回應</span><span class="sxs-lookup"><span data-stu-id="ebdf2-125">Responses</span></span>

| <span data-ttu-id="ebdf2-126">名稱</span><span class="sxs-lookup"><span data-stu-id="ebdf2-126">Name</span></span>   | <span data-ttu-id="ebdf2-127">類型</span><span class="sxs-lookup"><span data-stu-id="ebdf2-127">Type</span></span>  | <span data-ttu-id="ebdf2-128">描述</span><span class="sxs-lookup"><span data-stu-id="ebdf2-128">Description</span></span>|
|--------|-------|------------|
|<span data-ttu-id="ebdf2-129">200 OK</span><span class="sxs-lookup"><span data-stu-id="ebdf2-129">200 OK</span></span>| |<span data-ttu-id="ebdf2-130">成功</span><span class="sxs-lookup"><span data-stu-id="ebdf2-130">Success</span></span>|

## <a name="examples"></a><span data-ttu-id="ebdf2-131">範例</span><span class="sxs-lookup"><span data-stu-id="ebdf2-131">Examples</span></span>

### <a name="get-the-contoso-contract-model-by-id"></a><span data-ttu-id="ebdf2-132">根據識別碼取得 Contoso 合約模型</span><span class="sxs-lookup"><span data-stu-id="ebdf2-132">Get the Contoso Contract model by ID</span></span>

<span data-ttu-id="ebdf2-133">在此範例中，Contoso 合約文件了解模型的識別碼為 `7645e69d-21fb-4a24-a17a-9bdfa7cb63dc`。</span><span class="sxs-lookup"><span data-stu-id="ebdf2-133">In this sample, the ID of the Contoso Contract document understanding model is `7645e69d-21fb-4a24-a17a-9bdfa7cb63dc`.</span></span>

#### <a name="sample-request"></a><span data-ttu-id="ebdf2-134">範例要求</span><span class="sxs-lookup"><span data-stu-id="ebdf2-134">Sample request</span></span>

```HTTP
GET /_api/machinelearning/models/getbyuniqueid('7645e69d-21fb-4a24-a17a-9bdfa7cb63dc') HTTP/1.1
```

#### <a name="sample-response"></a><span data-ttu-id="ebdf2-135">範例回應</span><span class="sxs-lookup"><span data-stu-id="ebdf2-135">Sample response</span></span>

<span data-ttu-id="ebdf2-136">**狀態碼：** 200</span><span class="sxs-lookup"><span data-stu-id="ebdf2-136">**Status code:** 200</span></span>
...
### <a name="get-and-delete-the-contoso-contract-model-by-id"></a><span data-ttu-id="ebdf2-137">根據識別碼取得及刪除 Contoso 合約模型</span><span class="sxs-lookup"><span data-stu-id="ebdf2-137">Get and delete the Contoso Contract model by ID</span></span>

<span data-ttu-id="ebdf2-138">在此範例中，Contoso 合約文件了解模型的識別碼為 `7645e69d-21fb-4a24-a17a-9bdfa7cb63dc`。</span><span class="sxs-lookup"><span data-stu-id="ebdf2-138">In this sample, the ID of the Contoso Contract document understanding model is `7645e69d-21fb-4a24-a17a-9bdfa7cb63dc`.</span></span>

#### <a name="sample-request"></a><span data-ttu-id="ebdf2-139">範例要求</span><span class="sxs-lookup"><span data-stu-id="ebdf2-139">Sample request</span></span>

```HTTP
DELETE /_api/machinelearning/models/getbyuniqueid('7645e69d-21fb-4a24-a17a-9bdfa7cb63dc') HTTP/1.1
```

## <a name="see-also"></a><span data-ttu-id="ebdf2-140">另請參閱</span><span class="sxs-lookup"><span data-stu-id="ebdf2-140">See also</span></span>

[<span data-ttu-id="ebdf2-141">Syntex 文件瞭解模型 REST API</span><span class="sxs-lookup"><span data-stu-id="ebdf2-141">Syntex document understanding model REST API</span></span>](syntex-model-rest-api.md)
