...
取得或更新 SharePoint Syntex 文件了解模型的資訊 (查看[範例](rest-getbyuniqueid-method.md#examples))。
...
|名稱 |於 |必要項目|類型|描述|
|-----|---|--------|----|-----------|
|modelUniqueId|查詢|對|string|Syntex 模型檔案的識別碼。|
...
### <a name="get-the-contoso-contract-model-by-id"></a>根據識別碼取得 Contoso 合約模型
...
### <a name="get-and-delete-the-contoso-contract-model-by-id"></a>根據識別碼取得及刪除 Contoso 合約模型
