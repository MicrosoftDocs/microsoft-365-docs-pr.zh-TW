...
本主題說明如何在第一次存取預定。 此外，它也會告訴您如何在組織中開啟或關閉預訂。 此外，也說明如何將授權指派給您的使用者，以便他們可以存取和使用預定。
