...
您可以在[Microsoft 365 系統管理中心](https://admin.microsoft.com)管理主題許可權設定。 您必須是全域系統管理員或 SharePoint 管理員，才可執行這些工作。
...
1. 在 [**主題許可權**] 索引標籤的 [**神秘可以建立及編輯主題**，請選取 [**編輯**]。
2. 您可以在 [**神秘可以建立及編輯主題**] 頁面上，選取：
    - **您組織中的每個人**
    - **僅限選取的人員或安全性群組**
    - **沒人**
...
1. 在 [**主題許可權**] 索引標籤的 [**神秘可以管理主題**] 底下，選取 [**編輯**]。
2. 在 [**神秘可以管理主題**] 頁面上，您可以選取：
    - **您組織中的每個人**
    - **選取的人員或安全性群組**
