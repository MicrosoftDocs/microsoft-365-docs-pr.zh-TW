...
Gramm-leach-bliley 金融服務業現代化法案 (GLBA) 是美國法律新式金融服務產業，讓商業和投資銀行、 證券公司及保險公司合併彙算，並解決保護使用者隱私權相關的問題。 它需要聯邦貿易委員會 (FTC) 和其他金融服務管理者可以實作法規以解決這類的隱私權佈建為財務隱私權規則，以及保護規則。 以保護機密消費者資料 GLBA 需求適用於至取用者，例如手續費、 投資建議與保險提供財務產品和服務的金融機構。 FTC 會負責強制執行規範。

## <a name="microsoft-and-glba"></a>Microsoft 和 GLBA

Microsoft Azure、 Microsoft Office 365、 Dynamics 365 和 Microsoft Power BI，可以協助達成提供金融服務機構的雲端服務的嚴格要求。 我們支援的一部分，我們提供相關指導，以協助您遵守的需求提供 GLBA 技術，以及組織的防護功能，可協助維護安全性，並防止未經授權使用量。

Microsoft 開發風險評定工具以進行[Azure](https://servicetrust.microsoft.com/ViewPage/TrustDocuments?command=Download&downloadType=Document&downloadId=6b218946-c235-4234-9beb-d557e39a3f44&docTab=6d000410-c9e9-11e7-9a91-892aae8839ad_Compliance_Guides)與[Office 365](https://servicetrust.microsoft.com/ViewPage/TrustDocuments?command=Download&downloadType=Document&downloadId=55702ffd-c35a-4619-8722-ab71c0c02002&docTab=6d000410-c9e9-11e7-9a91-892aae8839ad_Compliance_Guides)幫助您更有效率地執行 Azure 與 Office 365 服務的風險評定。 工具 （Excel 試算表） 功能 19 資訊安全性網域 （例如安全性原則和風險管理） 的追蹤的財務服務法規及其他相關的標準，包括 （在 Azure 中的資料行 R GLBA 需求試算表和 Office 365 試算表中的資料行 Q）。 工具說明如何 Azure 與 Office 365 遵守到雲端服務提供者每個適用的需求，並且可協助您符合 GLBA 安全性需求。

## <a name="promote-your-glba-compliance"></a>升級您的 GLBA 合規性
...
**如何知道我金融機構必須遵守 GLB 法案？**

FTC 會接聽此在其 GLB 法案] 頁面上，[誰隱私權規則所涵蓋](https://www.ftc.gov/tips-advice/business-center/guidance/how-comply-privacy-consumer-financial-information-rule-gramm#whois)的詳細說明嗎？
