...
Microsoft 365 中的測試人員風險管理採用完整的服務和協力廠商指標，可協助您快速發現、分級風險活動，並採取行動。 透過使用 Office 365 和 Microsoft Graph 中的記錄，測試人員風險管理可讓您定義用於識別風險指標的特定原則。 這些原則可讓您識別風險活動，並採取行動來緩解這些風險。
