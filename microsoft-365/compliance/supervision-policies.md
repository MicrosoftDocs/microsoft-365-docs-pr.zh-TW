...
設定自訂關鍵字字典 (或詞典) ，以提供組織或行業特有之關鍵字的簡單管理。 關鍵字字典最多可支援每個字典的100000字詞。 如有需要，您可以將多個自訂關鍵字字典套用至單一原則，或在每個原則中有單一關鍵字字典。 這些字典是指派于監管原則中，可能來自 (例如 .csv 或 .txt 清單) 或您可以[在規範中心內匯入](create-a-keyword-dictionary.md)的清單中的檔。
