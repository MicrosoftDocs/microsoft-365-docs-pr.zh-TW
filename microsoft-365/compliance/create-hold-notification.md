...
3. 在 [ **名稱通訊** ] 頁面上，指定下列 () 通訊詳細資料所需的。
    ...
    - **簽發官**：下拉式清單會顯示案例成員清單清單。 如需如何新增成員至案例的詳細資訊，請參閱 [Create a Advanced eDiscovery case](get-started-with-advanced-ediscovery.md#step-4-create-an-advanced-ediscovery-case)。 傳送給保管人的每個通知都會代表指定的發行專員傳送。
