...
---
# <a name="prepare-data-for-advanced-ediscovery-classic"></a>準備資料以供高級 eDiscovery (傳統) 

本主題說明如何在高級 eDiscovery (傳統) 中，將內容搜尋的結果載入到案例中。 
...
若要使用 Advanced eDiscovery 來分析資料，您可以使用 Microsoft 365 安全性與合規性中心中所執行的內容搜尋結果，在 [Microsoft 365) 安全性與合規性中心] &amp; 中的 [ **內容搜尋** ] 頁面上，列出 (， &amp; 也就是與 ediscovery 案例相關聯的搜尋， (列于安全規範中心) 中的 [ **ediscovery** ] 頁面上 &amp; 。 
