...
[裝置管理] 是一種能夠從裝置收集遙測資訊，並將之引入 Microsoft 365 合規性中心解決方案，例如端點 DLP 和 [測試人員風險管理](insider-risk-management.md) 中的功能。 在 DLP 原則中，您需將想要用作位置的所有裝置上線。
...
### <a name="viewing-endpoint-dlp-data"></a>檢視端點 DLP 資料
 ...
 [端點 DLP] 可監視基於 MIME 類型的活動，因此即使副檔名變更，也能捕獲活動。 在公開預覽中，可監視所有項目：
