...
可供組織使用的 Microsoft Online Services (包括（但不限於）教育機構)  (hereinafter 稱為「客戶」 ) （包括可啟用個人資料處理的功能，例如 Microsoft Azure、Microsoft 365、Dynamics 365 及 Power Platform）是從俄羅斯以外的資料處理中心提供，以取得有關詳細資訊，請參閱 [Microsoft 信任中心](https://www.microsoft.com/trust-center) (。
...
Microsoft 邀請客戶會考慮透過 Microsoft 雲端解決方案提供者 (CSP) partner 訂閱 Microsoft Online Services （Microsoft Azure、Microsoft 365、Dynamics 365 及 Power Platform）。 如需詳細資訊，請參閱此 [CSP 合作夥伴清單](https://pinpoint.microsoft.com/search?type=services&campaign=691) 。
