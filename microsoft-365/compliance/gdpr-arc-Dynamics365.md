...
此責任整備程度檢查清單可讓您便捷地存取在使用 Microsoft Dynamics 365 時，為了支援 GDPR (一般資料保護規定) 所需要的資訊。該清單是依循 *ISO/IEC CD 27552 資訊技術 -- 安全性技術 -- 對 ISO/IEC 27001 隱私權管理的增強 - 規定*，針對個人資訊處理者的一組隱私權和安全性控制的標題和參考編號 (列在每個檢查清單主題的括號中) 來進行編排。

您可以使用合規性管理員管理此檢查清單中的項目 [[15](gdpr-arc-Dynamics365.md#15)]，方法是參考 GDPR 圖格中「客戶受管理控制項」** 底下的控制項識別碼和控制項標題。

此外，此檢查清單中「5. 資料保護和安全性」底下的項目，參考列在「服務信任」入口網站中[合規性管理員](https://servicetrust.microsoft.com/ComplianceManager)底下的控制項。檢閱這些控制項的 Microsoft 實作詳細資料，提供用來滿足客戶對於檢查清單項目考量的 Microsoft 方法的額外說明。

此控制項結構也可用於組織 Microsoft Dynamics 365 實作以支援 GDPR 的內部控制項展示，您可以在這裡下載：https://aka.ms/gdprcontrols。
...
|***識別法律依據 (7.2.2)***|客戶應了解任何與處理相關的法律依據規定，例如是否必須先取得同意。|Microsoft 服務為了納入您的責任歸屬文件而處理的個人資料描述。 <br>- Dynamics 365 針對客戶資料保護影響評估的重要資訊 [2]|(5)(1)(a)、(6)(1)(a)、(6)(1)(b)、(6)(1)(c)、(6)(1)(d)、(6)(1)(e)、(6)(1)(f)、(6)(3)、(6)4)(a)、(6)(4)(b)、(6)(4)(c)、(6)(4)(d)、(6)(4)(e)、(8)(3)、(9)(1)、(9)(2)(b)、(9)(2)(c)、(9)(2)(d)、(9)(2)(e)、(9)(2)(f)、(9)(2)(g)、(9)(2)(h)、(9)(2)(i)、(9)(2)(j)、(9)(3)、(9)(4)、(10)、(17)(3)(a)、(17)(3)(b)、(17)(3)(c)、(17)(3)(d)、(17)(3)(e)、(18)(2)、(22)(2)(a)、(22)(2)(b)、(22)(2)(c)、(22)(4)|
...
|***隱私權影響評估 (7.2.5)***|客戶應該了解完成隱私權影響評估的相關規定 (何時應執行、需要哪些類別的資料、以及完成評估的時機)。|服務信任入口網站的[資料保護影響評估 (DPIA) 頁面](https://servicetrust.microsoft.com/ViewPage/GDPRDPIA)中，提供了 Microsoft 服務如何判斷何時執行 DPIA 以及 Microsoft 的 DPIA 方案概述 (包括 DPO 的參與)。如需針對您的 DPIA 支援，請參閱：<br>- Dynamics 365 針對客戶資料保護影響評估的重要資訊 [2]|條款 (35)|
...
|***與 PII 處理相關的記錄 (7.2.7)***|客戶應該保存與處理個人資料相關的所有必要和需要的記錄 (例如，目的、安全性措施等)。如果某些記錄必須由次處理者提供，客戶應確保他們可以獲得這類記錄。|Microsoft 服務提供來協助您維護示範合規性所需記錄和支援 GDPR 之下的責任的工具。<br>- Dynamics 365 中的稽核和報告 [[3](gdpr-arc-Dynamics365.md#3)]|(5)(2)、(24)(1)、(30)(1)(a)、(30)(1)(b)、(30)(1)(c)、(30)(1)(d)、(30)(1)(g)、(30)(1)(f)、(30)(3)、(30)(4)、(30)(5)|
...
|***提供處理的 PII 副本 (7.3.8)***|客戶應了解將自己所處理的個人資料副本提供給個人的規定。這可能包括有關副本格式 (即機器可讀取)、傳輸副本等的要求。如果客戶使用第三方系統的功能來提供副本，應根據需要使用此功能。|在您提供給資料主體的資料中，可以包含的 Microsoft 服務功能相關資訊，這些功能可讓您取得其個人資料的複本。<br>- GDPR 的 Dynamics 365 資料主體要求 [[4](gdpr-arc-Dynamics365.md#4)] 請參閱：匯出**|(15)(3)、(15)(4)、(20)(1)、(20)(2)、(20)(3)、(20)(4)|
...
|***自動化決策 (7.3.10)***|客戶應該了解對個人資料進行自動化處理，以及此類自動化所作出決策的規定。這可能包括提供對個人進行者這種處理、反對這種處理、或要求人為干預的相關資訊。如果這些功能是由第三方系統提供，客戶應確保第三方會提供所需的所有資訊或支援。|可以包含在您的責任文件中、與 Microsoft 服務中可能支援自動決策的功能相關的資訊，以及與這些功能的資料主體資訊。<br>- Dynamics 365 針對客戶資料保護影響評估的重要資訊 [2]|(13)(2)(f)、(14)(2)(g)、(22)(1)、(22)(3)|
