...
使用 Microsoft 365 規範中心內的 Veritas 連接器，從處理 Microsoft 365 組織中的使用者信箱的 Reuters 匯入及封存資料。 Veritas 為您提供 [Reuters 處理](https://globanet.com/reuters-dealing/) 連接器，將其設定為定期從協力廠商資料來源捕獲專案 () ，然後將這些專案匯入至 Microsoft 365。 連接器會將 Reuters 處理帳戶的通訊，轉換為電子郵件訊息格式，然後將這些專案匯入至 Microsoft 365 中的使用者信箱。
...
3. 在 Microsoft 365 規範中心建立的 Reuters 會連線至 Veritas Merge1 網站，並將內容傳送至 Microsoft 雲端中的安全 Azure 儲存位置。
