...
使用 Microsoft 365 規範中心的 Veritas connector，匯入和封存 Redtail 中的資料給您的 Microsoft 365 組織中的使用者信箱。 Veritas 為您提供 [Redtail](https://globanet.com/redtail/) 的「使用中」連接器，可將其設定為從您的組織的 SFTP 伺服器捕獲專案，而這些專案會從 Redtail 接收。 連接器會將內容從 Redtail 朗讀為電子郵件訊息格式，然後將這些專案匯入至 Microsoft 365 中的使用者信箱。
...
3. 您在 Microsoft 365 合規性中心建立的 Redtail 講話連接器每天都會連線到 Veritas Merge1 網站，並將郵件傳輸至 Microsoft 雲端中的安全 Azure 儲存位置。
