...
Microsoft 365 中的 Advanced eDiscovery 解決方案是針對現有的 Microsoft eDiscovery 和分析功能而建立的。 Advanced eDiscovery 提供的端對端工作流程，可保留、收集、分析、審閱、分析和匯出以回應組織內部和外部調查的內容。 此外也可讓您的法律小組管理整個法務保存措施工作流程，以與涉及案例的監管人通訊。
