...
使用 Microsoft 365 規範中心內的 Veritas 連接器，將 Symphony 資料匯入至您的 Microsoft 365 組織中的使用者信箱，並將其封存。 Symphony 是金融服務行業中使用的訊息和共同作業平臺。 Veritas 會在 Microsoft 365 規範中心內提供 [Symphony](https://globanet.com/symphony) 資料連線器，讓您可以設定定期從協力廠商資料來源捕獲專案 () ，然後將這些專案匯入至使用者信箱。 連接器會將專案的內容從 Symphony 帳戶轉換成電子郵件格式，然後將該專案匯入 Microsoft 365 中的信箱。
...
3. 您在 Microsoft 365 規範中心建立的 Symphony 連接器會每天連線到 Veritas Merge1 網站，並將郵件傳輸至 Microsoft 雲端中的安全 Azure 存放位置。
