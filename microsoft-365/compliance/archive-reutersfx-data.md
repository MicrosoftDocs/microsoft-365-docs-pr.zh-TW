...
使用 Microsoft 365 規範中心內的 Veritas 連接器，將 Reuters FX 平臺的資料匯入和封存至您的 Microsoft 365 組織中的使用者信箱。 Veritas 為您提供了一個 [REUTERS FX](https://globanet.com/reuters-fx/) 連接器，可設定為定期從協力廠商資料來源捕獲專案 () ，然後將這些專案匯入至 Microsoft 365。 連接器會將貨幣和 FX 速率從 Reuters FX 帳戶轉換成電子郵件訊息格式，然後將這些專案匯入至 Microsoft 365 中的使用者信箱。
...
3. 您在 Microsoft 365 規範中心建立的 Reuters FX 連接器會每天連線到 Veritas Merge1 網站，並將內容傳送至 Microsoft 雲端中的安全 Azure 存放位置。
