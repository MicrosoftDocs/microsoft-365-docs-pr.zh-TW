...
| 具有夥伴組織的 SMTP TLS | Exchange Online | TLS 1.2 與 AES 256 | Exchange Online (outlook.office.com) 的 TLS 憑證是以 DigiCert 雲端服務 CA-1 所發行的 RSA 加密憑證為2048位的 SHA-256。 <br> <br> Exchange Online 的 TLS 根憑證是由[GlobalSign 根 CA – R1](./exchange-online-uses-tls-to-secure-email-connections.md?view=o365-worldwide#tls-certificate-information-for-exchange-online)所發行的 RSA 加密憑證所 SHA-1 的2048位。 <br> <br> 請注意，根據安全性的考慮，我們的憑證會在一段時間後變更。 | 是，當使用具有256位密碼強度的 TLS 1.2 時 |
