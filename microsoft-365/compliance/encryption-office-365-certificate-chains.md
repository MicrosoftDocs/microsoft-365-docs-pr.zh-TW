...
| --- | --- | --- | --- | --- |
| 公開信任的根憑證 | [Office 365 的根憑證束（P7B）](https://download.microsoft.com/download/A/5/A/A5AE01F3-D19B-4A11-9407-801263CEF72C/O365_Root_Certs_20170321.p7b) | crl.globalsign.net<br>www.d-trust.net | 不適用 | 不適用 |
...
| **主旨** | CN = Entrust 根憑證授權單位單位-G2<br>OU =&quot;（c） 2009 Entrust，inc.-僅限授權使用&quot;<br>OU = 請參閱 www.entrust.net/legal-terms<br>O =&quot;Entrust，inc.。&quot;<br>C=US |
| --- | --- |
| **序號** | 4A：53：8C：28 |
| **公開金鑰長度** | RSA 2048 位（e 65537） |
| **簽名演算法** | sha256RSA |
...
| **主旨** | CN = Entrust 憑證授權單位單位（2048）<br>OU = （c） 1999 Entrust.net 有限<br>OU = entrust net/CPS\_2048 包含。 使用 ref。（限制 s liab。）<br>O = Entrust |
| --- | --- |
| **序號** | 38：63： DE： F8 |
| **公開金鑰長度** | RSA 2048 位（e 65537） |
| **簽名演算法** | sha1RSA |
...
| **公開金鑰長度** | RSA 2048 位（e 65537） |
| **簽名演算法** | sha1RSA |
| **不早的合法性** | Dec 15 08:00:00 2006 UTC |
| **不晚的合法性** | Dec 15 08:00:00 2021 UTC |
| **主體金鑰識別碼** | 9b： e2：07：57：67：1c：1e： c0：6a：06： de：59： b4：9a：2d： df： dc：19：86：2e |
...
| **主旨** | CN = thawte Primary Root CA-G3<br>OU =&quot;（c） 2008 Thawte，inc.-僅限授權使用&quot;<br>OU = 認證服務部門<br>O =&quot;Thawte，inc.。&quot;<br>C=US |
| --- | --- |
...
| **主旨** | CN = VeriSign Class 3 Public Primary Primary 核證機關-G5<br>OU =&quot;（c） 2006 VeriSign，inc.-僅限授權使用&quot;<br>OU = VeriSign 信任網路<br>O =&quot;VeriSign，inc.。&quot;<br>C=US |
| --- | --- |
...
| --- | --- |
| **發行者** | CN = Entrust 憑證授權單位單位（2048）<br>OU = （c） 1999 Entrust.net 有限<br>OU = entrust net/CPS\_2048 包含。 使用 ref。（限制 liab。）<br>O = Entrust |
| **序號** | 4C：0E：8C：39 |
| **公開金鑰長度** | RSA 2048 位（e 65537） |
| **簽名演算法** | sha1RSA |
...
| **主旨** | CN = Entrust 憑證授權單位單位-L1K<br>OU =&quot;（c） 2012 Entrust，inc.-僅限授權使用&quot;<br>OU = 請參閱 www.entrust.net/legal-terms<br>O =&quot;Entrust，inc.。&quot;<br>C=US |
| --- | --- |
| **發行者** | CN = Entrust 根憑證授權單位單位-G2<br>OU =&quot;（c） 2009 Entrust，inc.-僅限授權使用&quot;<br>OU = 請參閱 www.entrust.net/legal-terms<br>O =&quot;Entrust，inc.。&quot;<br>C=US |
...
| --- | --- |
| **發行者** | CN = VeriSign Class 3 Public Primary Primary 核證機關-G5<br>OU =&quot;（c） 2006 VeriSign，inc.-僅限授權使用&quot;<br>OU = VeriSign 信任網路<br>O =&quot;VeriSign，inc.。&quot;<br>C=US |
...
| --- | --- |
| **發行者** | CN = thawte Primary Root CA-G3<br>OU =&quot;（c） 2008 Thawte，inc.-僅限授權使用&quot;<br>OU = 認證服務部門<br>O =&quot;Thawte，inc.。&quot;<br>C=US |
