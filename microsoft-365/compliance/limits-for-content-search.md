...
下表列出在 Microsoft 365 規範中心中使用內容搜尋工具時的搜尋限制，以及與核心 eDiscovery 案例相關聯的搜尋。
...
|預覽搜尋結果時，在預覽頁面上顯示的商務網站 SharePoint 和 OneDrive 中所找到的專案數上限。 隨即顯示最新的專案。  <br/> |200  <br/> |
...
|單一使用者可在任何時間執行的匯出上限 <br/> |3  <br/> |
|可使用 eDiscovery 匯出工具下載之搜尋結果的信箱數目上限 <br/><br/> **附注：** 若要從100000個以上的信箱下載搜尋結果，您必須使用安全性 & 規範中心 PowerShell。 如需相關指示，請參閱 [匯出超過100000個信箱的結果](export-search-results.md#exporting-results-from-more-than-100000-mailboxes)。 <br/> | 100,000 <br/>|
...
如需與核心 eDiscovery 和高級 eDiscovery 相關的大小寫限制，請參閱：
