...
您可以從 CSA 註冊機構下載 Azure 的 [CSA STAR 認證](https://aka.ms/csastar-certification)，其中包含 Intune 和 Power BI。

**Microsoft 雲端服務的成熟度為何？**

Azure、Cloud App Security、Intune 和 Power BI 在成熟度能力評估方面均獲得了最高的金牌認證。
