...
---
# <a name="set-up-basic-audit-in-microsoft-365"></a>在 Microsoft 365 中設定基本審核

Microsoft 365 的基本審核可讓您針對使用者和系統管理員在不同 Microsoft 365 服務中執行的活動，搜尋審計記錄。 因為對於大多數的 Microsoft 365 和 Office 365 組織而言，預設會啟用基本審核，所以組織中的其他人可以搜尋審核記錄之前，只需要做一些工作。
...
如需詳細資訊，請參閱[Microsoft 365 中的基本審核](auditing-solutions-overview.md#basic-audit)。
