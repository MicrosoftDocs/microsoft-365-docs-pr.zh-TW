...
- **Power)  (預覽的自動化功能 **：使用電源自動化流程，以自動化警示訊息的處理工作。 根據預設，通訊相容性會包含 *通知管理員，當使用者有通訊相容性警示* 流程範本時，檢閱者便可使用該通知來自動化具有郵件警示之使用者的通知程式。 如需如何建立及管理通訊相容性中之電源自動化流程的詳細資訊，請參閱 [通訊相容性功能參考](communication-compliance-feature-reference.md#power-automate-flows-preview) 文章。
