...
|線上會議和 IM 交談中共用檔案（Microsoft 小組）  <br/> |當使用者使用 Microsoft 團隊處理檔案時，TLS 用於連線。 這會自動內置於 Office 365。 Microsoft 團隊目前不支援加密電子郵件的內嵌轉譯。 若要防止加密的電子郵件在 Microsoft 小組中以加密形式傳送，請參閱[郵件加密常見問題](https://docs.microsoft.com/microsoft-365/compliance/ome-faq?view=o365-worldwide#can-i-automatically-remove-encryption-on-incoming-and-outgoing-mail)。  <br/> 
