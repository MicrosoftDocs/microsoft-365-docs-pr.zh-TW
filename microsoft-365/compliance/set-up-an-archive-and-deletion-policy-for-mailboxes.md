...
1. 在 [**保留標記**] 頁面上，按一下 [**新增標記** ![] [新增圖示](../media/457cd93f-22c2-4571-9f83-1b129bcfb58e.gif)]，然後選取 [自動套用**至預設資料夾**]。 
...
2. 在 [**保留原則**] 頁面上**New** ![，按一下 [](../media/457cd93f-22c2-4571-9f83-1b129bcfb58e.gif)新增新圖示]。
...
1. 在 [**信箱**] 頁面上選取信箱，然後按一下**Edit** ![[編輯](../media/d7dc7e5f-17a1-4eb9-b42d-487db59e2e21.png)編輯]。 
...
1. 在您的本機電腦上開啟 Windows PowerShell，並執行下列命令。
    ...
    在 [ **Windows PowerShell 憑證要求**] 對話方塊中，輸入全域管理員帳戶的使用者名稱和密碼，然後按一下 **[確定]**。
...
4. 若要確認您已連線至 Exchange Online 組織，執行下列命令以取得貴組織中所有信箱的清單：
    ...
    > [!NOTE]
    > 如需詳細資訊，或如果您連線至 Exchange Online 組織時有問題，請參閱連線[至 Exchange online PowerShell](https://go.microsoft.com/fwlink/p/?LinkId=517283)。 
  
5. 執行下列兩個命令，以啟動組織中所有使用者信箱的受管理的資料夾助理。
...
1. 連線[至 Exchange Online PowerShell](https://go.microsoft.com/fwlink/p/?LinkId=517283)或參閱步驟5。
