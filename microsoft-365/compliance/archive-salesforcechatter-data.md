...
使用 Microsoft 365 規範中心內的 Veritas 連接器，將 Salesforce 交談平臺的資料匯入並封存至您的 Microsoft 365 組織中的使用者信箱。 Veritas 提供 [Salesforce 交談](http://globanet.com/chatter/) 連接器，可從協力廠商資料來源捕獲專案，並將這些專案匯入至 Microsoft 365。 連接器會將聊天、附件和張貼等內容轉換為電子郵件訊息格式，然後將這些專案匯入至 Microsoft 365 中的使用者信箱。
...
3. 您在 Microsoft 365 規範中心建立的 Salesforce 交談連接器會每天連線到 Veritas Merge1 網站，並將交談內容傳送至 Microsoft 雲端中的安全 Azure 儲存位置。
