...
- 使用者設定檔，移至 [Office 365 系統管理中心](https://portal.office.com/adminportal/home)。 在 [系統管理中心]**** 中選取 [使用者]****。 在 [作用中使用者]**** 頁面上，在清單上搜尋使用者。 在 Social Engagement 中，請移至 [設定] \> [使用者管理] **** 以查看從 Office 365 自動同步處理的資訊。
