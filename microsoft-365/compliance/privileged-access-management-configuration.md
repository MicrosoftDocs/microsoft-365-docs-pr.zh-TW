...
- Microsoft 365A3 訂閱 (或 Office 365 A3 訂閱 + Enterprise 行動性和安全性 A3 訂閱) + the Microsoft A5 符合性附加元件
- 教育訂閱的任何 Microsoft 365、Office 365、Exchange、SharePoint 或 OneDrive，以及 Microsoft 365 A5 有問必答內幕風險管理附加元件
...
1. 使用組織中的系統管理員帳戶的認證，登入[Microsoft 365 系統管理中心](https://admin.microsoft.com)。
