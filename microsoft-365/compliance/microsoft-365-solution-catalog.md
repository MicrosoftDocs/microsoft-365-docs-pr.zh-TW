...
您是否在尋找 Microsoft 365 中快速開始使用合規性工作的方式？ 查看[Microsoft 365 方案目錄](https://compliance.microsoft.com/solutioncatalog)，以探索、瞭解及快速開始使用合規性和風險管理解決方案。
...
方案目錄分為區段，其中包含 Microsoft 365 訂閱中提供之每個規範解決方案的資訊卡片。 每個區段都包含依合規性區域分組的解決方案卡。

![Microsoft 365 方案類別的首頁](../media/m365-solution-catalog-home.png)

當您選取 [方案卡的 **視圖** ] 時，您將會看到相容性解決方案的詳細資訊，以及如何開始使用。 這項資訊包含綜述、預先設定需求、學習資源、可讓您將名片固定至功能窗格的控制項，以及以連結、電子郵件或 Microsoft Teams 訊息的方式來共用解決方案的選項。
...
「**資訊保護 &** 控管」一節將告訴您，如何使用 Microsoft 365 規範解決方案來保護和管理組織中的資料。

![Microsoft 365 方案目錄資訊保護和管理區段](../media/m365-solution-catalog-information-protection-governance.png)

在這裡，您將會看到下列解決方案的卡片：

- [資料遺失防護](dlp-learn-about-dlp.md)：偵測機密內容在整個組織、雲端和裝置上都使用及共用，並協助防止意外的資料遺失。
...
- **Microsoft 資訊保護**，瞭解 Microsoft 365 解決方案如何協助您探索、分類及保護任何地方生活或傳播的機密資訊。
