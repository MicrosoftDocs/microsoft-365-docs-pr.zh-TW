...
|[了解 Microsoft 合規性中心擴充功能 (預覽)](dlp-chrome-learn-about.md) | 將 DLP 功能延伸至 Chrome 瀏覽器 | [開始使用 Microsoft 合規性中心擴充功能 (預覽)](dlp-chrome-get-started.md)|
...
|[保護 Microsoft Teams 中聊天和頻道訊息的敏感性資訊](dlp-microsoft-teams.md) | 將部分 DLP 功能延伸至 Teams 聊天和頻道訊息 | [了解 Microsoft Teams 中的預設資料外洩防護原則 (預覽)](dlp-teams-default-policy.md)| 