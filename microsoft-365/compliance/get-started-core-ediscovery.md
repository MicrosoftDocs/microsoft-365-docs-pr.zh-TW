...
4. 在 [ **新案例** 飛入] 頁面上，為案例)  (所需的名稱，然後輸入選用的案例編號及描述。 案例名稱在您的組織中必須是唯一的。
...
如果您在步驟3中建立案例，而且您是唯一會使用此案例的人員，則您不需要執行此步驟。 您可以開始使用案例來建立 eDiscovery 保留、搜尋內容或匯出搜尋結果。 若要授與其他使用者 (或角色群組) 存取案例，請執行此步驟。
...
3. 在可以新增為案例成員的人員或角色群組清單中，按一下您要新增之人員 (或角色) 群組名稱旁邊的核取方塊。 如果您有很多可以新增為成員的人員清單，請使用 **搜尋** 方塊來搜尋清單中的特定人員。
