...
下表列出在資料調查（預覽）調查中，在證據集中的檔的元資料欄位。 該表會指出元資料欄位的名稱、在證據集內執行查詢時是否可以搜尋該欄位，是否有當查看證據集內所選取檔的檔案中繼資料，以及匯出檔時是否包含該欄位。 
...
|Doc 上次儲存者          |                                                 |                         | 是         |
|修改的 Doc            |                                                 |                         | 是         |
|Doc 主題                |                                                 |  是（Subject/Title）    | 是         |
|Doc 範本               |                                                 |                         | 是         |
|Doc 標題                  | 是（title）                                     |  是（Title）            | 是         |
|Doc 版本                |                                                 |                         | 是         |
...
|電子郵件抄送                   | 是（cc）                                        |                         | 是         |
|電子郵件交談識別碼      |                                                 |                         | 是         |
|電子郵件接收日期        | 是（已接收）                                  |   是（已接收）        | 是         |
|電子郵件傳送日期            | 是（已傳送）                                      |   是（已傳送）            | 是         |
|電子郵件有附件       |                                                 |                         | 是         |
|電子郵件重要性           |                                                 |                         | 是         |
|電子郵件網際網路標頭     |                                                 |                         | 是         |
|電子郵件層級                |                                                 |                         | 是         |
...
|電子郵件主題              | 是（subject）                                   |   是（Subject/Title）   | 是         |
|電子郵件執行緒               |                                                 |                         | 是         |
|電子郵件至                   | 是（to）                                        |                         | 是         |
...
|載入識別碼                    | 是（loadId）                                    |                         | 是         |
|位置名稱              |                                                 |                         | 是         |
|標示為 pivot            | 是（markAsPivot）                               |   是（已標示為 Pivot） | 是         |
...
|讀取百分之百分點（問題）    | 是（readPercentile_issueNum）                   |                         |             |
