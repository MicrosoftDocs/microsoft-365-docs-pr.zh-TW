...
若要將文件和電子郵件宣告為紀錄，您可使用 [[保留標籤]](retention.md#retention-labels) 將項目標記為記錄。 您可以發佈這些標籤，讓使用者和系統管理員手動將這些標籤套用至內容，或自動將這些標籤套用到您想要標記為記錄的內容。

## <a name="configuring-retention-labels-to-declare-records"></a>設定 [保留標籤] 以宣告記錄

當您建立或設定保留標籤時，選取選項以將項目標記為記錄。
...
2. 選取在精靈中 **[ 界定保留設定]** 頁面上的選項，以將項目標記為記錄：
